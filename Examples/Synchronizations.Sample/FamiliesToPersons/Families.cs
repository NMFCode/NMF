...
namespace NMF.Synchronizations.Example.Families
{
    ...
    public class Family : FamElem, IFamily, IModelElement
    {
        ...
        private void SonsCollectionChanging(object sender, System.Collections.Specialized.NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void DaughtersCollectionChanging(object sender, System.Collections.Specialized.NotifyCollectionChangedEventArgs e)
        {
