...
namespace NMF.Interop.Ecore
{
    ...
    public abstract class EClassifier : ENamedElement, IEClassifier, IModelElement
    {
        ...
        public virtual string InstanceClassName
        {
            ...
            set
            {
                if ((value != this._instanceClassName))
                {
                    this._instanceClassName = value;
                    this.OnInstanceClassNameChanged(EventArgs.Empty);
                    this.OnPropertyChanged("InstanceClassName");
                }
            }
        }
        ...
        public virtual string InstanceTypeName
        {
            ...
            set
            {
                if ((value != this._instanceTypeName))
                {
                    this._instanceTypeName = value;
                    this.OnInstanceTypeNameChanged(EventArgs.Empty);
                    this.OnPropertyChanged("InstanceTypeName");
                }
            }
        }
        ...
        /// </summary>
        public event EventHandler InstanceClassNameChanged;
        
        /// <summary>
        /// Gets fired when the InstanceTypeName property changed its value
        /// </summary>
        public event EventHandler InstanceTypeNameChanged;
        ...
        protected virtual void OnInstanceClassNameChanged(EventArgs eventArgs)
        {
            EventHandler handler = this.InstanceClassNameChanged;
            if ((handler != null))
            {
        ...
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnInstanceTypeNameChanged(EventArgs eventArgs)
        {
            EventHandler handler = this.InstanceTypeNameChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        protected override void OnParentChanged(IModelElement newParent, IModelElement oldParent)
        {
            ...
            this.OnEPackageChanged(new ValueChangedEventArgs(oldEPackage, newEPackage));
        }
        ...
        {
            return NMF.Models.Repository.MetaRepository.Instance.ResolveClass("http://www.eclipse.org/emf/2002/Ecore#//EClassifier/");
        }
