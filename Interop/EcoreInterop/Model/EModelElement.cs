...
namespace NMF.Interop.Ecore
{
    ...
    public abstract partial class EModelElement : ModelElement, IEModelElement, IModelElement
    {
        
        private static Lazy<IOperation> _getEAnnotationOperation = new Lazy<IOperation>(RetrieveGetEAnnotationOperation);
        
        private static Lazy<ITypedElement> _eAnnotationsReference = new Lazy<ITypedElement>(RetrieveEAnnotationsReference);
        ...
        [ConstantAttribute()]
        public IOrderedSetExpression<IEAnnotation> EAnnotations
        {
            get
            {
        ...
        /// </summary>
        public event EventHandler<OperationCallEventArgs> GetEAnnotationCalling;
        
        /// <summary>
        /// Gets fired after the operation getEAnnotation got called
        /// </summary>
        public event EventHandler<OperationCallEventArgs> GetEAnnotationCalled;
        
        /// <summary>
        /// 
        /// </summary>
        /// <param name="source"></param>
        public IEAnnotation GetEAnnotation(string source)
        {
            System.Func<IEModelElement, string, IEAnnotation> handler = OperationBroker.Instance.GetRegisteredDelegate<System.Func<IEModelElement, string, IEAnnotation>>(_getEAnnotationOperation);
            if ((handler != null))
            {
            }
            else
            {
                throw new InvalidOperationException(("There is no implementation for method getEAnnotation registered. Use the method b" +
                        "roker to register a method implementation."));
            }
            OperationCallEventArgs e = new OperationCallEventArgs(this, _getEAnnotationOperation.Value, source);
            this.OnGetEAnnotationCalling(e);
            this.OnBubbledChange(BubbledChangeEventArgs.OperationCalling(this, _getEAnnotationOperation.Value, e));
            IEAnnotation result = handler.Invoke(this, source);
            e.Result = result;
            this.OnGetEAnnotationCalled(e);
            this.OnBubbledChange(BubbledChangeEventArgs.OperationCalled(this, _getEAnnotationOperation.Value, e));
            return result;
        }
        
        private static IOperation RetrieveGetEAnnotationOperation()
        {
            return ClassInstance.LookupOperation("getEAnnotation");
        }
        
        /// <summary>
        /// Raises the GetEAnnotationCalling event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnGetEAnnotationCalling(OperationCallEventArgs eventArgs)
        {
            EventHandler<OperationCallEventArgs> handler = this.GetEAnnotationCalling;
            if ((handler != null))
            {
        ...
        /// <summary>
        /// Raises the GetEAnnotationCalled event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnGetEAnnotationCalled(OperationCallEventArgs eventArgs)
        {
            EventHandler<OperationCallEventArgs> handler = this.GetEAnnotationCalled;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private static ITypedElement RetrieveEAnnotationsReference()
        {
            return ((ITypedElement)(((ModelElement)(NMF.Interop.Ecore.EModelElement.ClassInstance)).Resolve("eAnnotations")));
        }
        ...
        private void EAnnotationsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
            this.OnCollectionChanging("EAnnotations", e, _eAnnotationsReference);
        }
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void EAnnotationsCollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            this.OnCollectionChanged("EAnnotations", e, _eAnnotationsReference);
        }
        ...
        {
            if ((container == this._eAnnotations))
            {
                return "eAnnotations";
            }
        ...
        public class EModelElementChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.EAnnotations.AsNotifiable()};
            }
