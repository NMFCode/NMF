...
namespace NMF.Interop.Ecore
{
    ...
    public partial class ETypeParameter : ENamedElement, IETypeParameter, IModelElement
    {
        
        private static Lazy<ITypedElement> _eBoundsReference = new Lazy<ITypedElement>(RetrieveEBoundsReference);
        ...
        [ConstantAttribute()]
        public IOrderedSetExpression<IEGenericType> EBounds
        {
            get
            {
        ...
        private static ITypedElement RetrieveEBoundsReference()
        {
            return ((ITypedElement)(((ModelElement)(NMF.Interop.Ecore.ETypeParameter.ClassInstance)).Resolve("eBounds")));
        }
        ...
        private void EBoundsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
            this.OnCollectionChanging("EBounds", e, _eBoundsReference);
        }
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void EBoundsCollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            this.OnCollectionChanged("EBounds", e, _eBoundsReference);
        }
        ...
        public class ETypeParameterChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.EBounds.AsNotifiable()};
            }
