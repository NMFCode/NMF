...
namespace NMF.Interop.Ecore
{
    ...
    public partial class EAnnotation : EModelElement, IEAnnotation, IModelElement
    {
        ...
        private static Lazy<ITypedElement> _detailsReference = new Lazy<ITypedElement>(RetrieveDetailsReference);
        ...
        [ConstantAttribute()]
        public IOrderedSetExpression<IEStringToStringMapEntry> Details
        {
            get
            {
        ...
        [ContainmentAttribute()]
        [ConstantAttribute()]
        public IOrderedSetExpression<IModelElement> Contents
        {
            get
            {
        ...
        [XmlAttributeAttribute(true)]
        [ConstantAttribute()]
        public IOrderedSetExpression<IModelElement> References
        {
            get
            {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> SourceChanging;
        
        /// <summary>
        /// Gets fired before the EModelElement property changes its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> EModelElementChanging;
        ...
        {
            return ((ITypedElement)(((ModelElement)(NMF.Interop.Ecore.EAnnotation.ClassInstance)).Resolve("source")));
        }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.SourceChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private static ITypedElement RetrieveDetailsReference()
        {
            return ((ITypedElement)(((ModelElement)(NMF.Interop.Ecore.EAnnotation.ClassInstance)).Resolve("details")));
        }
        ...
        {
            this.OnCollectionChanging("Details", e, _detailsReference);
        }
        ...
        {
            this.OnCollectionChanged("Details", e, _detailsReference);
        }
        
        private static ITypedElement RetrieveEModelElementReference()
        {
            return ((ITypedElement)(((ModelElement)(NMF.Interop.Ecore.EAnnotation.ClassInstance)).Resolve("eModelElement")));
        }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.EModelElementChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            return ((ITypedElement)(((ModelElement)(NMF.Interop.Ecore.EAnnotation.ClassInstance)).Resolve("contents")));
        }
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void ContentsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        {
            return ((ITypedElement)(((ModelElement)(NMF.Interop.Ecore.EAnnotation.ClassInstance)).Resolve("references")));
        }
        ...
        {
            if ((container == this._details))
            {
                return "details";
            }
            if ((container == this._contents))
            {
                return "contents";
            }
        ...
        public class EAnnotationChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.Details.AsNotifiable(),
                        this._parent.Contents.AsNotifiable()};
            }
        ...
        public class EAnnotationReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.Details.AsNotifiable(),
                        new EModelElementProxy(this._parent),
                        this._parent.Contents.AsNotifiable(),
                        this._parent.References.AsNotifiable()};
            }
