...
namespace NMF.Interop.Ecore
{
    ...
    /// <summary>
    /// Denotes a class to implement the eStructuralFeatures reference
    /// </summary>
    public class EClassEStructuralFeaturesCollection : ObservableOppositeOrderedSet<IEClass, IEStructuralFeature>
    {
        ...
        /// </summary>
        /// <param name="parent">the parent EClass</param>
        ...
        protected override void SetOpposite(IEStructuralFeature item, IEClass newParent)
        {
            if ((newParent != null))
            {
                item.ParentChanged += this.OnItemParentChanged;
                item.EContainingClass = newParent;
            }
            else
            {
                item.ParentChanged -= this.OnItemParentChanged;
