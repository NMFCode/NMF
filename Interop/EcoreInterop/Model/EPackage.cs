...
namespace NMF.Interop.Ecore
{
    ...
    public class EPackage : ENamedElement, IEPackage, IModelElement
    {
        ...
        public virtual string NsURI
        {
            ...
            set
            {
                if ((value != this._nsURI))
                {
                    this._nsURI = value;
                    this.OnNsURIChanged(EventArgs.Empty);
                    this.OnPropertyChanged("NsURI");
                }
            }
        }
        ...
        public virtual string NsPrefix
        {
            ...
            set
            {
                if ((value != this._nsPrefix))
                {
                    this._nsPrefix = value;
                    this.OnNsPrefixChanged(EventArgs.Empty);
                    this.OnPropertyChanged("NsPrefix");
                }
            }
        }
        ...
        public virtual IEFactory EFactoryInstance
        {
            ...
            set
            {
                if ((this._eFactoryInstance != value))
                {
                    ...
                    this.OnPropertyChanged("EFactoryInstance");
                    this.OnEFactoryInstanceChanged(new ValueChangedEventArgs(old, value));
                }
            }
        }
        ...
        /// </summary>
        public event EventHandler NsURIChanged;
        
        /// <summary>
        /// Gets fired when the NsPrefix property changed its value
        /// </summary>
        public event EventHandler NsPrefixChanged;
        ...
        protected virtual void OnNsURIChanged(EventArgs eventArgs)
        {
            EventHandler handler = this.NsURIChanged;
            if ((handler != null))
            {
        ...
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnNsPrefixChanged(EventArgs eventArgs)
        {
            EventHandler handler = this.NsPrefixChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        protected override void OnParentChanged(IModelElement newParent, IModelElement oldParent)
        {
            ...
            this.OnPropertyChanged("ESuperPackage");
            this.OnESuperPackageChanged(new ValueChangedEventArgs(oldESuperPackage, newESuperPackage));
        }
