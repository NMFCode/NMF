...
namespace NMF.Interop.Ecore
{
    ...
    /// <summary>
    /// Denotes a class to implement the eClassifiers reference
    /// </summary>
    public class EPackageEClassifiersCollection : ObservableOppositeOrderedSet<IEPackage, IEClassifier>
    {
        ...
        /// </summary>
        /// <param name="parent">the parent EPackage</param>
        ...
        protected override void SetOpposite(IEClassifier item, IEPackage newParent)
        {
            if ((newParent != null))
            {
                item.ParentChanged += this.OnItemParentChanged;
                item.EPackage = newParent;
            }
            else
            {
                item.ParentChanged -= this.OnItemParentChanged;
