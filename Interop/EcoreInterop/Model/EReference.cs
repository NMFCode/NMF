...
namespace NMF.Interop.Ecore
{
    ...
    public partial class EReference : EStructuralFeature, IEReference, IModelElement
    {
        ...
        private static Lazy<ITypedElement> _containmentAttribute = new Lazy<ITypedElement>(RetrieveContainmentAttribute);
        ...
        private static Lazy<ITypedElement> _resolveProxiesAttribute = new Lazy<ITypedElement>(RetrieveResolveProxiesAttribute);
        
        private static Lazy<ITypedElement> _eOppositeReference = new Lazy<ITypedElement>(RetrieveEOppositeReference);
        ...
        private static Lazy<ITypedElement> _eKeysReference = new Lazy<ITypedElement>(RetrieveEKeysReference);
        ...
        public Nullable<bool> Containment
        {
            get
            {
            ...
            set
            {
                if ((this._containment != value))
                {
                    ...
                    this.OnPropertyChanging("Containment", e, _containmentAttribute);
                    this._containment = value;
                    this.OnContainmentChanged(e);
                    this.OnPropertyChanged("Containment", e, _containmentAttribute);
                }
            }
        }
        ...
        [XmlAttributeAttribute(true)]
        public Nullable<bool> ResolveProxies
        {
            get
            {
            ...
            set
            {
                if ((this._resolveProxies != value))
                {
                    ...
                    this.OnPropertyChanging("ResolveProxies", e, _resolveProxiesAttribute);
                    this._resolveProxies = value;
                    this.OnResolveProxiesChanged(e);
                    this.OnPropertyChanged("ResolveProxies", e, _resolveProxiesAttribute);
                }
            }
        }
        ...
        public IEReference EOpposite
        {
            ...
            set
            {
                if ((this._eOpposite != value))
                {
                    ...
                    this.OnPropertyChanging("EOpposite", e, _eOppositeReference);
                    ...
                    this.OnPropertyChanged("EOpposite", e, _eOppositeReference);
                }
            }
        }
        ...
        [XmlAttributeAttribute(true)]
        [ConstantAttribute()]
        public IOrderedSetExpression<IEAttribute> EKeys
        {
            get
            {
                return this._eKeys;
        ...
        private static ITypedElement RetrieveContainmentAttribute()
        {
            return ((ITypedElement)(((ModelElement)(NMF.Interop.Ecore.EReference.ClassInstance)).Resolve("containment")));
        }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ContainmentChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private static ITypedElement RetrieveResolveProxiesAttribute()
        {
            return ((ITypedElement)(((ModelElement)(NMF.Interop.Ecore.EReference.ClassInstance)).Resolve("resolveProxies")));
        }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ResolveProxiesChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private static ITypedElement RetrieveEOppositeReference()
        {
            return ((ITypedElement)(((ModelElement)(NMF.Interop.Ecore.EReference.ClassInstance)).Resolve("eOpposite")));
        }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.EOppositeChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            if ((sender == this.EOpposite))
            {
                this.EOpposite = null;
            }
        }
        
        private static ITypedElement RetrieveEKeysReference()
        {
            return ((ITypedElement)(((ModelElement)(NMF.Interop.Ecore.EReference.ClassInstance)).Resolve("eKeys")));
        }
        ...
        private void EKeysCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
            this.OnCollectionChanging("EKeys", e, _eKeysReference);
        }
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void EKeysCollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            this.OnCollectionChanged("EKeys", e, _eKeysReference);
        }
        ...
        protected override IModelElement GetModelElementForReference(string reference, int index)
        {
            ...
            if ((reference == "EKEYS"))
            {
                if ((index < this.EKeys.Count))
                {
                    return this.EKeys[index];
                }
                else
                {
                    return null;
        ...
        protected override NMF.Expressions.INotifyExpression<object> GetExpressionForAttribute(string attribute)
        {
            if ((attribute == "CONTAINMENT"))
            {
                return Observable.Box(new ContainmentProxy(this));
            }
            if ((attribute == "RESOLVEPROXIES"))
            {
                return Observable.Box(new ResolveProxiesProxy(this));
            }
        ...
        public class EReferenceReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new EOppositeProxy(this._parent),
                        this._parent.EKeys.AsNotifiable()};
            }
