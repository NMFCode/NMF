...
namespace NMF.Interop.Ecore
{
    ...
    public class EClass : EClassifier, IEClass, IModelElement
    {
        ...
        public virtual Nullable<bool> Abstract
        {
            ...
            set
            {
                if ((value != this._abstract))
                {
                    ...
                    this.OnAbstractChanged(EventArgs.Empty);
        ...
        public virtual Nullable<bool> Interface
        {
            ...
            set
            {
                if ((value != this._interface))
                {
                    this._interface = value;
                    this.OnInterfaceChanged(EventArgs.Empty);
        ...
        /// </summary>
        public event EventHandler AbstractChanged;
        ...
        protected virtual void OnAbstractChanged(EventArgs eventArgs)
        {
            EventHandler handler = this.AbstractChanged;
            if ((handler != null))
            {
        ...
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnInterfaceChanged(EventArgs eventArgs)
        {
            EventHandler handler = this.InterfaceChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            return NMF.Models.Repository.MetaRepository.Instance.ResolveClass("http://www.eclipse.org/emf/2002/Ecore#//EClass/");
        }
