...
namespace NMF.Interop.Ecore
{
    ...
    public class EGenericType : ModelElement, IEGenericType, IModelElement
    {
        ...
        public virtual IEGenericType EUpperBound
        {
            ...
            set
            {
                if ((this._eUpperBound != value))
                {
                    ...
                    this.OnPropertyChanged("EUpperBound");
                    this.OnEUpperBoundChanged(new ValueChangedEventArgs(old, value));
                }
            }
        }
        ...
        public virtual IEGenericType ELowerBound
        {
            ...
            set
            {
                if ((this._eLowerBound != value))
                {
                    ...
                    this.OnPropertyChanged("ELowerBound");
                    this.OnELowerBoundChanged(new ValueChangedEventArgs(old, value));
                }
            }
        }
        ...
        public virtual IETypeParameter ETypeParameter
        {
            ...
            set
            {
                if ((this._eTypeParameter != value))
                {
                    ...
                    this.OnPropertyChanged("ETypeParameter");
                    this.OnETypeParameterChanged(new ValueChangedEventArgs(old, value));
                }
            }
        }
        ...
        public virtual IEClassifier EClassifier
        {
            ...
            set
            {
                if ((this._eClassifier != value))
                {
                    ...
                    this.OnPropertyChanged("EClassifier");
                    this.OnEClassifierChanged(new ValueChangedEventArgs(old, value));
                }
            }
        }
        ...
        {
            return NMF.Models.Repository.MetaRepository.Instance.ResolveClass("http://www.eclipse.org/emf/2002/Ecore#//EGenericType/");
        }
