...
namespace NMF.Interop.Cmof
{
    ...
    [ModelRepresentationClassAttribute("http://www.omg.org/spec/MOF/20131001/cmof.xmi#//Expression")]
    ...
    public partial class Expression : ValueSpecification, IExpression, IModelElement
    {
        ...
        [DescriptionAttribute("The symbol associated with the node in the expression tree.")]
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((NMF.Models.Meta.IClass)(MetaRepository.Instance.Resolve("http://www.omg.org/spec/MOF/20131001/cmof.xmi#//Expression")));
                }
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> SymbolChanging;
        
        private static NMF.Models.Meta.ITypedElement RetrieveSymbolAttribute()
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Cmof.Expression.ClassInstance)).Resolve("symbol")));
        }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.SymbolChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Cmof.Expression.ClassInstance)).Resolve("operand")));
        }
        ...
        public class ExpressionChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.Operand.AsNotifiable()};
            }
