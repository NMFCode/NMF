...
namespace NMF.Interop.Cmof
{
    ...
    public partial class Slot : Element, ISlot, IModelElement
    {
        ...
        public IStructuralFeature DefiningFeature
        {
            ...
            set
            {
                if ((this._definingFeature != value))
                {
                    ...
                    this.OnDefiningFeatureChanging(e);
                    ...
                    this.OnDefiningFeatureChanged(e);
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> DefiningFeatureChanging;
        
        /// <summary>
        /// Gets fired when the DefiningFeature property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> DefiningFeatureChanged;
        
        /// <summary>
        /// Gets fired before the OwningInstance property changes its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> OwningInstanceChanging;
        
        /// <summary>
        /// Gets fired when the OwningInstance property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> OwningInstanceChanged;
        ...
        /// <summary>
        /// Raises the DefiningFeatureChanging event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnDefiningFeatureChanging(ValueChangedEventArgs eventArgs)
        {
            EventHandler<ValueChangedEventArgs> handler = this.DefiningFeatureChanging;
            if ((handler != null))
            {
        ...
        /// <summary>
        /// Raises the DefiningFeatureChanged event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnDefiningFeatureChanged(ValueChangedEventArgs eventArgs)
        {
            EventHandler<ValueChangedEventArgs> handler = this.DefiningFeatureChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private void OnResetDefiningFeature(object sender, EventArgs eventArgs)
        {
        ...
        /// <summary>
        /// Raises the OwningInstanceChanging event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnOwningInstanceChanging(ValueChangedEventArgs eventArgs)
        {
            EventHandler<ValueChangedEventArgs> handler = this.OwningInstanceChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        protected override void OnParentChanging(IModelElement newParent, IModelElement oldParent)
        {
            ...
            this.OnOwningInstanceChanging(e);
            this.OnPropertyChanging("OwningInstance", e, _owningInstanceReference);
        }
        
        /// <summary>
        /// Raises the OwningInstanceChanged event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnOwningInstanceChanged(ValueChangedEventArgs eventArgs)
        {
            EventHandler<ValueChangedEventArgs> handler = this.OwningInstanceChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        protected override void OnParentChanged(IModelElement newParent, IModelElement oldParent)
        {
            ...
            ValueChangedEventArgs e = new ValueChangedEventArgs(oldOwningInstance, newOwningInstance);
            this.OnOwningInstanceChanged(e);
        ...
        public class SlotChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.Value.AsNotifiable()};
            }
        ...
        public class SlotReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            {
                return new INotifiable[] {
                        new DefiningFeatureProxy(this._parent),
                        this._parent.Value.AsNotifiable(),
                        new OwningInstanceProxy(this._parent)};
            }
