...
namespace NMF.Interop.Cmof
{
    ...
    [ModelRepresentationClassAttribute("http://www.omg.org/spec/MOF/20131001/cmof.xmi#//LiteralInteger")]
    [DebuggerDisplayAttribute("LiteralInteger {Name}")]
    public partial class LiteralInteger : LiteralSpecification, ILiteralInteger, IModelElement
    {
        ...
        [DescriptionAttribute("The specified Integer value.")]
        [CategoryAttribute("LiteralInteger")]
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((NMF.Models.Meta.IClass)(MetaRepository.Instance.Resolve("http://www.omg.org/spec/MOF/20131001/cmof.xmi#//LiteralInteger")));
                }
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Cmof.LiteralInteger.ClassInstance)).Resolve("value")));
        }
        ...
        /// </summary>
        private sealed class ValueProxy : ModelPropertyChange<ILiteralInteger, int>
        {
            ...
            public ValueProxy(ILiteralInteger modelElement) : 
