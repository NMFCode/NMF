...
namespace NMF.Interop.Cmof
{
    ...
    public abstract partial class Classifier : Namespace, IClassifier, IModelElement
    {
        ...
        private static System.Lazy<NMF.Models.Meta.IOperation> _generalOperation = new System.Lazy<NMF.Models.Meta.IOperation>(RetrieveGeneralOperation);
        ...
        private static System.Lazy<NMF.Models.Meta.IOperation> _inheritedMemberOperation = new System.Lazy<NMF.Models.Meta.IOperation>(RetrieveInheritedMemberOperation);
        ...
        {
            System.Func<IClassifier, ISetExpression<IClassifier>> handler = OperationBroker.Instance.GetRegisteredDelegate<System.Func<IClassifier, ISetExpression<IClassifier>>>(_generalOperation);
            if ((handler != null))
            {
            }
            else
            {
                throw new System.InvalidOperationException("There is no implementation for method general registered. Use the method broker t" +
                        "o register a method implementation.");
            }
            OperationCallEventArgs e = new OperationCallEventArgs(this, _generalOperation.Value);
            this.OnBubbledChange(BubbledChangeEventArgs.OperationCalling(this, _generalOperation.Value, e));
            ISetExpression<IClassifier> result = handler.Invoke(this);
            e.Result = result;
            this.OnBubbledChange(BubbledChangeEventArgs.OperationCalled(this, _generalOperation.Value, e));
            return result;
        }
        
        private static NMF.Models.Meta.IOperation RetrieveGeneralOperation()
        {
            return ClassInstance.LookupOperation("general");
        }
        ...
        /// </summary>
        public ISetExpression<INamedElement> InheritedMember()
        {
            System.Func<IClassifier, ISetExpression<INamedElement>> handler = OperationBroker.Instance.GetRegisteredDelegate<System.Func<IClassifier, ISetExpression<INamedElement>>>(_inheritedMemberOperation);
            if ((handler != null))
            {
            }
            else
            {
                throw new System.InvalidOperationException("There is no implementation for method inheritedMember registered. Use the method " +
                        "broker to register a method implementation.");
            }
            OperationCallEventArgs e = new OperationCallEventArgs(this, _inheritedMemberOperation.Value);
            this.OnBubbledChange(BubbledChangeEventArgs.OperationCalling(this, _inheritedMemberOperation.Value, e));
            ISetExpression<INamedElement> result = handler.Invoke(this);
            e.Result = result;
            this.OnBubbledChange(BubbledChangeEventArgs.OperationCalled(this, _inheritedMemberOperation.Value, e));
            return result;
        }
        
        private static NMF.Models.Meta.IOperation RetrieveInheritedMemberOperation()
        {
            return ClassInstance.LookupOperation("inheritedMember");
        }
        ...
        public class ClassifierReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            public override IEnumerator<IModelElement> GetEnumerator()
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.Generalization).Concat(this._parent.RedefinedClassifier).GetEnumerator();
            }
        }
