...
namespace NMF.Interop.Cmof
{
    ...
    public partial class Link : Object, ILink, IModelElement
    {
        ...
        public IElement SecondElement
        {
            ...
            set
            {
                if ((this._secondElement != value))
                {
                    ...
                    ValueChangedEventArgs e = new ValueChangedEventArgs(old, value);
                    this.OnSecondElementChanging(e);
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((NMF.Models.Meta.IClass)(MetaRepository.Instance.Resolve("http://www.omg.org/spec/MOF/20131001/cmof.xmi#//Link")));
                }
        ...
        public void Delete()
        {
            System.Action<ILink> handler = OperationBroker.Instance.GetRegisteredDelegate<System.Action<ILink>>(_deleteOperation);
            if ((handler != null))
            {
            }
            else
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Cmof.Link.ClassInstance)).Resolve("firstElement")));
        }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.FirstElementChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.FirstElementChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private void OnResetFirstElement(object sender, EventArgs eventArgs)
        {
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Cmof.Link.ClassInstance)).Resolve("secondElement")));
        }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.SecondElementChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.SecondElementChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <param name="sender">The object that sent this reset request</param>
        /// <param name="eventArgs">The event data for the reset event</param>
        private void OnResetSecondElement(object sender, EventArgs eventArgs)
        {
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Cmof.Link.ClassInstance)).Resolve("association")));
        }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.AssociationChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.AssociationChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <param name="sender">The object that sent this reset request</param>
        /// <param name="eventArgs">The event data for the reset event</param>
        private void OnResetAssociation(object sender, EventArgs eventArgs)
        {
        ...
        public class LinkReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new FirstElementProxy(this._parent),
                        new SecondElementProxy(this._parent),
                        new AssociationProxy(this._parent)};
            }
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.FirstElement).Concat(this._parent.SecondElement).Concat(this._parent.Association).GetEnumerator();
            }
        }
