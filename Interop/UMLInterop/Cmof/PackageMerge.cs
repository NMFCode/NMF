...
namespace NMF.Interop.Cmof
{
    ...
    [ModelRepresentationClassAttribute("http://www.omg.org/spec/MOF/20131001/cmof.xmi#//PackageMerge")]
    public partial class PackageMerge : DirectedRelationship, IPackageMerge, IModelElement
    {
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((NMF.Models.Meta.IClass)(MetaRepository.Instance.Resolve("http://www.omg.org/spec/MOF/20131001/cmof.xmi#//PackageMerge")));
                }
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> MergedPackageChanging;
        
        /// <summary>
        /// Gets fired when the MergedPackage property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> MergedPackageChanged;
        
        /// <summary>
        /// Gets fired before the ReceivingPackage property changes its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ReceivingPackageChanging;
        
        /// <summary>
        /// Gets fired when the ReceivingPackage property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ReceivingPackageChanged;
        
        private static NMF.Models.Meta.ITypedElement RetrieveMergedPackageReference()
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Cmof.PackageMerge.ClassInstance)).Resolve("mergedPackage")));
        }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.MergedPackageChanging;
            if ((handler != null))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.MergedPackageChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private void OnResetMergedPackage(object sender, EventArgs eventArgs)
        {
            if ((sender == this.MergedPackage))
            {
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Cmof.PackageMerge.ClassInstance)).Resolve("receivingPackage")));
        }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ReceivingPackageChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ReceivingPackageChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        public class PackageMergeReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new MergedPackageProxy(this._parent),
                        new ReceivingPackageProxy(this._parent)};
            }
