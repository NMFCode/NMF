...
namespace NMF.Interop.Cmof
{
    ...
    public partial class Factory : Element, IFactory, IModelElement
    {
        ...
        private static Lazy<NMF.Models.Meta.IOperation> _createFromStringOperation = new Lazy<NMF.Models.Meta.IOperation>(RetrieveCreateFromStringOperation);
        
        private static Lazy<NMF.Models.Meta.IOperation> _convertToStringOperation = new Lazy<NMF.Models.Meta.IOperation>(RetrieveConvertToStringOperation);
        
        private static Lazy<NMF.Models.Meta.IOperation> _createOperation = new Lazy<NMF.Models.Meta.IOperation>(RetrieveCreateOperation);
        
        private static Lazy<NMF.Models.Meta.IOperation> _createElementOperation = new Lazy<NMF.Models.Meta.IOperation>(RetrieveCreateElementOperation);
        
        private static Lazy<NMF.Models.Meta.IOperation> _createLinkOperation = new Lazy<NMF.Models.Meta.IOperation>(RetrieveCreateLinkOperation);
        ...
        /// </summary>
        public event EventHandler<OperationCallEventArgs> CreateElementCalling;
        
        /// <summary>
        /// Gets fired after the operation createElement got called
        /// </summary>
        public event EventHandler<OperationCallEventArgs> CreateElementCalled;
        
        /// <summary>
        /// Gets fired before the operation createLink gets called
        /// </summary>
        public event EventHandler<OperationCallEventArgs> CreateLinkCalling;
        
        /// <summary>
        /// Gets fired after the operation createLink got called
        /// </summary>
        public event EventHandler<OperationCallEventArgs> CreateLinkCalled;
        ...
        public IElement CreateElement(NMF.Interop.Cmof.IClass @class, IEnumerable<IArgument> arguments)
        {
            ...
            {
                throw new InvalidOperationException(("There is no implementation for method createElement registered. Use the method br" +
                        "oker to register a method implementation."));
            }
            OperationCallEventArgs e = new OperationCallEventArgs(this, _createElementOperation.Value, @class, arguments);
            this.OnCreateElementCalling(e);
        ...
        /// <summary>
        /// Raises the CreateElementCalling event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnCreateElementCalling(OperationCallEventArgs eventArgs)
        {
            EventHandler<OperationCallEventArgs> handler = this.CreateElementCalling;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <summary>
        /// Raises the CreateElementCalled event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnCreateElementCalled(OperationCallEventArgs eventArgs)
        {
            EventHandler<OperationCallEventArgs> handler = this.CreateElementCalled;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        public ILink CreateLink(IAssociation association, IElement firstElement, IElement secondElement)
        {
            ...
            {
                throw new InvalidOperationException(("There is no implementation for method createLink registered. Use the method broke" +
        ...
        /// <summary>
        /// Raises the CreateLinkCalling event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnCreateLinkCalling(OperationCallEventArgs eventArgs)
        {
            EventHandler<OperationCallEventArgs> handler = this.CreateLinkCalling;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <summary>
        /// Raises the CreateLinkCalled event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnCreateLinkCalled(OperationCallEventArgs eventArgs)
        {
            EventHandler<OperationCallEventArgs> handler = this.CreateLinkCalled;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private void OnResetPackage(object sender, EventArgs eventArgs)
        {
