...
namespace NMF.Interop.Cmof
{
    ...
    public partial class DataType : Classifier, NMF.Interop.Cmof.IDataType, IModelElement
    {
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((NMF.Models.Meta.IClass)(MetaRepository.Instance.Resolve("http://www.omg.org/spec/MOF/20131001/cmof.xmi#//DataType")));
                }
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Cmof.DataType.ClassInstance)).Resolve("ownedAttribute")));
        }
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Cmof.DataType.ClassInstance)).Resolve("ownedOperation")));
        }
        ...
        public class DataTypeChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.OwnedAttribute.AsNotifiable(),
                        this._parent.OwnedOperation.AsNotifiable()};
            }
