...
namespace NMF.Interop.Cmof
{
    ...
    public partial class Generalization : DirectedRelationship, IGeneralization, IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> IsSubstitutableChanged;
        
        /// <summary>
        /// Gets fired before the IsSubstitutable property changes its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> IsSubstitutableChanging;
        
        /// <summary>
        /// Gets fired before the General property changes its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> GeneralChanging;
        
        /// <summary>
        /// Gets fired when the General property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> GeneralChanged;
        
        /// <summary>
        /// Gets fired before the Specific property changes its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> SpecificChanging;
        
        /// <summary>
        /// Gets fired when the Specific property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> SpecificChanged;
        ...
        /// <summary>
        /// Raises the IsSubstitutableChanged event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnIsSubstitutableChanged(ValueChangedEventArgs eventArgs)
        {
            EventHandler<ValueChangedEventArgs> handler = this.IsSubstitutableChanged;
            if ((handler != null))
            {
        ...
        /// <summary>
        /// Raises the IsSubstitutableChanging event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnIsSubstitutableChanging(ValueChangedEventArgs eventArgs)
        {
            EventHandler<ValueChangedEventArgs> handler = this.IsSubstitutableChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.GeneralChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.GeneralChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private void OnResetGeneral(object sender, EventArgs eventArgs)
        {
        ...
        /// <summary>
        /// Raises the SpecificChanging event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnSpecificChanging(ValueChangedEventArgs eventArgs)
        {
            EventHandler<ValueChangedEventArgs> handler = this.SpecificChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        protected override void OnParentChanging(IModelElement newParent, IModelElement oldParent)
        {
            ...
            this.OnSpecificChanging(e);
            this.OnPropertyChanging("Specific", e, _specificReference);
        }
        
        /// <summary>
        /// Raises the SpecificChanged event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnSpecificChanged(ValueChangedEventArgs eventArgs)
        {
            EventHandler<ValueChangedEventArgs> handler = this.SpecificChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        public class GeneralizationReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new GeneralProxy(this._parent),
                        new SpecificProxy(this._parent)};
            }
