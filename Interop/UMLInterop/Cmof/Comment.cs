    ...
    public partial class Comment : Element, IComment, IModelElement
    {
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((NMF.Models.Meta.IClass)(MetaRepository.Instance.Resolve("http://www.omg.org/spec/MOF/20131001/cmof.xmi#//Comment")));
                }
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> BodyChanging;
        
        private static NMF.Models.Meta.ITypedElement RetrieveBodyAttribute()
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Cmof.Comment.ClassInstance)).Resolve("body")));
        }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.BodyChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Cmof.Comment.ClassInstance)).Resolve("annotatedElement")));
        }
        ...
        public class CommentReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.AnnotatedElement.AsNotifiable()};
            }
