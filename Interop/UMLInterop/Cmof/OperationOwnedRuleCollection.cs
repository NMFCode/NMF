...
namespace NMF.Interop.Cmof
{
    ...
    public class OperationOwnedRuleCollection : ICollectionExpression<IConstraint>, ICollection<IConstraint>, IListExpression<IConstraint>, IList<IConstraint>
    {
        ...
        private NMF.Interop.Cmof.IOperation _parent;
        
        /// <summary>
        /// Creates a new instance
        /// </summary>
        public OperationOwnedRuleCollection(NMF.Interop.Cmof.IOperation parent)
        {
            this._parent = parent;
            parent.BubbledChange += this.HandleBodyConditionValueChange;
        ...
        private void HandleBodyConditionValueChange(object sender, BubbledChangeEventArgs e)
        {
            if (e.Element == _parent && e.ChangeType == ChangeType.PropertyChanged && e.PropertyName == "BodyCondition")
            {
                HandleValueChange(sender, (ValueChangedEventArgs)e.OriginalEventArgs);
            }
        }
        ...
        public virtual IConstraint this[int index]
        {
            get
            {
                ...
                if ((this._parent.BodyCondition != null))
                {
                    ...
                    {
                        return this._parent.BodyCondition;
                    }
            ...
            set
            {
                ...
                if ((this._parent.BodyCondition != null))
                {
                    if ((runningIndex == index))
                    {
                        this._parent.BodyCondition = value;
                    }
                    runningIndex = (runningIndex + 1);
                }
                if ((this._parent.Postcondition.Count 
        ...
        public virtual void Add(IConstraint item)
        {
            if ((this._parent.BodyCondition == null))
            {
                this._parent.BodyCondition = item;
                return;
            }
            this._parent.Postcondition.Add(item);
        }
        ...
        {
            return Enumerable.Empty<IConstraint>().Concat(this._parent.BodyCondition).Concat(this._parent.Postcondition).Concat(this._parent.Precondition).GetEnumerator();
        }
