...
namespace NMF.Interop.Cmof
{
    ...
    public partial class InstanceSpecification : PackageableElement, IInstanceSpecification, IModelElement
    {
        ...
        private static Lazy<NMF.Models.Meta.IOperation> _structural_featureOperation = new Lazy<NMF.Models.Meta.IOperation>(RetrieveStructural_featureOperation);
        
        private static Lazy<NMF.Models.Meta.IOperation> _defining_featureOperation = new Lazy<NMF.Models.Meta.IOperation>(RetrieveDefining_featureOperation);
        ...
        {
            EventHandler<OperationCallEventArgs> handler = this.Structural_featureCalling;
            if ((handler != null))
            {
        ...
        {
            EventHandler<OperationCallEventArgs> handler = this.Structural_featureCalled;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<OperationCallEventArgs> handler = this.Defining_featureCalling;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<OperationCallEventArgs> handler = this.Defining_featureCalled;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        public class InstanceSpecificationChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.Slot.AsNotifiable(),
        ...
        public class InstanceSpecificationReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            {
                return new INotifiable[] {
                        this._parent.Classifier.AsNotifiable(),
                        this._parent.Slot.AsNotifiable(),
                        new SpecificationProxy(this._parent)};
            }
