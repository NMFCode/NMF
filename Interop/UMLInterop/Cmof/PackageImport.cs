...
namespace NMF.Interop.Cmof
{
    ...
    public partial class PackageImport : DirectedRelationship, IPackageImport, IModelElement
    {
        ...
        private static Lazy<NMF.Models.Meta.IOperation> _public_or_privateOperation = new Lazy<NMF.Models.Meta.IOperation>(RetrievePublic_or_privateOperation);
        ...
        public IPackage ImportedPackage
        {
            ...
            set
            {
                if ((this._importedPackage != value))
                {
                    ...
                    ValueChangedEventArgs e = new ValueChangedEventArgs(old, value);
                    this.OnImportedPackageChanging(e);
                    ...
                    this.OnImportedPackageChanged(e);
        ...
        /// </summary>
        public event EventHandler<OperationCallEventArgs> Public_or_privateCalling;
        
        /// <summary>
        /// Gets fired after the operation public_or_private got called
        /// </summary>
        public event EventHandler<OperationCallEventArgs> Public_or_privateCalled;
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ImportedPackageChanging;
        
        /// <summary>
        /// Gets fired when the ImportedPackage property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ImportedPackageChanged;
        ...
        public bool Public_or_private(object diagnostics, object context)
        {
            ...
            {
                throw new InvalidOperationException(("There is no implementation for method public_or_private registered. Use the metho" +
        ...
        /// <summary>
        /// Raises the Public_or_privateCalling event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnPublic_or_privateCalling(OperationCallEventArgs eventArgs)
        {
            EventHandler<OperationCallEventArgs> handler = this.Public_or_privateCalling;
            if ((handler != null))
            {
        ...
        /// <summary>
        /// Raises the Public_or_privateCalled event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnPublic_or_privateCalled(OperationCallEventArgs eventArgs)
        {
            EventHandler<OperationCallEventArgs> handler = this.Public_or_privateCalled;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <summary>
        /// Raises the ImportedPackageChanging event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnImportedPackageChanging(ValueChangedEventArgs eventArgs)
        {
            EventHandler<ValueChangedEventArgs> handler = this.ImportedPackageChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <summary>
        /// Raises the ImportedPackageChanged event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnImportedPackageChanged(ValueChangedEventArgs eventArgs)
        {
            EventHandler<ValueChangedEventArgs> handler = this.ImportedPackageChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private void OnResetImportedPackage(object sender, EventArgs eventArgs)
        {
        ...
        public class PackageImportReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new ImportedPackageProxy(this._parent),
