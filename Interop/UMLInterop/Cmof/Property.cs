...
namespace NMF.Interop.Cmof
{
    ...
    public partial class Property : StructuralFeature, IProperty, IModelElement
    {
        ...
        private static System.Lazy<NMF.Models.Meta.IOperation> _oppositeOperation = new System.Lazy<NMF.Models.Meta.IOperation>(RetrieveOppositeOperation);
        ...
        {
            System.Func<IProperty, string> handler = OperationBroker.Instance.GetRegisteredDelegate<System.Func<IProperty, string>>(_defaultOperation);
            if ((handler != null))
            {
            }
            else
        ...
        {
            System.Func<IProperty, IProperty> handler = OperationBroker.Instance.GetRegisteredDelegate<System.Func<IProperty, IProperty>>(_oppositeOperation);
            if ((handler != null))
            {
            }
            else
            {
                throw new System.InvalidOperationException("There is no implementation for method opposite registered. Use the method broker " +
                        "to register a method implementation.");
            }
            OperationCallEventArgs e = new OperationCallEventArgs(this, _oppositeOperation.Value);
            this.OnBubbledChange(BubbledChangeEventArgs.OperationCalling(this, _oppositeOperation.Value, e));
            IProperty result = handler.Invoke(this);
            e.Result = result;
            this.OnBubbledChange(BubbledChangeEventArgs.OperationCalled(this, _oppositeOperation.Value, e));
            return result;
        }
        
        private static NMF.Models.Meta.IOperation RetrieveOppositeOperation()
        {
            return ClassInstance.LookupOperation("opposite");
        }
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Cmof.Property.ClassInstance)).Resolve("association")));
        }
        ...
        public class PropertyReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            public override IEnumerator<IModelElement> GetEnumerator()
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.Class).Concat(this._parent.Datatype).Concat(this._parent.Association).Concat(this._parent.OwningAssociation).Concat(this._parent.DefaultValue).Concat(this._parent.RedefinedProperty).Concat(this._parent.SubsettedProperty).GetEnumerator();
            }
        }
