...
namespace NMF.Interop.Cmof
{
    ...
    public partial class Tag : Element, ITag, IModelElement
    {
        ...
        private static Lazy<NMF.Models.Meta.ITypedElement> _tagOwnerReference = new Lazy<NMF.Models.Meta.ITypedElement>(RetrieveTagOwnerReference);
        
        /// <summary>
        /// The backing field for the TagOwner property
        /// </summary>
        [DebuggerBrowsableAttribute(DebuggerBrowsableState.Never)]
        private IElement _tagOwner;
        ...
        [XmlAttributeAttribute(true)]
        public IElement TagOwner
        {
            get
            {
                return this._tagOwner;
            }
            set
            {
                if ((this._tagOwner != value))
                {
                    IElement old = this._tagOwner;
                    ValueChangedEventArgs e = new ValueChangedEventArgs(old, value);
                    this.OnTagOwnerChanging(e);
                    this.OnPropertyChanging("TagOwner", e, _tagOwnerReference);
                    this._tagOwner = value;
                    if ((old != null))
                    {
                        old.Deleted -= this.OnResetTagOwner;
                    }
                    if ((value != null))
                    {
                        value.Deleted += this.OnResetTagOwner;
                    }
                    this.OnTagOwnerChanged(e);
                    this.OnPropertyChanged("TagOwner", e, _tagOwnerReference);
                }
            }
        }
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((NMF.Models.Meta.IClass)(MetaRepository.Instance.Resolve("http://www.omg.org/spec/MOF/20131001/cmof.xmi#//Tag")));
                }
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> TagOwnerChanging;
        
        /// <summary>
        /// Gets fired when the TagOwner property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> TagOwnerChanged;
        
        private static NMF.Models.Meta.ITypedElement RetrieveNameAttribute()
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Cmof.Tag.ClassInstance)).Resolve("name")));
        }
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Cmof.Tag.ClassInstance)).Resolve("value")));
        }
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Cmof.Tag.ClassInstance)).Resolve("element")));
        }
        ...
        private static NMF.Models.Meta.ITypedElement RetrieveTagOwnerReference()
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Cmof.Tag.ClassInstance)).Resolve("tagOwner")));
        }
        
        /// <summary>
        /// Raises the TagOwnerChanging event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnTagOwnerChanging(ValueChangedEventArgs eventArgs)
        {
            EventHandler<ValueChangedEventArgs> handler = this.TagOwnerChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <summary>
        /// Raises the TagOwnerChanged event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnTagOwnerChanged(ValueChangedEventArgs eventArgs)
        {
            EventHandler<ValueChangedEventArgs> handler = this.TagOwnerChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <summary>
        /// Handles the event that the TagOwner property must reset
        /// </summary>
        /// <param name="sender">The object that sent this reset request</param>
        /// <param name="eventArgs">The event data for the reset event</param>
        private void OnResetTagOwner(object sender, EventArgs eventArgs)
        {
            if ((sender == this.TagOwner))
            {
                this.TagOwner = null;
            }
        }
        ...
        public class TagReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.Element.AsNotifiable(),
                        new TagOwnerProxy(this._parent)};
            }
            ...
            public override void Add(IModelElement item)
            {
                ...
                if ((this._parent.TagOwner == null))
                {
                    IElement tagOwnerCasted = item.As<IElement>();
                    if ((tagOwnerCasted != null))
                    {
                        this._parent.TagOwner = tagOwnerCasted;
                        return;
                    }
                }
            }
            ...
            public override void CopyTo(IModelElement[] array, int arrayIndex)
            {
                ...
                if ((this._parent.TagOwner != null))
                {
                    array[arrayIndex] = this._parent.TagOwner;
                    arrayIndex = (arrayIndex + 1);
                }
            }
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.Element).Concat(this._parent.TagOwner).GetEnumerator();
            }
        }
        ...
        /// <summary>
        /// Represents a proxy to represent an incremental access to the tagOwner property
        /// </summary>
        private sealed class TagOwnerProxy : ModelPropertyChange<ITag, IElement>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public TagOwnerProxy(ITag modelElement) : 
                    base(modelElement, "tagOwner")
            {
            }
            ...
            public override IElement Value
            {
                get
                {
                    return this.ModelElement.TagOwner;
                }
                set
                {
                    this.ModelElement.TagOwner = value;
                }
            }
        }
    }
