...
namespace NMF.Interop.Cmof
{
    ...
    public abstract partial class MultiplicityElement : Element, IMultiplicityElement, IModelElement
    {
        ...
        public int Lower()
        {
            System.Func<IMultiplicityElement, int> handler = OperationBroker.Instance.GetRegisteredDelegate<System.Func<IMultiplicityElement, int>>(_lowerOperation);
            if ((handler != null))
            {
            }
            else
        ...
        public void Upper()
        {
            System.Action<IMultiplicityElement> handler = OperationBroker.Instance.GetRegisteredDelegate<System.Action<IMultiplicityElement>>(_upperOperation);
            if ((handler != null))
            {
            }
            else
