...
namespace NMF.Interop.Cmof
{
    ...
    public partial class Constraint : PackageableElement, IConstraint, IModelElement
    {
        ...
        private static Lazy<NMF.Models.Meta.IOperation> _value_specification_booleanOperation = new Lazy<NMF.Models.Meta.IOperation>(RetrieveValue_specification_booleanOperation);
        
        private static Lazy<NMF.Models.Meta.IOperation> _boolean_valueOperation = new Lazy<NMF.Models.Meta.IOperation>(RetrieveBoolean_valueOperation);
        
        private static Lazy<NMF.Models.Meta.IOperation> _not_apply_to_selfOperation = new Lazy<NMF.Models.Meta.IOperation>(RetrieveNot_apply_to_selfOperation);
        
        private static Lazy<NMF.Models.Meta.IOperation> _no_side_effectsOperation = new Lazy<NMF.Models.Meta.IOperation>(RetrieveNo_side_effectsOperation);
        ...
        /// </summary>
        public event EventHandler<OperationCallEventArgs> Value_specification_booleanCalling;
        
        /// <summary>
        /// Gets fired after the operation value_specification_boolean got called
        /// </summary>
        public event EventHandler<OperationCallEventArgs> Value_specification_booleanCalled;
        
        /// <summary>
        /// Gets fired before the operation boolean_value gets called
        /// </summary>
        public event EventHandler<OperationCallEventArgs> Boolean_valueCalling;
        
        /// <summary>
        /// Gets fired after the operation boolean_value got called
        /// </summary>
        public event EventHandler<OperationCallEventArgs> Boolean_valueCalled;
        
        /// <summary>
        /// Gets fired before the operation not_apply_to_self gets called
        /// </summary>
        public event EventHandler<OperationCallEventArgs> Not_apply_to_selfCalling;
        
        /// <summary>
        /// Gets fired after the operation not_apply_to_self got called
        /// </summary>
        public event EventHandler<OperationCallEventArgs> Not_apply_to_selfCalled;
        
        /// <summary>
        /// Gets fired before the operation no_side_effects gets called
        /// </summary>
        public event EventHandler<OperationCallEventArgs> No_side_effectsCalling;
        
        /// <summary>
        /// Gets fired after the operation no_side_effects got called
        /// </summary>
        public event EventHandler<OperationCallEventArgs> No_side_effectsCalled;
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ContextChanging;
        
        /// <summary>
        /// Gets fired when the Context property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ContextChanged;
        ...
        public bool Value_specification_boolean(object diagnostics, object context)
        {
            ...
            {
                throw new InvalidOperationException(("There is no implementation for method value_specification_boolean registered. Use" +
            ...
            this.OnValue_specification_booleanCalling(e);
            ...
            e.Result = result;
            this.OnValue_specification_booleanCalled(e);
        ...
        /// <summary>
        /// Raises the Value_specification_booleanCalling event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnValue_specification_booleanCalling(OperationCallEventArgs eventArgs)
        {
            EventHandler<OperationCallEventArgs> handler = this.Value_specification_booleanCalling;
            if ((handler != null))
            {
        ...
        /// <summary>
        /// Raises the Value_specification_booleanCalled event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnValue_specification_booleanCalled(OperationCallEventArgs eventArgs)
        {
            EventHandler<OperationCallEventArgs> handler = this.Value_specification_booleanCalled;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <summary>
        /// Raises the Boolean_valueCalling event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnBoolean_valueCalling(OperationCallEventArgs eventArgs)
        {
            EventHandler<OperationCallEventArgs> handler = this.Boolean_valueCalling;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <summary>
        /// Raises the Boolean_valueCalled event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnBoolean_valueCalled(OperationCallEventArgs eventArgs)
        {
            EventHandler<OperationCallEventArgs> handler = this.Boolean_valueCalled;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        public bool Not_apply_to_self(object diagnostics, object context)
        {
            ...
            {
                throw new InvalidOperationException(("There is no implementation for method not_apply_to_self registered. Use the metho" +
        ...
        /// <summary>
        /// Raises the Not_apply_to_selfCalling event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnNot_apply_to_selfCalling(OperationCallEventArgs eventArgs)
        {
            EventHandler<OperationCallEventArgs> handler = this.Not_apply_to_selfCalling;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <summary>
        /// Raises the Not_apply_to_selfCalled event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnNot_apply_to_selfCalled(OperationCallEventArgs eventArgs)
        {
            EventHandler<OperationCallEventArgs> handler = this.Not_apply_to_selfCalled;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <summary>
        /// Raises the No_side_effectsCalling event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnNo_side_effectsCalling(OperationCallEventArgs eventArgs)
        {
            EventHandler<OperationCallEventArgs> handler = this.No_side_effectsCalling;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <summary>
        /// Raises the No_side_effectsCalled event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnNo_side_effectsCalled(OperationCallEventArgs eventArgs)
        {
            EventHandler<OperationCallEventArgs> handler = this.No_side_effectsCalled;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private void OnResetSpecification(object sender, EventArgs eventArgs)
        {
        ...
        /// <summary>
        /// Raises the ContextChanging event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnContextChanging(ValueChangedEventArgs eventArgs)
        {
            EventHandler<ValueChangedEventArgs> handler = this.ContextChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnContextChanged(ValueChangedEventArgs eventArgs)
        {
            EventHandler<ValueChangedEventArgs> handler = this.ContextChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        public class ConstraintChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new SpecificationProxy(this._parent)};
            }
        ...
        public class ConstraintReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            {
                return new INotifiable[] {
                        this._parent.ConstrainedElement.AsNotifiable(),
                        new SpecificationProxy(this._parent),
                        new ContextProxy(this._parent)};
            }
