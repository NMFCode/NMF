...
namespace NMF.Interop.Cmof
{
    ...
    public partial class Exception : ModelElement, IException, IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> DescriptionChanging;
        
        /// <summary>
        /// Gets fired before the ObjectInError property changes its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ObjectInErrorChanging;
        
        /// <summary>
        /// Gets fired when the ObjectInError property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ObjectInErrorChanged;
        
        /// <summary>
        /// Gets fired before the ElementInError property changes its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ElementInErrorChanging;
        
        /// <summary>
        /// Gets fired when the ElementInError property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ElementInErrorChanged;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.DescriptionChanged;
            if ((handler != null))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.DescriptionChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ObjectInErrorChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ObjectInErrorChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private void OnResetObjectInError(object sender, EventArgs eventArgs)
        {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ElementInErrorChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ElementInErrorChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <param name="sender">The object that sent this reset request</param>
        /// <param name="eventArgs">The event data for the reset event</param>
        private void OnResetElementInError(object sender, EventArgs eventArgs)
        {
        ...
        public class ExceptionReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new ObjectInErrorProxy(this._parent),
                        new ElementInErrorProxy(this._parent)};
            }
