...
namespace NMF.Interop.Transformations
{
    public class Cmof2NMeta : ReflectiveTransformation
    {
        public class Package2Namespace : TransformationRule<IPackage, NMF.Models.Meta.INamespace>
        {
            ...
            {
                CallMany(this,
                    selector: p => p.PackagedElement.OfType<Cmof.IPackage>(),
                    persistor: (ns, packages) => ns.ChildNamespaces.AddRange(packages));

                CallMany(Rule<Class2Class>(),
                    selector: p => p.PackagedElement.OfType<Cmof.IClass>(),
                    persistor: (ns, classes) => ns.Types.AddRange(classes));

                CallMany(Rule<DataType2DataType>(),
                    selector: p => p.PackagedElement.OfType<Cmof.IDataType>(),
                    persistor: (ns, classes) => ns.Types.AddRange(classes));

                CallMany(Rule<Enum2Enum>(),
                    selector: p => p.PackagedElement.OfType<Cmof.IEnumeration>(),
                    persistor: (ns, classes) => ns.Types.AddRange(classes));
        ...
        public class Class2Class : TransformationRule<Cmof.IClass, NMF.Models.Meta.IClass>
        {
            public override void Transform(Cmof.IClass input, Models.Meta.IClass output, ITransformationContext context)
            {
        ...
        public class DataType2DataType : TransformationRule<Cmof.IDataType, NMF.Models.Meta.IDataType>
        {
        ...
        public class Element2Element : AbstractTransformationRule<Cmof.INamedElement, NMF.Models.Meta.IMetaElement>
        {
        ...
        public class Classifier2Type : AbstractTransformationRule<Cmof.IType, NMF.Models.Meta.IType>
        {
            public override void RegisterDependencies()
            {
                MarkInstantiatingFor(Rule<Element2Element>());
        ...
        public class Property2Feature : AbstractTransformationRule<Cmof.IProperty, NMF.Models.Meta.ITypedElement>
        {
        ...
        public class Property2Attribute : TransformationRule<Cmof.IProperty, NMF.Models.Meta.IAttribute>
        {
            public override void RegisterDependencies()
            {
        ...
        public class Property2Reference : TransformationRule<Cmof.IProperty, NMF.Models.Meta.IReference>
        {
        ...
        public class Operation2Operation : TransformationRule<Cmof.IOperation, NMF.Models.Meta.IOperation>
        {
            public override void RegisterDependencies()
            {
        ...
        public class Parameter2Parameter : TransformationRule<Cmof.IParameter, NMF.Models.Meta.IParameter>
        {
            public override void RegisterDependencies()
            {
                Call(Rule<Classifier2Type>(),
        ...
        public class Enum2Enum : TransformationRule<Cmof.IEnumeration, NMF.Models.Meta.IEnumeration>
        {
        ...
        public class Literal2Literal : TransformationRule<Cmof.IEnumerationLiteral, NMF.Models.Meta.ILiteral>
        {
            public override void RegisterDependencies()
            {
                MarkInstantiatingFor(Rule<Element2Element>());
