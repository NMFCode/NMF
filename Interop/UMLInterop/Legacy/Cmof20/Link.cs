...
namespace NMF.Interop.Legacy.Cmof
{
    ...
    public partial class Link : ModelElement, ILink, IModelElement
    {
        ...
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> SecondElementChanging;
        
        /// <summary>
        /// Gets fired when the SecondElement property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> SecondElementChanged;
        
        /// <summary>
        /// Gets fired before the FirstElement property changes its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> FirstElementChanging;
        
        /// <summary>
        /// Gets fired when the FirstElement property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> FirstElementChanged;
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.SecondElementChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.SecondElementChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.FirstElementChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.FirstElementChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        public class LinkReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            {
                this._parent.SecondElementChanged += this.PropagateValueChanges;
                this._parent.FirstElementChanged += this.PropagateValueChanges;
