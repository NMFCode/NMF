...
namespace NMF.Interop.Legacy.Cmof
{
    ...
    public partial class EnumerationLiteral : NamedElement, IEnumerationLiteral, IModelElement
    {
        ...
        public NMF.Interop.Legacy.Cmof.IEnumeration Enumeration
        {
            get
            {
                return ModelHelper.CastAs<NMF.Interop.Legacy.Cmof.IEnumeration>(this.Parent);
            }
            set
            {
                this.Parent = value;
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((NMF.Models.Meta.IClass)(MetaRepository.Instance.Resolve("http://schema.omg.org/spec/MOF/2.0/cmof.xml#//EnumerationLiteral")));
                }
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Legacy.Cmof.EnumerationLiteral.ClassInstance)).Resolve("enumeration")));
        }
        ...
        {
            NMF.Interop.Legacy.Cmof.IEnumeration oldEnumeration = ModelHelper.CastAs<NMF.Interop.Legacy.Cmof.IEnumeration>(oldParent);
            NMF.Interop.Legacy.Cmof.IEnumeration newEnumeration = ModelHelper.CastAs<NMF.Interop.Legacy.Cmof.IEnumeration>(newParent);
        ...
        protected override void SetFeature(string feature, object value)
        {
            ...
            {
                this.Enumeration = ((NMF.Interop.Legacy.Cmof.IEnumeration)(value));
                return;
            }
        ...
        public class EnumerationLiteralReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            public override void Add(IModelElement item)
            {
                if ((this._parent.Enumeration == null))
                {
                    NMF.Interop.Legacy.Cmof.IEnumeration enumerationCasted = item.As<NMF.Interop.Legacy.Cmof.IEnumeration>();
        ...
        /// </summary>
        private sealed class EnumerationProxy : ModelPropertyChange<IEnumerationLiteral, NMF.Interop.Legacy.Cmof.IEnumeration>
        {
            ...
            /// </summary>
            public override NMF.Interop.Legacy.Cmof.IEnumeration Value
            {
                get
                {
