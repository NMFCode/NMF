...
namespace NMF.Interop.Legacy.Cmof
{
    ...
    public class AssociationOwnedEndCollection0 : ICollectionExpression<IProperty>, ICollection<IProperty>
    {
        ...
        /// </summary>
        public AssociationOwnedEndCollection0(IAssociation parent)
        {
            this._parent = parent;
            parent.NavigableOwnedEnd.AsNotifiable().CollectionChanged += this.HandleCollectionChange;
        }
        ...
        {
            this._parent.NavigableOwnedEnd.Add(item);
        }
        ...
        {
            this._parent.NavigableOwnedEnd.CopyTo(array, arrayIndex);
            arrayIndex = (arrayIndex + this._parent.NavigableOwnedEnd.Count);
        }
        ...
        {
            if (this._parent.NavigableOwnedEnd.Remove(item))
            {
                return true;
            }
            return false;
        ...
        {
            return Enumerable.Empty<IProperty>().Concat(this._parent.NavigableOwnedEnd).GetEnumerator();
        }
