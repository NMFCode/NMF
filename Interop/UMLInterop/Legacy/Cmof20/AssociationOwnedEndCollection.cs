...
namespace NMF.Interop.Legacy.Cmof
{
    ...
    /// </summary>
    public class AssociationOwnedEndCollection : ObservableOppositeList<IAssociation, IProperty>
    {
        
        /// <summary>
        /// Creates a new instance
        /// </summary>
        /// <param name="parent">the parent Association</param>
        ...
        protected override void SetOpposite(IProperty item, IAssociation newParent)
        {
            if ((newParent != null))
            {
                ...
                item.OwningAssociation = newParent;
            }
            else
            {
                item.ParentChanged -= this.OnItemParentChanged;
