...
namespace NMF.Interop.Legacy.Cmof
{
    ...
    /// </summary>
    public class ClassOwnedAttributeCollection : ObservableOppositeOrderedSet<NMF.Interop.Legacy.Cmof.IClass, IProperty>
    {
        ...
        public ClassOwnedAttributeCollection(NMF.Interop.Legacy.Cmof.IClass parent) : 
                base(parent)
        {
        }
        ...
        protected override void SetOpposite(IProperty item, NMF.Interop.Legacy.Cmof.IClass newParent)
        {
            if ((newParent != null))
            {
