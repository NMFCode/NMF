...
namespace NMF.Interop.Legacy.Cmof
{
    ...
    /// </summary>
    public class NamespaceOwnedRuleCollection : ObservableOppositeList<NMF.Interop.Legacy.Cmof.INamespace, IConstraint>
    {
        ...
        public NamespaceOwnedRuleCollection(NMF.Interop.Legacy.Cmof.INamespace parent) : 
                base(parent)
        {
        }
        ...
        protected override void SetOpposite(IConstraint item, NMF.Interop.Legacy.Cmof.INamespace newParent)
        {
            if ((newParent != null))
            {
                item.ParentChanged += this.OnItemParentChanged;
                item.Namespace = newParent;
            }
            else
            {
                item.ParentChanged -= this.OnItemParentChanged;
