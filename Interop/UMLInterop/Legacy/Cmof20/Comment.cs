...
namespace NMF.Interop.Legacy.Cmof
{
    ...
    [ModelRepresentationClassAttribute("http://schema.omg.org/spec/MOF/2.0/cmof.xml#//Comment")]
    public partial class Comment : Element, IComment, IModelElement
    {
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((NMF.Models.Meta.IClass)(MetaRepository.Instance.Resolve("http://schema.omg.org/spec/MOF/2.0/cmof.xml#//Comment")));
                }
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Legacy.Cmof.Comment.ClassInstance)).Resolve("body")));
        }
        
        private static NMF.Models.Meta.ITypedElement RetrieveAnnotatedElementReference()
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Legacy.Cmof.Comment.ClassInstance)).Resolve("annotatedElement")));
        }
