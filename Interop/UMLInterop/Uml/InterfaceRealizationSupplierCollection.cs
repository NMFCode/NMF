...
namespace NMF.Interop.Uml
{
    ...
    /// </summary>
    public class InterfaceRealizationSupplierCollection : ICollectionExpression<INamedElement>, ICollection<INamedElement>
    {
        ...
        {
            this._parent = parent;
            parent.BubbledChange += this.HandleContractValueChange;
        }
        ...
        private void HandleContractValueChange(object sender, BubbledChangeEventArgs e)
        {
        }
        ...
        {
            return Enumerable.Empty<INamedElement>().Concat(this._parent.Contract).GetEnumerator();
        }
