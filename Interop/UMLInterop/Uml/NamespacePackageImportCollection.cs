...
namespace NMF.Interop.Uml
{
    ...
    /// </summary>
    public class NamespacePackageImportCollection : ObservableOppositeList<NMF.Interop.Uml.INamespace, IPackageImport>
    {
        ...
        protected override void SetOpposite(IPackageImport item, NMF.Interop.Uml.INamespace newParent)
        {
            if ((newParent != null))
            {
