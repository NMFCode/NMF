...
namespace NMF.Interop.Uml
{
    ...
    public abstract partial class Classifier : Namespace, IClassifier, IModelElement
    {
        ...
        private static Lazy<NMF.Models.Meta.ITypedElement> _collaborationUseReference = new Lazy<NMF.Models.Meta.ITypedElement>(RetrieveCollaborationUseReference);
        
        /// <summary>
        /// The backing field for the CollaborationUse property
        /// </summary>
        [DebuggerBrowsableAttribute(DebuggerBrowsableState.Never)]
        private ObservableCompositionOrderedSet<ICollaborationUse> _collaborationUse;
        ...
        public Classifier()
        {
            this._collaborationUse = new ObservableCompositionOrderedSet<ICollaborationUse>(this);
            this._collaborationUse.CollectionChanging += this.CollaborationUseCollectionChanging;
            this._collaborationUse.CollectionChanged += this.CollaborationUseCollectionChanged;
...
<p>From package UML::Classification.</p>")]
        ...
        [ConstantAttribute()]
        public IOrderedSetExpression<ICollaborationUse> CollaborationUse
        {
            get
            {
        ...
        public ICollaborationUse Representation
        {
            ...
            set
            {
                if ((this._representation != value))
                {
                    ...
                    if ((old != null))
                    {
                        old.Deleted -= this.OnResetRepresentation;
                    }
                    if ((value != null))
                    {
                        value.Deleted += this.OnResetRepresentation;
                    }
        ...
        private static NMF.Models.Meta.ITypedElement RetrieveCollaborationUseReference()
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Uml.Classifier.ClassInstance)).Resolve("collaborationUse")));
        }
        
        /// <summary>
        /// Forwards CollectionChanging notifications for the CollaborationUse property to the parent model element
        /// </summary>
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void CollaborationUseCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
            this.OnCollectionChanging("CollaborationUse", e, _collaborationUseReference);
        }
        
        /// <summary>
        /// Forwards CollectionChanged notifications for the CollaborationUse property to the parent model element
        /// </summary>
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void CollaborationUseCollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            this.OnCollectionChanged("CollaborationUse", e, _collaborationUseReference);
        }
        ...
        {
            int collaborationUseIndex = ModelHelper.IndexOfReference(this.CollaborationUse, element);
            if ((collaborationUseIndex != -1))
            {
                return ModelHelper.CreatePath("collaborationUse", collaborationUseIndex);
            }
        ...
        {
            if ((reference == "COLLABORATIONUSE"))
            {
                if ((index < this.CollaborationUse.Count))
                {
                    return this.CollaborationUse[index];
                }
                else
                {
                    return null;
        ...
        {
            if ((container == this._collaborationUse))
            {
        ...
        public class ClassifierChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            public override int Count
            {
                ...
                {
                    int count = 0;
                    count = (count + this._parent.CollaborationUse.Count);
                    count = (count + this._parent.Generalization.Count);
                    count = (count + this._parent.OwnedUseCase.Count);
                    count = (count + this._parent.Substitution.Count);
            ...
            {
                this._parent.CollaborationUse.AsNotifiable().CollectionChanged += this.PropagateCollectionChanges;
                this._parent.Generalization.AsNotifiable().CollectionChanged += this.PropagateCollectionChanges;
                this._parent.OwnedUseCase.AsNotifiable().CollectionChanged += this.PropagateCollectionChanges;
                this._parent.Substitution.AsNotifiable().CollectionChanged += this.PropagateCollectionChanges;
            ...
            {
                ICollaborationUse collaborationUseCasted = item.As<ICollaborationUse>();
                if ((collaborationUseCasted != null))
                {
                    this._parent.CollaborationUse.Add(collaborationUseCasted);
                }
                ...
                IUseCase ownedUseCaseCasted = item.As<IUseCase>();
                if ((ownedUseCaseCasted != null))
                {
                    this._parent.OwnedUseCase.Add(ownedUseCaseCasted);
                }
                ISubstitution substitutionCasted = item.As<ISubstitution>();
                if ((substitutionCasted != null))
                {
                    this._parent.Substitution.Add(substitutionCasted);
                }
            ...
            {
                this._parent.CollaborationUse.Clear();
                this._parent.Generalization.Clear();
                this._parent.OwnedUseCase.Clear();
                this._parent.Substitution.Clear();
            ...
            {
                if (this._parent.CollaborationUse.Contains(item))
                {
                    return true;
                }
                ...
                if (this._parent.OwnedUseCase.Contains(item))
                {
                    return true;
                }
                if (this._parent.Substitution.Contains(item))
                {
                    return true;
                }
            ...
            {
                IEnumerator<IModelElement> collaborationUseEnumerator = this._parent.CollaborationUse.GetEnumerator();
                try
                {
                    for (
                    ; collaborationUseEnumerator.MoveNext(); 
                    )
                    {
                        array[arrayIndex] = collaborationUseEnumerator.Current;
                        arrayIndex = (arrayIndex + 1);
                    }
                }
                finally
                {
                    collaborationUseEnumerator.Dispose();
                }
                ...
                IEnumerator<IModelElement> ownedUseCaseEnumerator = this._parent.OwnedUseCase.GetEnumerator();
                try
                {
                    for (
                    ; ownedUseCaseEnumerator.MoveNext(); 
                    )
                    {
                        array[arrayIndex] = ownedUseCaseEnumerator.Current;
                        arrayIndex = (arrayIndex + 1);
                    }
                }
                finally
                {
                    ownedUseCaseEnumerator.Dispose();
                }
                IEnumerator<IModelElement> substitutionEnumerator = this._parent.Substitution.GetEnumerator();
                try
                {
                    for (
                    ...
                    {
                        array[arrayIndex] = substitutionEnumerator.Current;
                        arrayIndex = (arrayIndex + 1);
                    }
                }
                finally
                {
                    substitutionEnumerator.Dispose();
                }
            ...
            {
                ICollaborationUse collaborationUseItem = item.As<ICollaborationUse>();
                if (((collaborationUseItem != null) 
                            && this._parent.CollaborationUse.Remove(collaborationUseItem)))
                {
                    return true;
                }
                ...
                IUseCase useCaseItem = item.As<IUseCase>();
                if (((useCaseItem != null) 
                            && this._parent.OwnedUseCase.Remove(useCaseItem)))
                {
                    return true;
                }
                ISubstitution substitutionItem = item.As<ISubstitution>();
                if (((substitutionItem != null) 
                            && this._parent.Substitution.Remove(substitutionItem)))
                {
                    return true;
                }
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.CollaborationUse).Concat(this._parent.Generalization).Concat(this._parent.OwnedUseCase).Concat(this._parent.Substitution).Concat(this._parent.TemplateBinding).Concat(this._parent.OwnedTemplateSignature).GetEnumerator();
            }
        }
        ...
        public class ClassifierReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            public override int Count
            {
                get
                {
                    ...
                    count = (count + this._parent.CollaborationUse.Count);
                    count = (count + this._parent.Generalization.Count);
                    count = (count + this._parent.PowertypeExtent.Count);
                    count = (count + this._parent.OwnedUseCase.Count);
                    count = (count + this._parent.UseCase.Count);
            ...
            protected override void AttachCore()
            {
                this._parent.CollaborationUse.AsNotifiable().CollectionChanged += this.PropagateCollectionChanges;
                this._parent.Generalization.AsNotifiable().CollectionChanged += this.PropagateCollectionChanges;
                this._parent.PowertypeExtent.AsNotifiable().CollectionChanged += this.PropagateCollectionChanges;
                this._parent.OwnedUseCase.AsNotifiable().CollectionChanged += this.PropagateCollectionChanges;
                this._parent.UseCase.AsNotifiable().CollectionChanged += this.PropagateCollectionChanges;
            ...
            public override void Add(IModelElement item)
            {
                ...
                IGeneralizationSet powertypeExtentCasted = item.As<IGeneralizationSet>();
                if ((powertypeExtentCasted != null))
                {
                    this._parent.PowertypeExtent.Add(powertypeExtentCasted);
                }
                IUseCase ownedUseCaseCasted = item.As<IUseCase>();
                if ((ownedUseCaseCasted != null))
                {
                ...
                {
                    this._parent.UseCase.Add(useCaseCasted);
                }
                ...
                if ((this._parent.Representation == null))
                {
                    ICollaborationUse representationCasted = item.As<ICollaborationUse>();
                    if ((representationCasted != null))
                    {
                        this._parent.Representation = representationCasted;
                        return;
                    }
                }
                ISubstitution substitutionCasted = item.As<ISubstitution>();
            ...
            public override void Clear()
            {
                this._parent.CollaborationUse.Clear();
                this._parent.Generalization.Clear();
                this._parent.PowertypeExtent.Clear();
                this._parent.OwnedUseCase.Clear();
                this._parent.UseCase.Clear();
            ...
            public override bool Contains(IModelElement item)
            {
                ...
                if (this._parent.PowertypeExtent.Contains(item))
                {
                    return true;
                }
                if (this._parent.OwnedUseCase.Contains(item))
                ...
                if (this._parent.UseCase.Contains(item))
                {
                    return true;
                }
            ...
            public override void CopyTo(IModelElement[] array, int arrayIndex)
            {
                ...
                IEnumerator<IModelElement> powertypeExtentEnumerator = this._parent.PowertypeExtent.GetEnumerator();
                try
                {
                    for (
                    ; powertypeExtentEnumerator.MoveNext(); 
                    )
                    {
                        array[arrayIndex] = powertypeExtentEnumerator.Current;
                        arrayIndex = (arrayIndex + 1);
                    }
                }
                finally
                {
                    powertypeExtentEnumerator.Dispose();
                }
                IEnumerator<IModelElement> ownedUseCaseEnumerator = this._parent.OwnedUseCase.GetEnumerator();
                try
                {
                ...
                IEnumerator<IModelElement> useCaseEnumerator = this._parent.UseCase.GetEnumerator();
                try
                {
                    for (
                    ; useCaseEnumerator.MoveNext(); 
                    )
                    {
                        array[arrayIndex] = useCaseEnumerator.Current;
                        arrayIndex = (arrayIndex + 1);
                    }
                }
                finally
                {
                    useCaseEnumerator.Dispose();
                }
            ...
            public override bool Remove(IModelElement item)
            {
                ...
                if (((generalizationSetItem != null) 
                            && this._parent.PowertypeExtent.Remove(generalizationSetItem)))
                {
                    return true;
                }
                IUseCase useCaseItem = item.As<IUseCase>();
                ...
                if (((useCaseItem != null) 
                            && this._parent.UseCase.Remove(useCaseItem)))
                {
                    return true;
                }
            ...
            public override IEnumerator<IModelElement> GetEnumerator()
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.CollaborationUse).Concat(this._parent.Generalization).Concat(this._parent.PowertypeExtent).Concat(this._parent.OwnedUseCase).Concat(this._parent.UseCase).Concat(this._parent.RedefinedClassifier).Concat(this._parent.Representation).Concat(this._parent.Substitution).Concat(this._parent.OwningTemplateParameter).Concat(this._parent.TemplateParameter).Concat(this._parent.TemplateBinding).Concat(this._parent.OwnedTemplateSignature).GetEnumerator();
            }
        }
