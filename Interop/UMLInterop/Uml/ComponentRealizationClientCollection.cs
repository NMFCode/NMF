...
namespace NMF.Interop.Uml
{
    ...
    /// </summary>
    public class ComponentRealizationClientCollection : ICollectionExpression<INamedElement>, ICollection<INamedElement>
    {
        
        private IComponentRealization _parent;
        
        /// <summary>
        /// Creates a new instance
        /// </summary>
        public ComponentRealizationClientCollection(IComponentRealization parent)
        {
            this._parent = parent;
            parent.RealizingClassifier.AsNotifiable().CollectionChanged += this.HandleCollectionChange;
        }
        ...
        {
            IEnumerator<INamedElement> realizingClassifierEnumerator = this._parent.RealizingClassifier.GetEnumerator();
            try
            {
                for (
        ...
        {
            return Enumerable.Empty<INamedElement>().Concat(this._parent.RealizingClassifier).GetEnumerator();
        }
