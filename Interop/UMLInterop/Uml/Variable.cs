...
namespace NMF.Interop.Uml
{
    ...
    public partial class Variable : ConnectableElement, IVariable, IModelElement
    {
        
        private static System.Lazy<NMF.Models.Meta.IOperation> _isAccessibleByOperation = new System.Lazy<NMF.Models.Meta.IOperation>(RetrieveIsAccessibleByOperation);
        
        private static Lazy<NMF.Models.Meta.ITypedElement> _activityScopeReference = new Lazy<NMF.Models.Meta.ITypedElement>(RetrieveActivityScopeReference);
        
        /// <summary>
        /// The backing field for the ActivityScope property
        /// </summary>
        [DebuggerBrowsableAttribute(DebuggerBrowsableState.Never)]
        private IActivity _activityScope;
        
        private static Lazy<NMF.Models.Meta.ITypedElement> _scopeReference = new Lazy<NMF.Models.Meta.ITypedElement>(RetrieveScopeReference);
        
        /// <summary>
        /// The backing field for the Scope property
        /// </summary>
        [DebuggerBrowsableAttribute(DebuggerBrowsableState.Never)]
        private IStructuredActivityNode _scope;
        ...
        public IActivity ActivityScope
        {
            get
            {
                return this._activityScope;
            }
            set
            {
                if ((this._activityScope != value))
                {
                    IActivity old = this._activityScope;
                    ValueChangedEventArgs e = new ValueChangedEventArgs(old, value);
                    this.OnPropertyChanging("ActivityScope", e, _activityScopeReference);
                    this._activityScope = value;
                    this.Parent = value;
                    if ((old != null))
                    {
                    ...
                    if ((value != null))
                    {
                        value.Variable.Add(this);
                    }
                    this.OnPropertyChanged("ActivityScope", e, _activityScopeReference);
                }
            }
        }
        ...
        [XmlAttributeAttribute(true)]
        [XmlOppositeAttribute("variable")]
        public IStructuredActivityNode Scope
        {
            get
            {
                return this._scope;
            ...
            set
            {
                ...
                {
                    IStructuredActivityNode old = this._scope;
                    ValueChangedEventArgs e = new ValueChangedEventArgs(old, value);
                    this.OnPropertyChanging("Scope", e, _scopeReference);
                    this._scope = value;
                    this.Parent = value;
                    if ((old != null))
                    {
                    ...
                    this.OnPropertyChanged("Scope", e, _scopeReference);
                }
            }
        }
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((NMF.Models.Meta.IClass)(MetaRepository.Instance.Resolve("http://www.eclipse.org/uml2/5.0.0/UML#//Variable")));
                }
        ...
        /// </summary>
        /// <param name="a"></param>
        public bool IsAccessibleBy(IAction a)
        {
            System.Func<IVariable, IAction, bool> handler = OperationBroker.Instance.GetRegisteredDelegate<System.Func<IVariable, IAction, bool>>(_isAccessibleByOperation);
            if ((handler != null))
            {
            }
            else
            {
                throw new System.InvalidOperationException("There is no implementation for method isAccessibleBy registered. Use the method b" +
                        "roker to register a method implementation.");
            }
            OperationCallEventArgs e = new OperationCallEventArgs(this, _isAccessibleByOperation.Value, a);
            this.OnBubbledChange(BubbledChangeEventArgs.OperationCalling(this, _isAccessibleByOperation.Value, e));
            bool result = handler.Invoke(this, a);
            e.Result = result;
            this.OnBubbledChange(BubbledChangeEventArgs.OperationCalled(this, _isAccessibleByOperation.Value, e));
            return result;
        }
        
        private static NMF.Models.Meta.IOperation RetrieveIsAccessibleByOperation()
        {
            return ClassInstance.LookupOperation("isAccessibleBy");
        }
        
        private static NMF.Models.Meta.ITypedElement RetrieveActivityScopeReference()
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Uml.Variable.ClassInstance)).Resolve("activityScope")));
        }
        
        /// <summary>
        /// Handles the event that the ActivityScope property must reset
        /// </summary>
        /// <param name="sender">The object that sent this reset request</param>
        /// <param name="eventArgs">The event data for the reset event</param>
        private void OnResetActivityScope(object sender, System.EventArgs eventArgs)
        {
            this.ActivityScope = null;
        }
        
        private static NMF.Models.Meta.ITypedElement RetrieveScopeReference()
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Uml.Variable.ClassInstance)).Resolve("scope")));
        }
        
        /// <summary>
        /// Handles the event that the Scope property must reset
        /// </summary>
        /// <param name="sender">The object that sent this reset request</param>
        /// <param name="eventArgs">The event data for the reset event</param>
        private void OnResetScope(object sender, System.EventArgs eventArgs)
        {
            this.Scope = null;
        }
        ...
        {
            if ((feature == "ACTIVITYSCOPE"))
            {
                this.ActivityScope = ((IActivity)(value));
                return;
            }
            if ((feature == "SCOPE"))
            {
                this.Scope = ((IStructuredActivityNode)(value));
                return;
            }
        ...
        protected override NMF.Expressions.INotifyExpression<NMF.Models.IModelElement> GetExpressionForReference(string reference)
        {
            if ((reference == "ACTIVITYSCOPE"))
            {
                return new ActivityScopeProxy(this);
            }
            if ((reference == "SCOPE"))
            {
        ...
        public class VariableReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            public override int Count
            {
                ...
                {
                    int count = 0;
                    if ((this._parent.ActivityScope != null))
                    {
                        count = (count + 1);
                    }
                    if ((this._parent.Scope != null))
                    {
                        count = (count + 1);
                    }
                    if ((this._parent.LowerValue != null))
            ...
            public override void Add(IModelElement item)
            {
                if ((this._parent.ActivityScope == null))
                {
                    IActivity activityScopeCasted = item.As<IActivity>();
                    if ((activityScopeCasted != null))
                    {
                        this._parent.ActivityScope = activityScopeCasted;
                        return;
                    }
                }
                if ((this._parent.Scope == null))
                {
                    IStructuredActivityNode scopeCasted = item.As<IStructuredActivityNode>();
                    if ((scopeCasted != null))
                    {
                        this._parent.Scope = scopeCasted;
                        return;
                    }
                }
                if ((this._parent.LowerValue == null))
            ...
            public override void Clear()
            {
                this._parent.ActivityScope = null;
            ...
            public override bool Contains(IModelElement item)
            {
                if ((item == this._parent.ActivityScope))
                {
                    return true;
                }
                if ((item == this._parent.Scope))
                {
                    return true;
                }
                if ((item == this._parent.LowerValue))
            ...
            public override void CopyTo(IModelElement[] array, int arrayIndex)
            {
                if ((this._parent.ActivityScope != null))
                {
                    array[arrayIndex] = this._parent.ActivityScope;
                    arrayIndex = (arrayIndex + 1);
                }
                if ((this._parent.Scope != null))
                {
                    array[arrayIndex] = this._parent.Scope;
                    arrayIndex = (arrayIndex + 1);
                }
                if ((this._parent.LowerValue != null))
                {
            ...
            public override bool Remove(IModelElement item)
            {
                if ((this._parent.ActivityScope == item))
                {
                    this._parent.ActivityScope = null;
                    return true;
                }
                if ((this._parent.Scope == item))
                {
                    this._parent.Scope = null;
                    return true;
                }
            ...
            public override IEnumerator<IModelElement> GetEnumerator()
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.ActivityScope).Concat(this._parent.Scope).Concat(this._parent.LowerValue).Concat(this._parent.UpperValue).GetEnumerator();
            }
        }
        
        /// <summary>
        /// Represents a proxy to represent an incremental access to the activityScope property
        /// </summary>
        private sealed class ActivityScopeProxy : ModelPropertyChange<IVariable, IActivity>
        {
            ...
            public ActivityScopeProxy(IVariable modelElement) : 
                    base(modelElement, "activityScope")
            {
            }
            ...
            public override IActivity Value
            {
                get
                {
                    return this.ModelElement.ActivityScope;
                }
                set
                {
                    this.ModelElement.ActivityScope = value;
                }
            }
        }
        ...
        /// </summary>
        private sealed class ScopeProxy : ModelPropertyChange<IVariable, IStructuredActivityNode>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public ScopeProxy(IVariable modelElement) : 
