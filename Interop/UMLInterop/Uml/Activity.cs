...
namespace NMF.Interop.Uml
{
    ...
    public partial class Activity : Behavior, IActivity, IModelElement
    {
        ...
        private static Lazy<NMF.Models.Meta.ITypedElement> _ownedGroupReference = new Lazy<NMF.Models.Meta.ITypedElement>(RetrieveOwnedGroupReference);
        
        /// <summary>
        /// The backing field for the OwnedGroup property
        /// </summary>
        [DebuggerBrowsableAttribute(DebuggerBrowsableState.Never)]
        private ObservableCompositionOrderedSet<IActivityGroup> _ownedGroup;
        ...
        /// </summary>
        [DebuggerBrowsableAttribute(DebuggerBrowsableState.Never)]
        private ObservableAssociationSet<IActivityPartition> _partition;
        ...
        public Activity()
        {
            this._ownedGroup = new ObservableCompositionOrderedSet<IActivityGroup>(this);
            this._ownedGroup.CollectionChanging += this.OwnedGroupCollectionChanging;
            this._ownedGroup.CollectionChanged += this.OwnedGroupCollectionChanged;
            ...
            this._partition = new ObservableAssociationSet<IActivityPartition>();
...
<p>From package UML::Activities.</p>")]
        ...
        [ConstantAttribute()]
        public IOrderedSetExpression<IActivityGroup> OwnedGroup
        {
            get
            {
                return this._ownedGroup;
            }
        }
        ...
        [XmlAttributeAttribute(true)]
        [ConstantAttribute()]
        public ISetExpression<IActivityPartition> Partition
        {
            get
            {
        ...
        private static NMF.Models.Meta.ITypedElement RetrieveOwnedGroupReference()
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Uml.Activity.ClassInstance)).Resolve("ownedGroup")));
        }
        
        /// <summary>
        /// Forwards CollectionChanging notifications for the OwnedGroup property to the parent model element
        /// </summary>
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void OwnedGroupCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
            this.OnCollectionChanging("OwnedGroup", e, _ownedGroupReference);
        }
        
        /// <summary>
        /// Forwards CollectionChanged notifications for the OwnedGroup property to the parent model element
        /// </summary>
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void OwnedGroupCollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            this.OnCollectionChanged("OwnedGroup", e, _ownedGroupReference);
        }
        ...
        {
            int ownedGroupIndex = ModelHelper.IndexOfReference(this.OwnedGroup, element);
            if ((ownedGroupIndex != -1))
            {
                return ModelHelper.CreatePath("ownedGroup", ownedGroupIndex);
            }
        ...
        {
            if ((reference == "OWNEDGROUP"))
            {
                if ((index < this.OwnedGroup.Count))
                {
                    return this.OwnedGroup[index];
                }
                else
                {
                    return null;
        ...
        public class ActivityChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            public override int Count
            {
                ...
                {
                    int count = 0;
                    count = (count + this._parent.OwnedGroup.Count);
                    count = (count + this._parent.Edge.Count);
                    count = (count + this._parent.Variable.Count);
                    count = (count + this._parent.OwnedNode.Count);
                    count = (count + this._parent.StructuredNode.Count);
                    return count;
                }
            }
            ...
            {
                this._parent.OwnedGroup.AsNotifiable().CollectionChanged += this.PropagateCollectionChanges;
                ...
                this._parent.OwnedNode.AsNotifiable().CollectionChanged += this.PropagateCollectionChanges;
                this._parent.StructuredNode.AsNotifiable().CollectionChanged += this.PropagateCollectionChanges;
            }
            ...
            {
                IActivityGroup ownedGroupCasted = item.As<IActivityGroup>();
                if ((ownedGroupCasted != null))
                {
                    this._parent.OwnedGroup.Add(ownedGroupCasted);
                }
                ...
                IActivityNode ownedNodeCasted = item.As<IActivityNode>();
                if ((ownedNodeCasted != null))
                {
                    this._parent.OwnedNode.Add(ownedNodeCasted);
                }
                IStructuredActivityNode structuredNodeCasted = item.As<IStructuredActivityNode>();
                if ((structuredNodeCasted != null))
                {
                    this._parent.StructuredNode.Add(structuredNodeCasted);
                }
            }
            ...
            {
                this._parent.OwnedGroup.Clear();
                this._parent.Edge.Clear();
                this._parent.Variable.Clear();
                this._parent.OwnedNode.Clear();
                this._parent.StructuredNode.Clear();
            }
            ...
            {
                if (this._parent.OwnedGroup.Contains(item))
                {
                    return true;
                }
                ...
                if (this._parent.OwnedNode.Contains(item))
                {
                    return true;
                }
                if (this._parent.StructuredNode.Contains(item))
                {
                    return true;
                }
                return false;
            ...
            {
                IEnumerator<IModelElement> ownedGroupEnumerator = this._parent.OwnedGroup.GetEnumerator();
                try
                {
                    for (
                    ; ownedGroupEnumerator.MoveNext(); 
                    )
                    {
                        array[arrayIndex] = ownedGroupEnumerator.Current;
                        arrayIndex = (arrayIndex + 1);
                    }
                }
                finally
                {
                    ownedGroupEnumerator.Dispose();
                }
                ...
                IEnumerator<IModelElement> ownedNodeEnumerator = this._parent.OwnedNode.GetEnumerator();
                try
                {
                    for (
                    ; ownedNodeEnumerator.MoveNext(); 
                    )
                    {
                        array[arrayIndex] = ownedNodeEnumerator.Current;
                        arrayIndex = (arrayIndex + 1);
                    }
                }
                finally
                {
                    ownedNodeEnumerator.Dispose();
                }
                IEnumerator<IModelElement> structuredNodeEnumerator = this._parent.StructuredNode.GetEnumerator();
                try
                {
                    for (
                    ; structuredNodeEnumerator.MoveNext(); 
                    )
                    {
                        array[arrayIndex] = structuredNodeEnumerator.Current;
                        arrayIndex = (arrayIndex + 1);
                    }
                }
                finally
                {
                    structuredNodeEnumerator.Dispose();
                }
            }
            ...
            {
                IActivityGroup activityGroupItem = item.As<IActivityGroup>();
                if (((activityGroupItem != null) 
                            && this._parent.OwnedGroup.Remove(activityGroupItem)))
                {
                    return true;
                }
                ...
                if (((activityNodeItem != null) 
                            && this._parent.OwnedNode.Remove(activityNodeItem)))
                {
                    return true;
                }
                IStructuredActivityNode structuredActivityNodeItem = item.As<IStructuredActivityNode>();
                if (((structuredActivityNodeItem != null) 
                            && this._parent.StructuredNode.Remove(structuredActivityNodeItem)))
                {
                    return true;
                }
                return false;
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.OwnedGroup).Concat(this._parent.Edge).Concat(this._parent.Variable).Concat(this._parent.OwnedNode).Concat(this._parent.StructuredNode).GetEnumerator();
            }
        }
        ...
        public class ActivityReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override void AttachCore()
            {
                ...
                this._parent.Variable.AsNotifiable().CollectionChanged += this.PropagateCollectionChanges;
                this._parent.OwnedNode.AsNotifiable().CollectionChanged += this.PropagateCollectionChanges;
                this._parent.Partition.AsNotifiable().CollectionChanged += this.PropagateCollectionChanges;
                this._parent.StructuredNode.AsNotifiable().CollectionChanged += this.PropagateCollectionChanges;
            }
            ...
            public override void CopyTo(IModelElement[] array, int arrayIndex)
            {
                ...
                IEnumerator<IModelElement> partitionEnumerator = this._parent.Partition.GetEnumerator();
                try
                {
                    for (
            ...
            public override IEnumerator<IModelElement> GetEnumerator()
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.OwnedGroup).Concat(this._parent.Edge).Concat(this._parent.Variable).Concat(this._parent.OwnedNode).Concat(this._parent.Partition).Concat(this._parent.StructuredNode).GetEnumerator();
            }
        }
