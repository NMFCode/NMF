...
namespace NMF.Interop.Uml
{
    ...
    /// </summary>
    public class OccurrenceSpecificationToBeforeCollection : ObservableOppositeSet<IOccurrenceSpecification, IGeneralOrdering>
    {
        
        /// <summary>
        /// Creates a new instance
        /// </summary>
        /// <param name="parent">the parent OccurrenceSpecification</param>
        ...
        protected override void SetOpposite(IGeneralOrdering item, IOccurrenceSpecification newParent)
        {
            if ((newParent != null))
            {
                ...
                item.After = newParent;
            }
            else
            {
                item.Deleted -= this.OnItemDeleted;
                if ((item.After == this.Parent))
                {
                    item.After = newParent;
                }
            }
