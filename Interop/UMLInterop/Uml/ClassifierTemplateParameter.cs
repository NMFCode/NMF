...
<p>From package UML::Classification.</p>")]
        ...
        public class ClassifierTemplateParameterReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            public override int Count
            {
                ...
                {
                    int count = 0;
                    count = (count + this._parent.ConstrainingClassifier.Count);
                    return count;
                }
            }
            ...
            {
                this._parent.ConstrainingClassifier.AsNotifiable().CollectionChanged += this.PropagateCollectionChanges;
            }
            ...
            {
                IClassifier constrainingClassifierCasted = item.As<IClassifier>();
                if ((constrainingClassifierCasted != null))
                {
                    this._parent.ConstrainingClassifier.Add(constrainingClassifierCasted);
                }
            }
            ...
            {
                this._parent.ConstrainingClassifier.Clear();
            }
            ...
            {
                if (this._parent.ConstrainingClassifier.Contains(item))
                {
                    return true;
                }
                return false;
            ...
            {
                IEnumerator<IModelElement> constrainingClassifierEnumerator = this._parent.ConstrainingClassifier.GetEnumerator();
                try
                {
                    for (
                    ; constrainingClassifierEnumerator.MoveNext(); 
                    )
                    {
                        array[arrayIndex] = constrainingClassifierEnumerator.Current;
                        arrayIndex = (arrayIndex + 1);
                    }
                }
                finally
                {
                    constrainingClassifierEnumerator.Dispose();
                }
            }
            ...
            public override bool Remove(IModelElement item)
            {
                ...
                if (((classifierItem != null) 
                            && this._parent.ConstrainingClassifier.Remove(classifierItem)))
                {
                    return true;
                }
                return false;
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.ConstrainingClassifier).GetEnumerator();
            }
        }
