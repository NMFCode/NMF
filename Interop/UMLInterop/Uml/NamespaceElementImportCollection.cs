...
namespace NMF.Interop.Uml
{
    ...
    /// </summary>
    public class NamespaceElementImportCollection : ObservableOppositeList<NMF.Interop.Uml.INamespace, IElementImport>
    {
        ...
        protected override void SetOpposite(IElementImport item, NMF.Interop.Uml.INamespace newParent)
        {
            if ((newParent != null))
            {
