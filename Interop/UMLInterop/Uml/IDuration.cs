...
namespace NMF.Interop.Uml
{
    ...
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(Duration))]
    [XmlDefaultImplementationTypeAttribute(typeof(Duration))]
    [ModelRepresentationClassAttribute("http://www.eclipse.org/uml2/5.0.0/UML#//Duration")]
    public interface IDuration : IModelElement, IValueSpecification
    {
