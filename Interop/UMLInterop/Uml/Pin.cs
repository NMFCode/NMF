...
namespace NMF.Interop.Uml
{
    ...
    [DebuggerDisplayAttribute("Pin {Name}")]
    public abstract partial class Pin : ObjectNode, IPin, IModelElement
    {
        
        private static System.Lazy<NMF.Models.Meta.IOperation> _control_pinsOperation = new System.Lazy<NMF.Models.Meta.IOperation>(RetrieveControl_pinsOperation);
        
        private static System.Lazy<NMF.Models.Meta.IOperation> _not_uniqueOperation = new System.Lazy<NMF.Models.Meta.IOperation>(RetrieveNot_uniqueOperation);
        
        /// <summary>
        /// The backing field for the IsControl property
        /// </summary>
        [DebuggerBrowsableAttribute(DebuggerBrowsableState.Never)]
        private bool _isControl = false;
        
        private static Lazy<NMF.Models.Meta.ITypedElement> _isControlAttribute = new Lazy<NMF.Models.Meta.ITypedElement>(RetrieveIsControlAttribute);
        ...
        public bool IsControl
        {
            ...
            set
            {
                ...
                {
                    bool old = this._isControl;
                    ValueChangedEventArgs e = new ValueChangedEventArgs(old, value);
                    this.OnPropertyChanging("IsControl", e, _isControlAttribute);
                    this._isControl = value;
                    this.OnPropertyChanged("IsControl", e, _isControlAttribute);
                }
            }
        }
        ...
        public override IEnumerableExpression<IModelElement> Children
        {
            get
            {
                return base.Children.Concat(new PinChildrenCollection(this));
            }
        }
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((NMF.Models.Meta.IClass)(MetaRepository.Instance.Resolve("http://www.eclipse.org/uml2/5.0.0/UML#//Pin")));
                }
        ...
        {
            System.Func<IPin, object, object, bool> handler = OperationBroker.Instance.GetRegisteredDelegate<System.Func<IPin, object, object, bool>>(_control_pinsOperation);
            if ((handler != null))
            {
            }
            else
            {
                throw new System.InvalidOperationException("There is no implementation for method control_pins registered. Use the method bro" +
                        "ker to register a method implementation.");
            }
            OperationCallEventArgs e = new OperationCallEventArgs(this, _control_pinsOperation.Value, diagnostics, context);
            this.OnBubbledChange(BubbledChangeEventArgs.OperationCalling(this, _control_pinsOperation.Value, e));
            bool result = handler.Invoke(this, diagnostics, context);
            e.Result = result;
            this.OnBubbledChange(BubbledChangeEventArgs.OperationCalled(this, _control_pinsOperation.Value, e));
            return result;
        }
        
        private static NMF.Models.Meta.IOperation RetrieveControl_pinsOperation()
        {
            return ClassInstance.LookupOperation("control_pins");
        }
        ...
        {
            System.Func<IPin, object, object, bool> handler = OperationBroker.Instance.GetRegisteredDelegate<System.Func<IPin, object, object, bool>>(_not_uniqueOperation);
            if ((handler != null))
            {
            }
            else
            {
                throw new System.InvalidOperationException("There is no implementation for method not_unique registered. Use the method broke" +
                        "r to register a method implementation.");
            }
            OperationCallEventArgs e = new OperationCallEventArgs(this, _not_uniqueOperation.Value, diagnostics, context);
            this.OnBubbledChange(BubbledChangeEventArgs.OperationCalling(this, _not_uniqueOperation.Value, e));
            bool result = handler.Invoke(this, diagnostics, context);
            e.Result = result;
            this.OnBubbledChange(BubbledChangeEventArgs.OperationCalled(this, _not_uniqueOperation.Value, e));
            return result;
        }
        
        private static NMF.Models.Meta.IOperation RetrieveNot_uniqueOperation()
        {
            return ClassInstance.LookupOperation("not_unique");
        }
        
        private static NMF.Models.Meta.ITypedElement RetrieveIsControlAttribute()
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Uml.Pin.ClassInstance)).Resolve("isControl")));
        }
        ...
        protected override void SetFeature(string feature, object value)
        {
            ...
            if ((feature == "ISCONTROL"))
            {
                this.IsControl = ((bool)(value));
                return;
            }
        ...
        protected override NMF.Expressions.INotifyExpression<object> GetExpressionForAttribute(string attribute)
        {
            if ((attribute == "ISCONTROL"))
            {
                return Observable.Box(new IsControlProxy(this));
            }
            if ((attribute == "ISORDERED"))
            {
        ...
        /// </summary>
        public class PinChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            /// </summary>
            public PinChildrenCollection(Pin parent)
            {
                this._parent = parent;
            }
        ...
        /// <summary>
        /// Represents a proxy to represent an incremental access to the isControl property
        /// </summary>
        private sealed class IsControlProxy : ModelPropertyChange<IPin, bool>
        {
            ...
            public IsControlProxy(IPin modelElement) : 
                    base(modelElement, "isControl")
            {
            }
            ...
            public override bool Value
            {
                get
                {
                    return this.ModelElement.IsControl;
                }
                set
                {
                    this.ModelElement.IsControl = value;
                }
            }
        }
