...
namespace NMF.Interop.Uml
{
    ...
    [DebuggerDisplayAttribute("AssociationClass {Name}")]
    public partial class AssociationClass : Class, IAssociationClass, IModelElement
    {
        
        private static System.Lazy<NMF.Models.Meta.IOperation> _cannot_be_definedOperation = new System.Lazy<NMF.Models.Meta.IOperation>(RetrieveCannot_be_definedOperation);
        
        private static System.Lazy<NMF.Models.Meta.IOperation> _disjoint_attributes_endsOperation = new System.Lazy<NMF.Models.Meta.IOperation>(RetrieveDisjoint_attributes_endsOperation);
        ...
        public override IEnumerableExpression<IModelElement> Children
        {
            get
            {
                return base.Children.Concat(new AssociationClassChildrenCollection(this));
            }
        }
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((NMF.Models.Meta.IClass)(MetaRepository.Instance.Resolve("http://www.eclipse.org/uml2/5.0.0/UML#//AssociationClass")));
                }
        ...
        public bool Cannot_be_defined(object diagnostics, object context)
        {
            System.Func<IAssociationClass, object, object, bool> handler = OperationBroker.Instance.GetRegisteredDelegate<System.Func<IAssociationClass, object, object, bool>>(_cannot_be_definedOperation);
            if ((handler != null))
            {
            }
            else
            {
                throw new System.InvalidOperationException("There is no implementation for method cannot_be_defined registered. Use the metho" +
                        "d broker to register a method implementation.");
            }
            OperationCallEventArgs e = new OperationCallEventArgs(this, _cannot_be_definedOperation.Value, diagnostics, context);
            this.OnBubbledChange(BubbledChangeEventArgs.OperationCalling(this, _cannot_be_definedOperation.Value, e));
            bool result = handler.Invoke(this, diagnostics, context);
            e.Result = result;
            this.OnBubbledChange(BubbledChangeEventArgs.OperationCalled(this, _cannot_be_definedOperation.Value, e));
            return result;
        }
        
        private static NMF.Models.Meta.IOperation RetrieveCannot_be_definedOperation()
        {
            return ClassInstance.LookupOperation("cannot_be_defined");
        }
        ...
        /// <param name="diagnostics">The chain of diagnostics to which problems are to be appended.</param>
        /// <param name="context">The cache of context-specific information.</param>
        public bool Disjoint_attributes_ends(object diagnostics, object context)
        {
            System.Func<IAssociationClass, object, object, bool> handler = OperationBroker.Instance.GetRegisteredDelegate<System.Func<IAssociationClass, object, object, bool>>(_disjoint_attributes_endsOperation);
            if ((handler != null))
            {
            }
            else
            {
                throw new System.InvalidOperationException("There is no implementation for method disjoint_attributes_ends registered. Use th" +
                        "e method broker to register a method implementation.");
            }
            OperationCallEventArgs e = new OperationCallEventArgs(this, _disjoint_attributes_endsOperation.Value, diagnostics, context);
            this.OnBubbledChange(BubbledChangeEventArgs.OperationCalling(this, _disjoint_attributes_endsOperation.Value, e));
            bool result = handler.Invoke(this, diagnostics, context);
            e.Result = result;
            this.OnBubbledChange(BubbledChangeEventArgs.OperationCalled(this, _disjoint_attributes_endsOperation.Value, e));
            return result;
        }
        
        private static NMF.Models.Meta.IOperation RetrieveDisjoint_attributes_endsOperation()
        {
            return ClassInstance.LookupOperation("disjoint_attributes_ends");
        }
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Uml.Association.ClassInstance)).Resolve("memberEnd")));
        }
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Uml.Association.ClassInstance)).Resolve("ownedEnd")));
        }
        ...
        /// </summary>
        public class AssociationClassChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private AssociationClass _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public AssociationClassChildrenCollection(AssociationClass parent)
            {
                this._parent = parent;
            }
