...
namespace NMF.Interop.Uml
{
    ...
    /// </summary>
    public class ComponentRealizationSupplierCollection : ICollectionExpression<INamedElement>, ICollection<INamedElement>
    {
        ...
        /// </summary>
        public ComponentRealizationSupplierCollection(IComponentRealization parent)
        {
            this._parent = parent;
            parent.BubbledChange += this.HandleAbstractionValueChange;
        }
        ...
        private void HandleAbstractionValueChange(object sender, BubbledChangeEventArgs e)
        {
        }
        ...
        {
            return Enumerable.Empty<INamedElement>().Concat(this._parent.Abstraction).GetEnumerator();
        }
