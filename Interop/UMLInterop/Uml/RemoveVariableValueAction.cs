...
namespace NMF.Interop.Uml
{
    ...
    [ModelRepresentationClassAttribute("http://www.eclipse.org/uml2/5.0.0/UML#//RemoveVariableValueAction")]
    [DebuggerDisplayAttribute("RemoveVariableValueAction {Name}")]
    public partial class RemoveVariableValueAction : WriteVariableAction, IRemoveVariableValueAction, IModelElement
    {
        ...
        [DescriptionAttribute("Specifies whether to remove duplicates of the value in nonunique Variables.\n<p>Fr" +
            "om package UML::Actions.</p>")]
        [CategoryAttribute("RemoveVariableValueAction")]
        ...
        public override IEnumerableExpression<IModelElement> Children
        {
            get
            {
                return base.Children.Concat(new RemoveVariableValueActionChildrenCollection(this));
            }
        }
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new RemoveVariableValueActionReferencedElementsCollection(this));
            }
        }
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((NMF.Models.Meta.IClass)(MetaRepository.Instance.Resolve("http://www.eclipse.org/uml2/5.0.0/UML#//RemoveVariableValueAction")));
                }
        ...
        {
            System.Func<IRemoveVariableValueAction, object, object, bool> handler = OperationBroker.Instance.GetRegisteredDelegate<System.Func<IRemoveVariableValueAction, object, object, bool>>(_removeAt_and_valueOperation);
            if ((handler != null))
            {
            }
            else
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Uml.RemoveVariableValueAction.ClassInstance)).Resolve("isRemoveDuplicates")));
        }
        
        private static NMF.Models.Meta.ITypedElement RetrieveRemoveAtReference()
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Uml.RemoveVariableValueAction.ClassInstance)).Resolve("removeAt")));
        }
        ...
        /// </summary>
        public class RemoveVariableValueActionChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private RemoveVariableValueAction _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public RemoveVariableValueActionChildrenCollection(RemoveVariableValueAction parent)
            {
                this._parent = parent;
            }
        ...
        /// The collection class to to represent the children of the RemoveVariableValueAction class
        /// </summary>
        public class RemoveVariableValueActionReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            /// Creates a new instance
            /// </summary>
            public RemoveVariableValueActionReferencedElementsCollection(RemoveVariableValueAction parent)
            {
                this._parent = parent;
            }
        ...
        /// </summary>
        private sealed class IsRemoveDuplicatesProxy : ModelPropertyChange<IRemoveVariableValueAction, bool>
        {
            ...
            public IsRemoveDuplicatesProxy(IRemoveVariableValueAction modelElement) : 
        ...
        /// </summary>
        private sealed class RemoveAtProxy : ModelPropertyChange<IRemoveVariableValueAction, IInputPin>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public RemoveAtProxy(IRemoveVariableValueAction modelElement) : 
