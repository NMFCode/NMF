...
namespace NMF.Interop.Uml
{
    ...
    /// </summary>
    public class BehaviorOwnedRuleCollection : ICollectionExpression<IConstraint>, ICollection<IConstraint>, IListExpression<IConstraint>, IList<IConstraint>
    {
        ...
        /// </summary>
        public BehaviorOwnedRuleCollection(IBehavior parent)
        {
            this._parent = parent;
        ...
        {
            return Enumerable.Empty<IConstraint>().Concat(this._parent.Postcondition).Concat(this._parent.Precondition).GetEnumerator();
        }
