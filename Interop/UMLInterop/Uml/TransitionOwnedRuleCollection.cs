...
namespace NMF.Interop.Uml
{
    ...
    /// </summary>
    public class TransitionOwnedRuleCollection : ICollectionExpression<IConstraint>, ICollection<IConstraint>, IListExpression<IConstraint>, IList<IConstraint>
    {
        
        private ITransition _parent;
        ...
        {
            return Enumerable.Empty<IConstraint>().Concat(this._parent.Guard).GetEnumerator();
        }
