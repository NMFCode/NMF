    ...
    public partial class Interaction : Behavior, IInteraction, IModelElement
    {
        ...
        public class InteractionChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            public override int Count
            {
                ...
                {
                    int count = 0;
                    count = (count + this._parent.Lifeline.Count);
                    count = (count + this._parent.Fragment.Count);
                    count = (count + this._parent.Action.Count);
                    count = (count + this._parent.FormalGate.Count);
            ...
            {
                this._parent.Lifeline.AsNotifiable().CollectionChanged += this.PropagateCollectionChanges;
                this._parent.Fragment.AsNotifiable().CollectionChanged += this.PropagateCollectionChanges;
                this._parent.Action.AsNotifiable().CollectionChanged += this.PropagateCollectionChanges;
                this._parent.FormalGate.AsNotifiable().CollectionChanged += this.PropagateCollectionChanges;
            ...
            {
                ILifeline lifelineCasted = item.As<ILifeline>();
                if ((lifelineCasted != null))
                {
                    this._parent.Lifeline.Add(lifelineCasted);
                }
                ...
                {
                    this._parent.Action.Add(actionCasted);
                }
                IGate formalGateCasted = item.As<IGate>();
                if ((formalGateCasted != null))
                {
                    this._parent.FormalGate.Add(formalGateCasted);
                }
            ...
            {
                this._parent.Lifeline.Clear();
                this._parent.Fragment.Clear();
                this._parent.Action.Clear();
                this._parent.FormalGate.Clear();
            ...
            {
                if (this._parent.Lifeline.Contains(item))
                {
                    return true;
                }
                ...
                if (this._parent.Action.Contains(item))
                {
                    return true;
                }
                if (this._parent.FormalGate.Contains(item))
                {
                    return true;
                }
            ...
            {
                IEnumerator<IModelElement> lifelineEnumerator = this._parent.Lifeline.GetEnumerator();
                try
                {
                    for (
                    ; lifelineEnumerator.MoveNext(); 
                    )
                    {
                        array[arrayIndex] = lifelineEnumerator.Current;
                        arrayIndex = (arrayIndex + 1);
                    }
                }
                finally
                {
                    lifelineEnumerator.Dispose();
                }
                ...
                IEnumerator<IModelElement> actionEnumerator = this._parent.Action.GetEnumerator();
                try
                {
                    for (
                    ...
                    {
                        array[arrayIndex] = actionEnumerator.Current;
                        arrayIndex = (arrayIndex + 1);
                    }
                }
                finally
                ...
                IEnumerator<IModelElement> formalGateEnumerator = this._parent.FormalGate.GetEnumerator();
                try
                {
                    for (
                    ; formalGateEnumerator.MoveNext(); 
                    )
                    {
                        array[arrayIndex] = formalGateEnumerator.Current;
                        arrayIndex = (arrayIndex + 1);
                    }
                }
                finally
                {
                    formalGateEnumerator.Dispose();
                }
            ...
            public override bool Remove(IModelElement item)
            {
                ...
                if (((lifelineItem != null) 
                            && this._parent.Lifeline.Remove(lifelineItem)))
                {
                    return true;
                }
                ...
                IAction actionItem = item.As<IAction>();
                if (((actionItem != null) 
                            && this._parent.Action.Remove(actionItem)))
                {
                    return true;
                }
                IGate gateItem = item.As<IGate>();
                if (((gateItem != null) 
                            && this._parent.FormalGate.Remove(gateItem)))
                {
                    return true;
                }
                IMessage messageItem = item.As<IMessage>();
                if (((messageItem != null) 
                            && this._parent.Message.Remove(messageItem)))
                {
                    return true;
                }
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.Lifeline).Concat(this._parent.Fragment).Concat(this._parent.Action).Concat(this._parent.FormalGate).Concat(this._parent.Message).Concat(this._parent.GeneralOrdering).GetEnumerator();
            }
        }
        ...
        public class InteractionReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            public override IEnumerator<IModelElement> GetEnumerator()
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.Lifeline).Concat(this._parent.Fragment).Concat(this._parent.Action).Concat(this._parent.FormalGate).Concat(this._parent.Message).Concat(this._parent.Covered).Concat(this._parent.EnclosingOperand).Concat(this._parent.EnclosingInteraction).Concat(this._parent.GeneralOrdering).GetEnumerator();
            }
        }
