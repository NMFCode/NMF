    ...
    public partial class Abstraction : Dependency, IAbstraction, IModelElement
    {
        ...
        public class AbstractionChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            public override void Add(IModelElement item)
            {
                if ((this._parent.Mapping == null))
                {
                    IOpaqueExpression mappingCasted = item.As<IOpaqueExpression>();
                    if ((mappingCasted != null))
                    {
                        this._parent.Mapping = mappingCasted;
                        return;
                    }
                }
            }
            ...
            public override void CopyTo(IModelElement[] array, int arrayIndex)
            {
                if ((this._parent.Mapping != null))
                {
                    array[arrayIndex] = this._parent.Mapping;
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.Mapping).GetEnumerator();
            }
        }
