...
namespace NMF.Interop.Uml
{
    ...
    public partial class InstanceSpecification : DeploymentTarget, IInstanceSpecification, IModelElement
    {
        
        private static System.Lazy<NMF.Models.Meta.IOperation> _deployment_artifactOperation = new System.Lazy<NMF.Models.Meta.IOperation>(RetrieveDeployment_artifactOperation);
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((NMF.Models.Meta.IClass)(MetaRepository.Instance.Resolve("http://www.eclipse.org/uml2/5.0.0/UML#//InstanceSpecification")));
                }
        ...
        public bool Deployment_artifact(object diagnostics, object context)
        {
            System.Func<IInstanceSpecification, object, object, bool> handler = OperationBroker.Instance.GetRegisteredDelegate<System.Func<IInstanceSpecification, object, object, bool>>(_deployment_artifactOperation);
            if ((handler != null))
            {
            }
            else
            {
                throw new System.InvalidOperationException("There is no implementation for method deployment_artifact registered. Use the met" +
                        "hod broker to register a method implementation.");
            }
            OperationCallEventArgs e = new OperationCallEventArgs(this, _deployment_artifactOperation.Value, diagnostics, context);
            this.OnBubbledChange(BubbledChangeEventArgs.OperationCalling(this, _deployment_artifactOperation.Value, e));
            bool result = handler.Invoke(this, diagnostics, context);
            e.Result = result;
            this.OnBubbledChange(BubbledChangeEventArgs.OperationCalled(this, _deployment_artifactOperation.Value, e));
            return result;
        }
        
        private static NMF.Models.Meta.IOperation RetrieveDeployment_artifactOperation()
        {
            return ClassInstance.LookupOperation("deployment_artifact");
        }
        ...
        {
            System.Func<IInstanceSpecification, object, object, bool> handler = OperationBroker.Instance.GetRegisteredDelegate<System.Func<IInstanceSpecification, object, object, bool>>(_deployment_targetOperation);
            if ((handler != null))
            {
            }
            else
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Uml.InstanceSpecification.ClassInstance)).Resolve("classifier")));
        }
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Uml.InstanceSpecification.ClassInstance)).Resolve("slot")));
        }
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Uml.InstanceSpecification.ClassInstance)).Resolve("specification")));
        }
        ...
        public class InstanceSpecificationReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            public override IEnumerator<IModelElement> GetEnumerator()
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.Classifier).Concat(this._parent.Slot).Concat(this._parent.Specification).Concat(this._parent.OwningTemplateParameter).Concat(this._parent.TemplateParameter).GetEnumerator();
            }
        }
