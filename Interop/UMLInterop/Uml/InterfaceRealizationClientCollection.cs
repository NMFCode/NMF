...
namespace NMF.Interop.Uml
{
    ...
    /// </summary>
    public class InterfaceRealizationClientCollection : ICollectionExpression<INamedElement>, ICollection<INamedElement>
    {
        
        private IInterfaceRealization _parent;
        
        /// <summary>
        /// Creates a new instance
        /// </summary>
        public InterfaceRealizationClientCollection(IInterfaceRealization parent)
        {
            this._parent = parent;
            parent.BubbledChange += this.HandleImplementingClassifierValueChange;
        }
        ...
        private void HandleImplementingClassifierValueChange(object sender, BubbledChangeEventArgs e)
        {
        }
        ...
        {
            return Enumerable.Empty<INamedElement>().Concat(this._parent.ImplementingClassifier).GetEnumerator();
        }
