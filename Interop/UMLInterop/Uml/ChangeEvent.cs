    ...
    public partial class ChangeEvent : Event, IChangeEvent, IModelElement
    {
        ...
        public class ChangeEventChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            public override int Count
            {
                ...
                {
                    int count = 0;
                    if ((this._parent.ChangeExpression != null))
                    {
                        count = (count + 1);
                    }
                    return count;
            ...
            public override void Add(IModelElement item)
            {
                if ((this._parent.ChangeExpression == null))
                {
                    IValueSpecification changeExpressionCasted = item.As<IValueSpecification>();
                    if ((changeExpressionCasted != null))
                    {
                        this._parent.ChangeExpression = changeExpressionCasted;
                        return;
                    }
                }
            }
            ...
            {
                this._parent.ChangeExpression = null;
            }
            ...
            {
                if ((item == this._parent.ChangeExpression))
                {
                    return true;
                }
                return false;
            ...
            public override void CopyTo(IModelElement[] array, int arrayIndex)
            {
                if ((this._parent.ChangeExpression != null))
                {
                    array[arrayIndex] = this._parent.ChangeExpression;
            ...
            {
                if ((this._parent.ChangeExpression == item))
                {
                    this._parent.ChangeExpression = null;
                    return true;
                }
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.ChangeExpression).GetEnumerator();
            }
        }
