...
namespace NMF.Interop.Uml
{
    ...
    public class InterfaceOwnedAttributeCollection : ObservableOppositeOrderedSet<IInterface, IProperty>
    {
        ...
        protected override void SetOpposite(IProperty item, IInterface parent)
        {
            if ((parent != null))
            {
