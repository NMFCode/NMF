...
namespace NMF.Interop.Uml
{
    ...
    [DebuggerDisplayAttribute("Collaboration {Name}")]
    public partial class Collaboration : StructuredClassifier, ICollaboration, IModelElement
    {
        
        private static Lazy<NMF.Models.Meta.ITypedElement> _collaborationRoleReference = new Lazy<NMF.Models.Meta.ITypedElement>(RetrieveCollaborationRoleReference);
        
        /// <summary>
        /// The backing field for the CollaborationRole property
        /// </summary>
        [DebuggerBrowsableAttribute(DebuggerBrowsableState.Never)]
        private ObservableAssociationSet<IConnectableElement> _collaborationRole;
        ...
        {
            this._collaborationRole = new ObservableAssociationSet<IConnectableElement>();
            this._collaborationRole.CollectionChanging += this.CollaborationRoleCollectionChanging;
            this._collaborationRole.CollectionChanged += this.CollaborationRoleCollectionChanged;
        ...
        [ConstantAttribute()]
        public ISetExpression<IConnectableElement> CollaborationRole
        {
            get
            {
                return this._collaborationRole;
            }
        }
        ...
        public override IEnumerableExpression<IModelElement> Children
        {
            get
            {
                return base.Children.Concat(new CollaborationChildrenCollection(this));
            }
        }
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new CollaborationReferencedElementsCollection(this));
            }
        }
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((NMF.Models.Meta.IClass)(MetaRepository.Instance.Resolve("http://www.eclipse.org/uml2/5.0.0/UML#//Collaboration")));
                }
                return _classInstance;
            }
        }
        
        private static NMF.Models.Meta.ITypedElement RetrieveCollaborationRoleReference()
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Uml.Collaboration.ClassInstance)).Resolve("collaborationRole")));
        }
        
        /// <summary>
        /// Forwards CollectionChanging notifications for the CollaborationRole property to the parent model element
        /// </summary>
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void CollaborationRoleCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
            this.OnCollectionChanging("CollaborationRole", e, _collaborationRoleReference);
        }
        
        /// <summary>
        /// Forwards CollectionChanged notifications for the CollaborationRole property to the parent model element
        /// </summary>
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void CollaborationRoleCollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            this.OnCollectionChanged("CollaborationRole", e, _collaborationRoleReference);
        }
        ...
        /// </summary>
        public class CollaborationChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private Collaboration _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public CollaborationChildrenCollection(Collaboration parent)
            {
                this._parent = parent;
            }
        ...
        /// The collection class to to represent the children of the Collaboration class
        /// </summary>
        public class CollaborationReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            /// Creates a new instance
            /// </summary>
            public CollaborationReferencedElementsCollection(Collaboration parent)
            {
                this._parent = parent;
            }
            ...
            public override int Count
            {
                ...
                {
                    int count = 0;
                    count = (count + this._parent.CollaborationRole.Count);
            ...
            protected override void AttachCore()
            {
                this._parent.CollaborationRole.AsNotifiable().CollectionChanged += this.PropagateCollectionChanges;
            ...
            public override void Add(IModelElement item)
            {
                IConnectableElement collaborationRoleCasted = item.As<IConnectableElement>();
                if ((collaborationRoleCasted != null))
                {
                    this._parent.CollaborationRole.Add(collaborationRoleCasted);
                }
                if ((this._parent.ClassifierBehavior == null))
                {
            ...
            public override void Clear()
            {
                this._parent.CollaborationRole.Clear();
            ...
            public override bool Contains(IModelElement item)
            {
                if (this._parent.CollaborationRole.Contains(item))
                {
                    return true;
                }
            ...
            public override void CopyTo(IModelElement[] array, int arrayIndex)
            {
                IEnumerator<IModelElement> collaborationRoleEnumerator = this._parent.CollaborationRole.GetEnumerator();
                try
                {
                    for (
                    ; collaborationRoleEnumerator.MoveNext(); 
                    )
                    {
                        array[arrayIndex] = collaborationRoleEnumerator.Current;
                        arrayIndex = (arrayIndex + 1);
                    }
                }
                finally
                {
                    collaborationRoleEnumerator.Dispose();
                }
                if ((this._parent.ClassifierBehavior != null))
                {
            ...
            public override bool Remove(IModelElement item)
            {
                IConnectableElement connectableElementItem = item.As<IConnectableElement>();
                if (((connectableElementItem != null) 
                            && this._parent.CollaborationRole.Remove(connectableElementItem)))
                {
                    return true;
                }
            ...
            public override IEnumerator<IModelElement> GetEnumerator()
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.CollaborationRole).Concat(this._parent.ClassifierBehavior).Concat(this._parent.InterfaceRealization).Concat(this._parent.OwnedBehavior).GetEnumerator();
            }
        }
