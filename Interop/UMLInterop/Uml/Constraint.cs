    ...
    public partial class Constraint : PackageableElement, IConstraint, IModelElement
    {
        ...
        public class ConstraintReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            public override void Add(IModelElement item)
            {
                ...
                if ((this._parent.Context == null))
                {
                    NMF.Interop.Uml.INamespace contextCasted = item.As<NMF.Interop.Uml.INamespace>();
            ...
            public override IEnumerator<IModelElement> GetEnumerator()
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.ConstrainedElement).Concat(this._parent.Context).Concat(this._parent.Specification).GetEnumerator();
            }
        }
