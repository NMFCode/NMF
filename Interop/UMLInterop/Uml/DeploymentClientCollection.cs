...
namespace NMF.Interop.Uml
{
    ...
    /// </summary>
    public class DeploymentClientCollection : ICollectionExpression<INamedElement>, ICollection<INamedElement>
    {
        ...
        /// </summary>
        public DeploymentClientCollection(IDeployment parent)
        {
            this._parent = parent;
            parent.BubbledChange += this.HandleLocationValueChange;
        }
        ...
        private void HandleLocationValueChange(object sender, BubbledChangeEventArgs e)
        {
        }
        ...
        {
            return Enumerable.Empty<INamedElement>().Concat(this._parent.Location).GetEnumerator();
        }
