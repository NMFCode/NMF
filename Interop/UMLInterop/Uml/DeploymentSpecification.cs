    ...
    public partial class DeploymentSpecification : Artifact, IDeploymentSpecification, IModelElement
    {
        ...
        public class DeploymentSpecificationReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            public override int Count
            {
                ...
                {
                    int count = 0;
                    if ((this._parent.Deployment != null))
                    {
                        count = (count + 1);
                    }
                    return count;
            ...
            public override void Add(IModelElement item)
            {
                if ((this._parent.Deployment == null))
                {
                    ...
                    {
                        this._parent.Deployment = deploymentCasted;
                        return;
                    }
                }
            }
            ...
            {
                if ((item == this._parent.Deployment))
                {
                    return true;
                }
                return false;
            ...
            public override void CopyTo(IModelElement[] array, int arrayIndex)
            {
                if ((this._parent.Deployment != null))
                {
                    array[arrayIndex] = this._parent.Deployment;
            ...
            {
                if ((this._parent.Deployment == item))
                {
                    this._parent.Deployment = null;
                    return true;
                }
