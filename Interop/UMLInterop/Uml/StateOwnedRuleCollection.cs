...
namespace NMF.Interop.Uml
{
    ...
    /// </summary>
    public class StateOwnedRuleCollection : ICollectionExpression<IConstraint>, ICollection<IConstraint>, IListExpression<IConstraint>, IList<IConstraint>
    {
        ...
        /// </summary>
        public StateOwnedRuleCollection(IState parent)
        {
            this._parent = parent;
            parent.BubbledChange += this.HandleStateInvariantValueChange;
        }
        ...
        public virtual IConstraint this[int index]
        {
            get
            {
                ...
                if ((this._parent.StateInvariant != null))
                {
                    ...
                    {
                        return this._parent.StateInvariant;
                    }
            ...
            set
            {
                ...
                if ((this._parent.StateInvariant != null))
                {
                    if ((runningIndex == index))
                    {
                        this._parent.StateInvariant = value;
                    }
                    runningIndex = (runningIndex + 1);
                }
                throw new System.IndexOutOfRangeException();
        ...
        private void HandleStateInvariantValueChange(object sender, BubbledChangeEventArgs e)
        {
        }
        ...
        public virtual void Add(IConstraint item)
        {
            if ((this._parent.StateInvariant == null))
            {
                this._parent.StateInvariant = item;
                return;
            }
        }
        ...
        {
            return Enumerable.Empty<IConstraint>().Concat(this._parent.StateInvariant).GetEnumerator();
        }
