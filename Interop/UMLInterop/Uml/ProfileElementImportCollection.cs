...
namespace NMF.Interop.Uml
{
    ...
    /// </summary>
    public class ProfileElementImportCollection : ICollectionExpression<IElementImport>, ICollection<IElementImport>, IListExpression<IElementImport>, IList<IElementImport>
    {
        ...
        {
            this._parent = parent;
            parent.MetaclassReference.AsNotifiable().CollectionChanged += this.HandleCollectionChange;
        }
        ...
        /// </summary>
        public virtual IElementImport this[int index]
        {
            get
            {
                int runningIndex = 0;
                if ((this._parent.MetaclassReference.Count 
                            <= (index - runningIndex)))
                {
                    return this._parent.MetaclassReference[(index - runningIndex)];
                }
                else
                {
                    runningIndex = (runningIndex + this._parent.MetaclassReference.Count);
                }
            ...
            set
            {
                ...
                if ((this._parent.MetaclassReference.Count 
                            <= (index - runningIndex)))
                {
                    this._parent.MetaclassReference[(index - runningIndex)] = value;
                }
                else
                {
                    runningIndex = (runningIndex + this._parent.MetaclassReference.Count);
        ...
        {
            this._parent.MetaclassReference.Add(item);
        }
        ...
        {
            this._parent.MetaclassReference.CopyTo(array, arrayIndex);
            arrayIndex = (arrayIndex + this._parent.MetaclassReference.Count);
        }
        ...
        {
            if (this._parent.MetaclassReference.Remove(item))
            {
                return true;
            }
            return false;
        ...
        {
            return Enumerable.Empty<IElementImport>().Concat(this._parent.MetaclassReference).GetEnumerator();
        }
        ...
        public virtual int IndexOf(IElementImport item)
        {
            int runningIndex = 0;
            int index;
            index = this._parent.MetaclassReference.IndexOf(item);
            if ((index == -1))
            {
                runningIndex = (runningIndex + this._parent.MetaclassReference.Count);
            }
        ...
        public virtual void Insert(int index, IElementImport item)
        {
            ...
            if ((this._parent.MetaclassReference.Count 
                        <= (index - runningIndex)))
            {
                this._parent.MetaclassReference.Insert((index - runningIndex), item);
                return;
            }
            else
            {
        ...
        public virtual void RemoveAt(int index)
        {
            ...
            if ((this._parent.MetaclassReference.Count 
                        <= (index - runningIndex)))
            {
                this._parent.MetaclassReference.RemoveAt((index - runningIndex));
                return;
            }
            else
            {
        ...
        /// Gets an observable version of this collection
        /// </summary>
        INotifyEnumerable<IElementImport> IEnumerableExpression<IElementImport>.AsNotifiable()
        {
            return this.WithUpdates();
        }
