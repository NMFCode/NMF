    ...
    public partial class Slot : Element, ISlot, IModelElement
    {
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((NMF.Models.Meta.IClass)(MetaRepository.Instance.Resolve("http://www.eclipse.org/uml2/5.0.0/UML#//Slot")));
                }
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Uml.Slot.ClassInstance)).Resolve("definingFeature")));
        }
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Uml.Slot.ClassInstance)).Resolve("value")));
        }
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Uml.Slot.ClassInstance)).Resolve("owningInstance")));
        }
