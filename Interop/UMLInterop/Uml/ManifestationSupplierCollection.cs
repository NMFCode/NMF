...
namespace NMF.Interop.Uml
{
    ...
    /// </summary>
    public class ManifestationSupplierCollection : ICollectionExpression<INamedElement>, ICollection<INamedElement>
    {
        
        private IManifestation _parent;
        
        /// <summary>
        /// Creates a new instance
        /// </summary>
        public ManifestationSupplierCollection(IManifestation parent)
        {
            this._parent = parent;
            parent.BubbledChange += this.HandleUtilizedElementValueChange;
        }
        ...
        private void HandleUtilizedElementValueChange(object sender, BubbledChangeEventArgs e)
        {
        }
        ...
        {
            return Enumerable.Empty<INamedElement>().Concat(this._parent.UtilizedElement).GetEnumerator();
        }
