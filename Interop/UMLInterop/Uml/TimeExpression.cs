...
namespace NMF.Interop.Uml
{
    ...
    [DebuggerDisplayAttribute("TimeExpression {Name}")]
    public partial class TimeExpression : ValueSpecification, ITimeExpression, IModelElement
    {
        ...
        public override IEnumerableExpression<IModelElement> Children
        {
            get
            {
                return base.Children.Concat(new TimeExpressionChildrenCollection(this));
            }
        }
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new TimeExpressionReferencedElementsCollection(this));
            }
        }
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((NMF.Models.Meta.IClass)(MetaRepository.Instance.Resolve("http://www.eclipse.org/uml2/5.0.0/UML#//TimeExpression")));
                }
        ...
        {
            System.Func<ITimeExpression, object, object, bool> handler = OperationBroker.Instance.GetRegisteredDelegate<System.Func<ITimeExpression, object, object, bool>>(_no_expr_requires_observationOperation);
            if ((handler != null))
            {
            }
            else
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Uml.TimeExpression.ClassInstance)).Resolve("expr")));
        }
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Uml.TimeExpression.ClassInstance)).Resolve("observation")));
        }
        ...
        /// </summary>
        public class TimeExpressionChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private TimeExpression _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public TimeExpressionChildrenCollection(TimeExpression parent)
            {
                this._parent = parent;
            }
        ...
        /// The collection class to to represent the children of the TimeExpression class
        /// </summary>
        public class TimeExpressionReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            /// Creates a new instance
            /// </summary>
            public TimeExpressionReferencedElementsCollection(TimeExpression parent)
            {
                this._parent = parent;
            }
        ...
        /// </summary>
        private sealed class ExprProxy : ModelPropertyChange<ITimeExpression, IValueSpecification>
        {
            ...
            public ExprProxy(ITimeExpression modelElement) : 
