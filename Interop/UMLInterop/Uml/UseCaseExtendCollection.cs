...
namespace NMF.Interop.Uml
{
    ...
    public class UseCaseExtendCollection : ObservableOppositeOrderedSet<IUseCase, IExtend>
    {
        ...
        private void OnItemParentChanged(object sender, ValueChangedEventArgs e)
        {
            ...
            {
                this.Remove(((IExtend)(sender)));
            }
        }
        
        protected override void SetOpposite(IExtend item, IUseCase parent)
        {
            if ((parent != null))
            {
