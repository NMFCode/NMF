    ...
    public partial class ProtocolStateMachine : StateMachine, IProtocolStateMachine, IModelElement
    {
        ...
        public class ProtocolStateMachineChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            public override int Count
            {
                ...
                {
                    int count = 0;
                    count = (count + this._parent.Conformance.Count);
                    return count;
                }
            }
            ...
            {
                this._parent.Conformance.AsNotifiable().CollectionChanged += this.PropagateCollectionChanges;
            }
            ...
            {
                IProtocolConformance conformanceCasted = item.As<IProtocolConformance>();
                if ((conformanceCasted != null))
                {
                    this._parent.Conformance.Add(conformanceCasted);
                }
            }
            ...
            {
                this._parent.Conformance.Clear();
            }
            ...
            {
                if (this._parent.Conformance.Contains(item))
                {
                    return true;
                }
                return false;
            ...
            {
                IEnumerator<IModelElement> conformanceEnumerator = this._parent.Conformance.GetEnumerator();
                try
                {
                    for (
                    ; conformanceEnumerator.MoveNext(); 
                    )
                    {
                        array[arrayIndex] = conformanceEnumerator.Current;
                        arrayIndex = (arrayIndex + 1);
                    }
                }
                finally
                {
                    conformanceEnumerator.Dispose();
                }
            }
            ...
            {
                IProtocolConformance protocolConformanceItem = item.As<IProtocolConformance>();
                if (((protocolConformanceItem != null) 
                            && this._parent.Conformance.Remove(protocolConformanceItem)))
                {
                    return true;
                }
                return false;
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.Conformance).GetEnumerator();
            }
        }
