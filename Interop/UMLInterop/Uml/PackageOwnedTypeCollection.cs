...
namespace NMF.Interop.Uml
{
    ...
    /// </summary>
    public class PackageOwnedTypeCollection : ObservableOppositeOrderedSet<IPackage, NMF.Interop.Uml.IType>
    {
        ...
        private void OnItemParentChanged(object sender, ValueChangedEventArgs e)
        {
            ...
            {
                this.Remove(((NMF.Interop.Uml.IType)(sender)));
            }
        }
        ...
        protected override void SetOpposite(NMF.Interop.Uml.IType item, IPackage newParent)
        {
            if ((newParent != null))
            {
