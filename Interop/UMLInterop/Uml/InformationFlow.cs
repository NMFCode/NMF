    ...
    public partial class InformationFlow : PackageableElement, IInformationFlow, IModelElement
    {
        ...
        public class InformationFlowReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            public override int Count
            {
                ...
                {
                    int count = 0;
                    count = (count + this._parent.Conveyed.Count);
                    count = (count + this._parent.InformationSource.Count);
                    count = (count + this._parent.InformationTarget.Count);
                    count = (count + this._parent.Realization.Count);
                    count = (count + this._parent.RealizingActivityEdge.Count);
                    count = (count + this._parent.RealizingConnector.Count);
                    count = (count + this._parent.RealizingMessage.Count);
                    return count;
                }
            }
            ...
            protected override void AttachCore()
            {
                this._parent.Conveyed.AsNotifiable().CollectionChanged += this.PropagateCollectionChanges;
                this._parent.InformationSource.AsNotifiable().CollectionChanged += this.PropagateCollectionChanges;
                this._parent.InformationTarget.AsNotifiable().CollectionChanged += this.PropagateCollectionChanges;
                this._parent.Realization.AsNotifiable().CollectionChanged += this.PropagateCollectionChanges;
                this._parent.RealizingActivityEdge.AsNotifiable().CollectionChanged += this.PropagateCollectionChanges;
                this._parent.RealizingConnector.AsNotifiable().CollectionChanged += this.PropagateCollectionChanges;
                this._parent.RealizingMessage.AsNotifiable().CollectionChanged += this.PropagateCollectionChanges;
            }
            ...
            public override void Add(IModelElement item)
            {
                IClassifier conveyedCasted = item.As<IClassifier>();
                if ((conveyedCasted != null))
                {
                    this._parent.Conveyed.Add(conveyedCasted);
                }
                INamedElement informationSourceCasted = item.As<INamedElement>();
                if ((informationSourceCasted != null))
                {
                    this._parent.InformationSource.Add(informationSourceCasted);
                }
                INamedElement informationTargetCasted = item.As<INamedElement>();
                if ((informationTargetCasted != null))
                {
                    this._parent.InformationTarget.Add(informationTargetCasted);
                }
                IRelationship realizationCasted = item.As<IRelationship>();
                if ((realizationCasted != null))
                {
                    this._parent.Realization.Add(realizationCasted);
                }
                IActivityEdge realizingActivityEdgeCasted = item.As<IActivityEdge>();
                if ((realizingActivityEdgeCasted != null))
                {
                    this._parent.RealizingActivityEdge.Add(realizingActivityEdgeCasted);
                }
                IConnector realizingConnectorCasted = item.As<IConnector>();
                if ((realizingConnectorCasted != null))
                {
                    this._parent.RealizingConnector.Add(realizingConnectorCasted);
                }
                IMessage realizingMessageCasted = item.As<IMessage>();
                if ((realizingMessageCasted != null))
                {
                    this._parent.RealizingMessage.Add(realizingMessageCasted);
                }
            }
            ...
            public override void Clear()
            {
                this._parent.Conveyed.Clear();
                this._parent.InformationSource.Clear();
                this._parent.InformationTarget.Clear();
                this._parent.Realization.Clear();
                this._parent.RealizingActivityEdge.Clear();
                this._parent.RealizingConnector.Clear();
                this._parent.RealizingMessage.Clear();
            }
            ...
            public override bool Contains(IModelElement item)
            {
                if (this._parent.Conveyed.Contains(item))
                {
                    return true;
                }
                if (this._parent.InformationSource.Contains(item))
                {
                    return true;
                }
                if (this._parent.InformationTarget.Contains(item))
                {
                    return true;
                }
                ...
                if (this._parent.RealizingActivityEdge.Contains(item))
                {
                    return true;
                }
                if (this._parent.RealizingConnector.Contains(item))
                {
                    return true;
                }
                if (this._parent.RealizingMessage.Contains(item))
                {
                    return true;
                }
                return false;
            ...
            public override void CopyTo(IModelElement[] array, int arrayIndex)
            {
                IEnumerator<IModelElement> conveyedEnumerator = this._parent.Conveyed.GetEnumerator();
                try
                {
                    for (
                    ; conveyedEnumerator.MoveNext(); 
                    )
                    {
                        array[arrayIndex] = conveyedEnumerator.Current;
                        arrayIndex = (arrayIndex + 1);
                    }
                }
                finally
                {
                    conveyedEnumerator.Dispose();
                }
                IEnumerator<IModelElement> informationSourceEnumerator = this._parent.InformationSource.GetEnumerator();
                try
                {
                    for (
                    ; informationSourceEnumerator.MoveNext(); 
                    )
                    {
                        array[arrayIndex] = informationSourceEnumerator.Current;
                        arrayIndex = (arrayIndex + 1);
                    }
                }
                finally
                {
                    informationSourceEnumerator.Dispose();
                }
                IEnumerator<IModelElement> informationTargetEnumerator = this._parent.InformationTarget.GetEnumerator();
                try
                {
                    for (
                    ; informationTargetEnumerator.MoveNext(); 
                    )
                    {
                        array[arrayIndex] = informationTargetEnumerator.Current;
                        arrayIndex = (arrayIndex + 1);
                    }
                }
                finally
                {
                    informationTargetEnumerator.Dispose();
                }
                ...
                IEnumerator<IModelElement> realizingActivityEdgeEnumerator = this._parent.RealizingActivityEdge.GetEnumerator();
                try
                {
                    for (
                    ; realizingActivityEdgeEnumerator.MoveNext(); 
                    )
                    {
                        array[arrayIndex] = realizingActivityEdgeEnumerator.Current;
                        arrayIndex = (arrayIndex + 1);
                    }
                }
                finally
                {
                    realizingActivityEdgeEnumerator.Dispose();
                }
                IEnumerator<IModelElement> realizingConnectorEnumerator = this._parent.RealizingConnector.GetEnumerator();
                try
                {
                    for (
                    ; realizingConnectorEnumerator.MoveNext(); 
                    )
                    {
                        array[arrayIndex] = realizingConnectorEnumerator.Current;
                        arrayIndex = (arrayIndex + 1);
                    }
                }
                finally
                {
                    realizingConnectorEnumerator.Dispose();
                }
                IEnumerator<IModelElement> realizingMessageEnumerator = this._parent.RealizingMessage.GetEnumerator();
                try
                {
                    for (
                    ; realizingMessageEnumerator.MoveNext(); 
                    )
                    {
                        array[arrayIndex] = realizingMessageEnumerator.Current;
                        arrayIndex = (arrayIndex + 1);
                    }
                }
                finally
                {
                    realizingMessageEnumerator.Dispose();
                }
            }
            ...
            public override bool Remove(IModelElement item)
            {
                ...
                if (((classifierItem != null) 
                            && this._parent.Conveyed.Remove(classifierItem)))
                {
                    return true;
                }
                INamedElement namedElementItem = item.As<INamedElement>();
                if (((namedElementItem != null) 
                            && this._parent.InformationSource.Remove(namedElementItem)))
                {
                    return true;
                }
                if (((namedElementItem != null) 
                            && this._parent.InformationTarget.Remove(namedElementItem)))
                {
                    return true;
                }
                IRelationship relationshipItem = item.As<IRelationship>();
                if (((relationshipItem != null) 
                            && this._parent.Realization.Remove(relationshipItem)))
                {
                    return true;
                }
                IActivityEdge activityEdgeItem = item.As<IActivityEdge>();
                if (((activityEdgeItem != null) 
                            && this._parent.RealizingActivityEdge.Remove(activityEdgeItem)))
                {
                    return true;
                }
                IConnector connectorItem = item.As<IConnector>();
                if (((connectorItem != null) 
                            && this._parent.RealizingConnector.Remove(connectorItem)))
                {
                    return true;
                }
                IMessage messageItem = item.As<IMessage>();
                if (((messageItem != null) 
                            && this._parent.RealizingMessage.Remove(messageItem)))
                {
                    return true;
                }
                return false;
            ...
            public override IEnumerator<IModelElement> GetEnumerator()
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.Conveyed).Concat(this._parent.InformationSource).Concat(this._parent.InformationTarget).Concat(this._parent.Realization).Concat(this._parent.RealizingActivityEdge).Concat(this._parent.RealizingConnector).Concat(this._parent.RealizingMessage).GetEnumerator();
            }
        }
    }
}
