    ...
    public partial class RedefinableTemplateSignature : RedefinableElement, IRedefinableTemplateSignature, IModelElement
    {
        ...
        public class RedefinableTemplateSignatureReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            public override int Count
            {
                ...
                {
                    int count = 0;
                    count = (count + this._parent.ExtendedSignature.Count);
            ...
            protected override void AttachCore()
            {
                this._parent.ExtendedSignature.AsNotifiable().CollectionChanged += this.PropagateCollectionChanges;
            ...
            public override void Add(IModelElement item)
            {
                IRedefinableTemplateSignature extendedSignatureCasted = item.As<IRedefinableTemplateSignature>();
                if ((extendedSignatureCasted != null))
                {
                    this._parent.ExtendedSignature.Add(extendedSignatureCasted);
                }
                if ((this._parent.Classifier == null))
                {
            ...
            public override void Clear()
            {
                this._parent.ExtendedSignature.Clear();
            ...
            public override bool Contains(IModelElement item)
            {
                if (this._parent.ExtendedSignature.Contains(item))
                {
                    return true;
                }
            ...
            public override void CopyTo(IModelElement[] array, int arrayIndex)
            {
                IEnumerator<IModelElement> extendedSignatureEnumerator = this._parent.ExtendedSignature.GetEnumerator();
                try
                {
                    for (
                    ; extendedSignatureEnumerator.MoveNext(); 
                    )
                    {
                        array[arrayIndex] = extendedSignatureEnumerator.Current;
                        arrayIndex = (arrayIndex + 1);
                    }
                }
                finally
                {
                    extendedSignatureEnumerator.Dispose();
                }
                if ((this._parent.Classifier != null))
                {
            ...
            public override bool Remove(IModelElement item)
            {
                IRedefinableTemplateSignature redefinableTemplateSignatureItem = item.As<IRedefinableTemplateSignature>();
                if (((redefinableTemplateSignatureItem != null) 
                            && this._parent.ExtendedSignature.Remove(redefinableTemplateSignatureItem)))
                {
                    return true;
                }
            ...
            public override IEnumerator<IModelElement> GetEnumerator()
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.ExtendedSignature).Concat(this._parent.Classifier).Concat(this._parent.Parameter).Concat(this._parent.Template).Concat(this._parent.OwnedParameter).GetEnumerator();
            }
        }
