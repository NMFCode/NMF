...
namespace NMF.Interop.Uml
{
    ...
    public partial class Dependency : PackageableElement, IDependency, IModelElement
    {
        ...
        private ObservableAssociationSet<INamedElement> _client;
        ...
        /// </summary>
        [DebuggerBrowsableAttribute(DebuggerBrowsableState.Never)]
        private ObservableAssociationSet<INamedElement> _supplier;
        
        private static NMF.Models.Meta.IClass _classInstance;
        
        public Dependency()
        {
            this._client = new ObservableAssociationSet<INamedElement>();
            this._client.CollectionChanging += this.ClientCollectionChanging;
            this._client.CollectionChanged += this.ClientCollectionChanged;
            this._supplier = new ObservableAssociationSet<INamedElement>();
...
<p>From package UML::CommonStructure.</p>")]
        ...
        [ConstantAttribute()]
        public ISetExpression<INamedElement> Client
        {
            get
            {
                return this._client;
        ...
        [XmlAttributeAttribute(true)]
        [ConstantAttribute()]
        public ISetExpression<INamedElement> Supplier
        {
            get
            {
        ...
        public class DependencyReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            public override int Count
            {
                ...
                {
                    int count = 0;
                    count = (count + this._parent.Client.Count);
                    count = (count + this._parent.Supplier.Count);
                    return count;
                }
            }
            ...
            protected override void AttachCore()
            {
                this._parent.Client.AsNotifiable().CollectionChanged += this.PropagateCollectionChanges;
                this._parent.Supplier.AsNotifiable().CollectionChanged += this.PropagateCollectionChanges;
            }
            ...
            public override void Add(IModelElement item)
            {
                INamedElement clientCasted = item.As<INamedElement>();
                if ((clientCasted != null))
                {
                    this._parent.Client.Add(clientCasted);
                }
                INamedElement supplierCasted = item.As<INamedElement>();
                if ((supplierCasted != null))
                {
                    this._parent.Supplier.Add(supplierCasted);
                }
            }
            ...
            public override void Clear()
            {
                this._parent.Client.Clear();
                this._parent.Supplier.Clear();
            }
            ...
            public override bool Contains(IModelElement item)
            {
                if (this._parent.Client.Contains(item))
                {
                    return true;
                }
                if (this._parent.Supplier.Contains(item))
                {
                    return true;
                }
                return false;
            ...
            public override void CopyTo(IModelElement[] array, int arrayIndex)
            {
                IEnumerator<IModelElement> clientEnumerator = this._parent.Client.GetEnumerator();
                try
                {
                    for (
                    ...
                    {
                        array[arrayIndex] = clientEnumerator.Current;
                ...
                IEnumerator<IModelElement> supplierEnumerator = this._parent.Supplier.GetEnumerator();
                try
                {
                    for (
                    ; supplierEnumerator.MoveNext(); 
                    )
                    {
                        array[arrayIndex] = supplierEnumerator.Current;
                        arrayIndex = (arrayIndex + 1);
                    }
                }
                finally
                {
                    supplierEnumerator.Dispose();
                }
            }
            ...
            public override bool Remove(IModelElement item)
            {
                ...
                if (((namedElementItem != null) 
                            && this._parent.Client.Remove(namedElementItem)))
                {
                    return true;
                }
                if (((namedElementItem != null) 
                            && this._parent.Supplier.Remove(namedElementItem)))
                {
                    return true;
                }
                return false;
            ...
            public override IEnumerator<IModelElement> GetEnumerator()
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.Client).Concat(this._parent.Supplier).GetEnumerator();
            }
        }
    }
}
