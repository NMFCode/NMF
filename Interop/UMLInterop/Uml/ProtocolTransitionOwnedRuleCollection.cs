...
namespace NMF.Interop.Uml
{
    ...
    /// </summary>
    public class ProtocolTransitionOwnedRuleCollection : ICollectionExpression<IConstraint>, ICollection<IConstraint>, IListExpression<IConstraint>, IList<IConstraint>
    {
        
        private IProtocolTransition _parent;
        
        /// <summary>
        /// Creates a new instance
        /// </summary>
        public ProtocolTransitionOwnedRuleCollection(IProtocolTransition parent)
        {
            this._parent = parent;
            parent.BubbledChange += this.HandleGuardValueChange;
            parent.BubbledChange += this.HandlePostConditionValueChange;
        }
        ...
        public virtual IConstraint this[int index]
        {
            get
            {
                ...
                if ((this._parent.PostCondition != null))
                {
                    if ((runningIndex == index))
                    {
                        return this._parent.PostCondition;
                    }
                    runningIndex = (runningIndex + 1);
                }
            ...
            set
            {
                ...
                if ((this._parent.PostCondition != null))
                {
                    if ((runningIndex == index))
                    {
                        this._parent.PostCondition = value;
                    }
                    runningIndex = (runningIndex + 1);
                }
                throw new System.IndexOutOfRangeException();
        ...
        private void HandleGuardValueChange(object sender, BubbledChangeEventArgs e)
        {
        }
        
        private void HandlePostConditionValueChange(object sender, BubbledChangeEventArgs e)
        {
        }
        ...
        public virtual void Add(IConstraint item)
        {
            if ((this._parent.Guard == null))
            {
                this._parent.Guard = item;
                return;
            }
            if ((this._parent.PostCondition == null))
            {
                this._parent.PostCondition = item;
                return;
            }
        }
        ...
        {
            return Enumerable.Empty<IConstraint>().Concat(this._parent.Guard).Concat(this._parent.PostCondition).GetEnumerator();
        }
