...
namespace NMF.Interop.Uml
{
    ...
    public abstract partial class StructuralFeatureAction : Action, IStructuralFeatureAction, IModelElement
    {
        ...
        {
            System.Func<IStructuralFeatureAction, object, object, bool> handler = OperationBroker.Instance.GetRegisteredDelegate<System.Func<IStructuralFeatureAction, object, object, bool>>(_visibilityOperation);
            if ((handler != null))
            {
            }
            else
