...
namespace NMF.Interop.Uml
{
    ...
    public partial class TemplateParameterSubstitution : Element, ITemplateParameterSubstitution, IModelElement
    {
        ...
        private static Lazy<NMF.Models.Meta.ITypedElement> _actualReference = new Lazy<NMF.Models.Meta.ITypedElement>(RetrieveActualReference);
        
        /// <summary>
        /// The backing field for the Actual property
        /// </summary>
        [DebuggerBrowsableAttribute(DebuggerBrowsableState.Never)]
        private IParameterableElement _actual;
        ...
        public IParameterableElement Actual
        {
            get
            {
                return this._actual;
            ...
            set
            {
                ...
                {
                    IParameterableElement old = this._actual;
                    ValueChangedEventArgs e = new ValueChangedEventArgs(old, value);
                    this.OnPropertyChanging("Actual", e, _actualReference);
                    this._actual = value;
                    if ((old != null))
                    {
                        old.Deleted -= this.OnResetActual;
                    }
                    if ((value != null))
                    {
                        value.Deleted += this.OnResetActual;
                    }
                    this.OnPropertyChanged("Actual", e, _actualReference);
                }
            }
        }
        ...
        public IParameterableElement OwnedActual
        {
            ...
            set
            {
                if ((this._ownedActual != value))
                {
                    ...
                    {
                        old.Parent = null;
                        old.ParentChanged -= this.OnResetOwnedActual;
                    }
                    if ((value != null))
                    {
                        value.Parent = this;
                        value.ParentChanged += this.OnResetOwnedActual;
                    }
        ...
        public override IEnumerableExpression<IModelElement> Children
        {
            get
            {
                return base.Children.Concat(new TemplateParameterSubstitutionChildrenCollection(this));
            }
        }
        ...
        private static NMF.Models.Meta.ITypedElement RetrieveActualReference()
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Uml.TemplateParameterSubstitution.ClassInstance)).Resolve("actual")));
        }
        
        /// <summary>
        /// Handles the event that the Actual property must reset
        /// </summary>
        /// <param name="sender">The object that sent this reset request</param>
        /// <param name="eventArgs">The event data for the reset event</param>
        private void OnResetActual(object sender, System.EventArgs eventArgs)
        {
            this.Actual = null;
        }
        ...
        {
            if ((element == this.OwnedActual))
            {
                return ModelHelper.CreatePath("ownedActual");
            }
        ...
        protected override void SetFeature(string feature, object value)
        {
            if ((feature == "ACTUAL"))
            {
                this.Actual = ((IParameterableElement)(value));
                return;
            }
            if ((feature == "FORMAL"))
            {
        ...
        /// </summary>
        public class TemplateParameterSubstitutionChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            /// </summary>
            public TemplateParameterSubstitutionChildrenCollection(TemplateParameterSubstitution parent)
            {
                this._parent = parent;
            }
            ...
            public override int Count
            {
                ...
                {
                    int count = 0;
                    if ((this._parent.OwnedActual != null))
                    {
                        count = (count + 1);
                    }
                    return count;
            ...
            public override void Add(IModelElement item)
            {
                if ((this._parent.OwnedActual == null))
                {
                    IParameterableElement ownedActualCasted = item.As<IParameterableElement>();
                    if ((ownedActualCasted != null))
                    {
                        this._parent.OwnedActual = ownedActualCasted;
                        return;
                    }
                }
            }
            ...
            {
                if ((item == this._parent.OwnedActual))
                {
                    return true;
                }
                return false;
            ...
            public override void CopyTo(IModelElement[] array, int arrayIndex)
            {
                if ((this._parent.OwnedActual != null))
                {
                    array[arrayIndex] = this._parent.OwnedActual;
            ...
            {
                if ((this._parent.OwnedActual == item))
                {
                    this._parent.OwnedActual = null;
                    return true;
                }
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.OwnedActual).GetEnumerator();
            }
        }
        ...
        public class TemplateParameterSubstitutionReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            public override int Count
            {
                ...
                {
                    int count = 0;
                    if ((this._parent.Actual != null))
                    {
                        count = (count + 1);
                    }
                    if ((this._parent.Formal != null))
                    {
                        count = (count + 1);
                    }
                    if ((this._parent.OwnedActual != null))
                    ...
                    if ((this._parent.TemplateBinding != null))
                    {
                        count = (count + 1);
                    }
                    return count;
            ...
            public override void Add(IModelElement item)
            {
                if ((this._parent.Actual == null))
                {
                    IParameterableElement actualCasted = item.As<IParameterableElement>();
                    if ((actualCasted != null))
                    {
                        this._parent.Actual = actualCasted;
                        return;
                    }
                }
                if ((this._parent.Formal == null))
                {
                    ITemplateParameter formalCasted = item.As<ITemplateParameter>();
                    if ((formalCasted != null))
                    {
                        this._parent.Formal = formalCasted;
                        return;
                    }
                }
                if ((this._parent.OwnedActual == null))
                ...
                if ((this._parent.TemplateBinding == null))
                {
                    ...
                    {
                        this._parent.TemplateBinding = templateBindingCasted;
                        return;
                    }
                }
            }
            ...
            public override void Clear()
            {
                this._parent.Actual = null;
                this._parent.Formal = null;
                this._parent.OwnedActual = null;
                this._parent.TemplateBinding = null;
            }
            ...
            public override bool Contains(IModelElement item)
            {
                if ((item == this._parent.Actual))
                {
                    return true;
                }
                if ((item == this._parent.Formal))
                {
                    return true;
                }
                if ((item == this._parent.OwnedActual))
                ...
                if ((item == this._parent.TemplateBinding))
                {
                    return true;
                }
                return false;
            ...
            public override void CopyTo(IModelElement[] array, int arrayIndex)
            {
                if ((this._parent.Actual != null))
                {
                    array[arrayIndex] = this._parent.Actual;
                    arrayIndex = (arrayIndex + 1);
                }
                if ((this._parent.Formal != null))
                {
                    array[arrayIndex] = this._parent.Formal;
                    arrayIndex = (arrayIndex + 1);
                }
                if ((this._parent.OwnedActual != null))
                {
                ...
                if ((this._parent.TemplateBinding != null))
                {
                    array[arrayIndex] = this._parent.TemplateBinding;
                    arrayIndex = (arrayIndex + 1);
                }
            }
            ...
            public override bool Remove(IModelElement item)
            {
                if ((this._parent.Actual == item))
                {
                    this._parent.Actual = null;
                    return true;
                }
                if ((this._parent.Formal == item))
                {
                    this._parent.Formal = null;
                    return true;
                }
                ...
                if ((this._parent.TemplateBinding == item))
                {
                    this._parent.TemplateBinding = null;
                    return true;
                }
            ...
            public override IEnumerator<IModelElement> GetEnumerator()
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.Actual).Concat(this._parent.Formal).Concat(this._parent.OwnedActual).Concat(this._parent.TemplateBinding).GetEnumerator();
            }
        }
