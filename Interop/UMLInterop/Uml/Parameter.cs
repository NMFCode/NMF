...
namespace NMF.Interop.Uml
{
    ...
    public partial class Parameter : ConnectableElement, NMF.Interop.Uml.IParameter, IModelElement
    {
        ...
        public class ParameterChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.DefaultValue).Concat(this._parent.LowerValue).Concat(this._parent.UpperValue).GetEnumerator();
            }
        }
        ...
        public class ParameterReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            public override int Count
            {
                get
                {
                    ...
                    count = (count + this._parent.ParameterSet.Count);
                    if ((this._parent.LowerValue != null))
                    {
                        count = (count + 1);
                    }
            ...
            protected override void AttachCore()
            {
                this._parent.BubbledChange += this.PropagateValueChanges;
                this._parent.BubbledChange += this.PropagateValueChanges;
                this._parent.ParameterSet.AsNotifiable().CollectionChanged += this.PropagateCollectionChanges;
                this._parent.BubbledChange += this.PropagateValueChanges;
                this._parent.BubbledChange += this.PropagateValueChanges;
            }
            ...
            public override void Add(IModelElement item)
            {
                ...
                IParameterSet parameterSetCasted = item.As<IParameterSet>();
                if ((parameterSetCasted != null))
                {
                    this._parent.ParameterSet.Add(parameterSetCasted);
                }
                if ((this._parent.LowerValue == null))
                {
                    IValueSpecification lowerValueCasted = item.As<IValueSpecification>();
            ...
            public override void Clear()
            {
                ...
                this._parent.ParameterSet.Clear();
                this._parent.LowerValue = null;
                this._parent.UpperValue = null;
            }
            ...
            public override bool Contains(IModelElement item)
            {
                ...
                if (this._parent.ParameterSet.Contains(item))
                {
                    return true;
                }
                if ((item == this._parent.LowerValue))
            ...
            public override void CopyTo(IModelElement[] array, int arrayIndex)
            {
                ...
                IEnumerator<IModelElement> parameterSetEnumerator = this._parent.ParameterSet.GetEnumerator();
                try
                {
                    for (
                    ; parameterSetEnumerator.MoveNext(); 
                    )
                    {
                        array[arrayIndex] = parameterSetEnumerator.Current;
                        arrayIndex = (arrayIndex + 1);
                    }
                }
                finally
                {
                    parameterSetEnumerator.Dispose();
                }
                if ((this._parent.LowerValue != null))
                {
                    array[arrayIndex] = this._parent.LowerValue;
            ...
            public override bool Remove(IModelElement item)
            {
                ...
                if (((parameterSetItem != null) 
                            && this._parent.ParameterSet.Remove(parameterSetItem)))
                {
                    return true;
                }
                if ((this._parent.LowerValue == item))
            ...
            public override IEnumerator<IModelElement> GetEnumerator()
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.DefaultValue).Concat(this._parent.Operation).Concat(this._parent.ParameterSet).Concat(this._parent.LowerValue).Concat(this._parent.UpperValue).GetEnumerator();
            }
        }
