...
namespace NMF.Interop.Uml
{
    ...
    /// </summary>
    public class PackagePackagedElementCollection : ICollectionExpression<IPackageableElement>, ICollection<IPackageableElement>, IListExpression<IPackageableElement>, IList<IPackageableElement>
    {
        ...
        /// </summary>
        public PackagePackagedElementCollection(IPackage parent)
        {
            this._parent = parent;
            parent.NestedPackage.AsNotifiable().CollectionChanged += this.HandleCollectionChange;
            parent.OwnedStereotype.AsNotifiable().CollectionChanged += this.HandleCollectionChange;
        ...
        public virtual int Count
        {
            get
            {
                ...
                count = (count + this._parent.OwnedStereotype.Count);
        ...
        public virtual IPackageableElement this[int index]
        {
            get
            {
                ...
                if ((this._parent.OwnedStereotype.Count 
                            <= (index - runningIndex)))
                {
                    return this._parent.OwnedStereotype[(index - runningIndex)];
                }
                else
                {
                    runningIndex = (runningIndex + this._parent.OwnedStereotype.Count);
                }
            ...
            set
            {
                ...
                if ((this._parent.OwnedStereotype.Count 
                            <= (index - runningIndex)))
                {
                    this._parent.OwnedStereotype[(index - runningIndex)] = ((IStereotype)(value));
                }
                else
                {
                    runningIndex = (runningIndex + this._parent.OwnedStereotype.Count);
                ...
                if ((this._parent.OwnedType.Count 
                            <= (index - runningIndex)))
                {
                    this._parent.OwnedType[(index - runningIndex)] = ((NMF.Interop.Uml.IType)(value));
                }
                else
                {
                    runningIndex = (runningIndex + this._parent.OwnedType.Count);
        ...
        public virtual void Add(IPackageableElement item)
        {
            ...
            IStereotype ownedStereotypeCasted = item.As<IStereotype>();
            if ((ownedStereotypeCasted != null))
            {
                this._parent.OwnedStereotype.Add(ownedStereotypeCasted);
            }
            NMF.Interop.Uml.IType ownedTypeCasted = item.As<NMF.Interop.Uml.IType>();
        ...
        public virtual void Clear()
        {
            ...
            this._parent.OwnedStereotype.Clear();
        ...
        public virtual bool Contains(IPackageableElement item)
        {
            ...
            if (this._parent.OwnedStereotype.Contains(item))
            {
                return true;
            }
        ...
        public virtual void CopyTo(IPackageableElement[] array, int arrayIndex)
        {
            ...
            IEnumerator<IPackageableElement> ownedStereotypeEnumerator = this._parent.OwnedStereotype.GetEnumerator();
            try
            {
                for (
                ; ownedStereotypeEnumerator.MoveNext(); 
                )
                {
                    array[arrayIndex] = ownedStereotypeEnumerator.Current;
                    arrayIndex = (arrayIndex + 1);
                }
            }
            finally
            {
                ownedStereotypeEnumerator.Dispose();
            }
        ...
        public virtual bool Remove(IPackageableElement item)
        {
            ...
            IStereotype stereotypeItem = item.As<IStereotype>();
            if (((stereotypeItem != null) 
                        && this._parent.OwnedStereotype.Remove(stereotypeItem)))
            {
                return true;
            }
        ...
        {
            return Enumerable.Empty<IPackageableElement>().Concat(this._parent.NestedPackage).Concat(this._parent.OwnedStereotype).Concat(this._parent.OwnedType).GetEnumerator();
        }
        ...
        public virtual int IndexOf(IPackageableElement item)
        {
            ...
            {
                index = this._parent.OwnedStereotype.IndexOf(stereotypeItem);
            }
            if ((index == -1))
            {
                runningIndex = (runningIndex + this._parent.OwnedStereotype.Count);
        ...
        public virtual void Insert(int index, IPackageableElement item)
        {
            ...
            if ((this._parent.OwnedStereotype.Count 
                        <= (index - runningIndex)))
            {
                this._parent.OwnedStereotype.Insert((index - runningIndex), ((IStereotype)(item)));
                return;
            }
            else
            {
            ...
            if ((this._parent.OwnedType.Count 
                        <= (index - runningIndex)))
            {
                this._parent.OwnedType.Insert((index - runningIndex), ((NMF.Interop.Uml.IType)(item)));
                return;
            }
            else
            {
        ...
        public virtual void RemoveAt(int index)
        {
            ...
            if ((this._parent.OwnedStereotype.Count 
                        <= (index - runningIndex)))
            {
                this._parent.OwnedStereotype.RemoveAt((index - runningIndex));
                return;
            }
            else
            {
