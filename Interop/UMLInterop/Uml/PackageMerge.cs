    ...
    public partial class PackageMerge : DirectedRelationship, IPackageMerge, IModelElement
    {
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((NMF.Models.Meta.IClass)(MetaRepository.Instance.Resolve("http://www.eclipse.org/uml2/5.0.0/UML#//PackageMerge")));
                }
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Uml.PackageMerge.ClassInstance)).Resolve("mergedPackage")));
        }
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(NMF.Interop.Uml.PackageMerge.ClassInstance)).Resolve("receivingPackage")));
        }
