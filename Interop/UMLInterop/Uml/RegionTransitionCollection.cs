...
namespace NMF.Interop.Uml
{
    ...
    /// </summary>
    public class RegionTransitionCollection : ObservableOppositeOrderedSet<IRegion, ITransition>
    {
        ...
        public RegionTransitionCollection(IRegion parent) : 
                base(parent)
        {
        }
        ...
        protected override void SetOpposite(ITransition item, IRegion newParent)
        {
            if ((newParent != null))
            {
                item.ParentChanged += this.OnItemParentChanged;
                item.Container = newParent;
            }
            else
            {
                item.ParentChanged -= this.OnItemParentChanged;
                if ((item.Container == this.Parent))
                {
                    item.Container = newParent;
                }
            }
