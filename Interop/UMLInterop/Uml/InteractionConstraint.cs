    ...
    public partial class InteractionConstraint : Constraint, IInteractionConstraint, IModelElement
    {
        ...
        public class InteractionConstraintChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            public override int Count
            {
                ...
                {
                    int count = 0;
                    if ((this._parent.Maxint != null))
                    {
                        count = (count + 1);
                    }
                    if ((this._parent.Minint != null))
                    {
                        count = (count + 1);
                    }
                    return count;
            ...
            public override void Add(IModelElement item)
            {
                if ((this._parent.Maxint == null))
                {
                    IValueSpecification maxintCasted = item.As<IValueSpecification>();
                    if ((maxintCasted != null))
                    {
                        this._parent.Maxint = maxintCasted;
                        return;
                    }
                }
                if ((this._parent.Minint == null))
                {
                    IValueSpecification minintCasted = item.As<IValueSpecification>();
                    if ((minintCasted != null))
                    {
                        this._parent.Minint = minintCasted;
                        return;
                    }
                }
            }
            ...
            {
                this._parent.Maxint = null;
                this._parent.Minint = null;
            }
            ...
            {
                if ((item == this._parent.Maxint))
                {
                    return true;
                }
                if ((item == this._parent.Minint))
                {
                    return true;
                }
                return false;
            ...
            public override void CopyTo(IModelElement[] array, int arrayIndex)
            {
                if ((this._parent.Maxint != null))
                {
                    array[arrayIndex] = this._parent.Maxint;
                    arrayIndex = (arrayIndex + 1);
                }
                if ((this._parent.Minint != null))
                {
                    array[arrayIndex] = this._parent.Minint;
                    arrayIndex = (arrayIndex + 1);
                }
            }
            ...
            {
                if ((this._parent.Maxint == item))
                {
                    this._parent.Maxint = null;
                    return true;
                }
                if ((this._parent.Minint == item))
                {
                    this._parent.Minint = null;
                    return true;
                }
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.Maxint).Concat(this._parent.Minint).GetEnumerator();
            }
        }
