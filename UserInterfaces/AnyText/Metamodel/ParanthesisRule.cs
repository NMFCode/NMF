...
namespace NMF.AnyText.Metamodel
{
    ...
    public partial class ParanthesisRule : ClassRule, IParanthesisRule, IModelElement
    {
        ...
        {
            return ((ITypedElement)(((ModelElement)(NMF.AnyText.Metamodel.ParanthesisRule.ClassInstance)).Resolve("Expression")));
        }
        ...
        /// </summary>
        private sealed class ExpressionProxy : ModelPropertyChange<IParanthesisRule, IParserExpression>
        {
            ...
            public ExpressionProxy(IParanthesisRule modelElement) : 
