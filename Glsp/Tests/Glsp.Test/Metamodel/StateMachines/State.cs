...
namespace NMF.GlspTest.FiniteStateMachines
{
    ...
    public partial class State : ModelElement, IState, IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> IsFinalStateChanged;
        
        /// <summary>
        /// Gets fired before the IsFinalState property changes its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> IsFinalStateChanging;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.IsFinalStateChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.IsFinalStateChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        public class StateChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.Outgoing.AsNotifiable()};
            }
        ...
        public class StateReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.Outgoing.AsNotifiable(),
                        this._parent.Incoming.AsNotifiable()};
            }
