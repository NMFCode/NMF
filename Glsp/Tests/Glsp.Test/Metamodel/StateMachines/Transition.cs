...
namespace NMF.GlspTest.FiniteStateMachines
{
    ...
    public partial class Transition : ModelElement, ITransition, IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> TriggerChanged;
        
        /// <summary>
        /// Gets fired before the Trigger property changes its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> TriggerChanging;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.TriggerChanged;
            if ((handler != null))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.TriggerChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.TargetChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
