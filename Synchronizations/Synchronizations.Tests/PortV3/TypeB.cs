...
namespace PortV3Namespace.TypeB
{
    ...
    public class BlockB : ModelElement, IBlockB, IModelElement
    {
        ...
        private void InputPortsCollectionChanging(object sender, System.Collections.Specialized.NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void OutputPortsCollectionChanging(object sender, System.Collections.Specialized.NotifyCollectionChangedEventArgs e)
        {
