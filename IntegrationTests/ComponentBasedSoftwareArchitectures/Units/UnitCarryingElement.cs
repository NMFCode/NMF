...
namespace NMFExamples.Units
{
    ...
    public abstract partial class UnitCarryingElement : ModelElement, IUnitCarryingElement, IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> UnitSpecificationChanging;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.UnitSpecificationChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        protected override NMF.Expressions.INotifyExpression<object> GetExpressionForAttribute(string attribute)
        {
            if ((attribute == "UNITSPECIFICATION"))
            {
                return new UnitSpecificationProxy(this);
            }
