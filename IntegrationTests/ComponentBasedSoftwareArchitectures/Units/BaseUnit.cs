...
namespace NMFExamples.Units
{
    ...
    /// <summary>
    /// The default implementation of the BaseUnit class
    /// </summary>
    ...
    public partial class BaseUnit : ModelElement, IBaseUnit, IModelElement
    {
        ...
        {
            return ((ITypedElement)(((ModelElement)(NMFExamples.Units.BaseUnit.ClassInstance)).Resolve("name")));
        }
        ...
        /// </summary>
        private sealed class NameProxy : ModelPropertyChange<IBaseUnit, string>
        {
