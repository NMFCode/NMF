...
namespace NMFExamples.MM06
{
    ...
    public abstract partial class NamedElement : ModelElement, NMFExamples.MM06.INamedElement, IModelElement
    {
        ...
        {
            return ((ITypedElement)(((ModelElement)(NMFExamples.MM06.NamedElement.ClassInstance)).Resolve("name")));
        }
        ...
        /// </summary>
        private sealed class NameProxy : ModelPropertyChange<NMFExamples.MM06.INamedElement, string>
        {
            ...
            public NameProxy(NMFExamples.MM06.INamedElement modelElement) : 
