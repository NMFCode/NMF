...
namespace NMFExamples.MM06.Deployment
{
    ...
    public partial class Container_MM06 : NMFExamples.MM06.NamedElement, IContainer_MM06, IModelElement
    {
        ...
        {
            return ((ITypedElement)(((ModelElement)(NMFExamples.MM06.Deployment.Container_MM06.ClassInstance)).Resolve("Links")));
        }
        ...
        private void LinksCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        {
            return ((ITypedElement)(((ModelElement)(NMFExamples.MM06.Deployment.Container_MM06.ClassInstance)).Resolve("Environment")));
        }
        ...
        {
            throw new NotSupportedException("Container_MM06 does not have an absolute URI and therefore cannot be resolved.");
        }
        ...
        public class Container_MM06ReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.Links.AsNotifiable(),
