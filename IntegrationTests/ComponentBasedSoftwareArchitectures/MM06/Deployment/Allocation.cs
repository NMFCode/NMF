...
namespace NMFExamples.MM06.Deployment
{
    ...
    public partial class Allocation : ModelElement, NMFExamples.MM06.Deployment.IAllocation, IModelElement
    {
        ...
        [ConstantAttribute()]
        public IOrderedSetExpression<IAllocationContext> Contexts
        {
            get
            {
        ...
        public ISystem_MM06 AllocatedSystem
        {
            get
            {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> AllocatedSystemChanging;
        
        /// <summary>
        /// Gets fired when the AllocatedSystem property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> AllocatedSystemChanged;
        
        private static ITypedElement RetrieveContextsReference()
        {
            return ((ITypedElement)(((ModelElement)(NMFExamples.MM06.Deployment.Allocation.ClassInstance)).Resolve("Contexts")));
        }
        ...
        private void ContextsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void ContextsCollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        {
            return ((ITypedElement)(((ModelElement)(NMFExamples.MM06.Deployment.Allocation.ClassInstance)).Resolve("AllocatedSystem")));
        }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.AllocatedSystemChanging;
            if ((handler != null))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.AllocatedSystemChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private void OnResetAllocatedSystem(object sender, EventArgs eventArgs)
        {
            if ((sender == this.AllocatedSystem))
            {
        ...
        public class AllocationChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.Contexts.AsNotifiable()};
            }
        ...
        public class AllocationReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.Contexts.AsNotifiable(),
                        new AllocatedSystemProxy(this._parent)};
            }
        ...
        /// </summary>
        private sealed class AllocatedSystemProxy : ModelPropertyChange<NMFExamples.MM06.Deployment.IAllocation, ISystem_MM06>
        {
            ...
            public AllocatedSystemProxy(NMFExamples.MM06.Deployment.IAllocation modelElement) : 
