...
namespace NMFExamples.MM06.Deployment
{
    ...
    public partial class Link : NMFExamples.MM06.NamedElement, ILink, IModelElement
    {
        ...
        [ConstantAttribute()]
        public IOrderedSetExpression<IContainer_MM06> ConnectedContainers
        {
            get
            {
        ...
        {
            return ((ITypedElement)(((ModelElement)(NMFExamples.MM06.Deployment.Link.ClassInstance)).Resolve("ConnectedContainers")));
        }
        ...
        private void ConnectedContainersCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        {
            if ((reference == "CONNECTEDCONTAINERS"))
            {
                if ((index < this.ConnectedContainers.Count))
                {
                    return this.ConnectedContainers[index];
                }
                else
                {
                    return null;
        ...
        {
            throw new NotSupportedException("Link does not have an absolute URI and therefore cannot be resolved.");
        }
        ...
        public class LinkReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.ConnectedContainers.AsNotifiable()};
            }
