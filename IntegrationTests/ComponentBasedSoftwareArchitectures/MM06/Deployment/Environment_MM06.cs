...
namespace NMFExamples.MM06.Deployment
{
    ...
    public partial class Environment_MM06 : ModelElement, IEnvironment_MM06, IModelElement
    {
        ...
        [ConstantAttribute()]
        public IOrderedSetExpression<IContainer_MM06> Containers
        {
            get
            {
        ...
        {
            return ((ITypedElement)(((ModelElement)(NMFExamples.MM06.Deployment.Environment_MM06.ClassInstance)).Resolve("Containers")));
        }
        ...
        private void ContainersCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        {
            return ((ITypedElement)(((ModelElement)(NMFExamples.MM06.Deployment.Environment_MM06.ClassInstance)).Resolve("Links")));
        }
        ...
        {
            throw new NotSupportedException("Environment_MM06 does not have an absolute URI and therefore cannot be resolved.");
        }
        ...
        public class Environment_MM06ChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.Containers.AsNotifiable(),
