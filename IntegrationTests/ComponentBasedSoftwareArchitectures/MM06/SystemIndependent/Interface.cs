...
namespace NMFExamples.MM06.SystemIndependent
{
    ...
    public partial class Interface : NMFExamples.MM06.NamedElement, NMFExamples.MM06.SystemIndependent.IInterface, IModelElement
    {
        ...
        {
            return ((ITypedElement)(((ModelElement)(NMFExamples.MM06.SystemIndependent.Interface.ClassInstance)).Resolve("Signatures")));
        }
        ...
        private void SignaturesCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        {
            if ((reference == "SIGNATURES"))
            {
                if ((index < this.Signatures.Count))
                {
        ...
        public class InterfaceReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.Signatures.AsNotifiable()};
            }
