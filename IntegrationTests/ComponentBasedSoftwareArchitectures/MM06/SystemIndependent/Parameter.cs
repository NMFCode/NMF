...
namespace NMFExamples.MM06.SystemIndependent
{
    ...
    public partial class Parameter : NMFExamples.MM06.NamedElement, NMFExamples.MM06.SystemIndependent.IParameter, IModelElement
    {
        ...
        {
            return ((ITypedElement)(((ModelElement)(NMFExamples.MM06.SystemIndependent.Parameter.ClassInstance)).Resolve("Type")));
        }
        ...
        /// </summary>
        private sealed class TypeProxy : ModelPropertyChange<NMFExamples.MM06.SystemIndependent.IParameter, Type>
        {
            ...
            public TypeProxy(NMFExamples.MM06.SystemIndependent.IParameter modelElement) : 
