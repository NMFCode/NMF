...
namespace NMFExamples.MM06.SystemIndependent
{
    ...
    public partial class Signature : NMFExamples.MM06.NamedElement, ISignature, IModelElement
    {
        ...
        /// </summary>
        [DebuggerBrowsableAttribute(DebuggerBrowsableState.Never)]
        private ObservableCompositionOrderedSet<NMFExamples.MM06.SystemIndependent.IParameter> _parameter;
        ...
        public Signature()
        {
            this._parameter = new ObservableCompositionOrderedSet<NMFExamples.MM06.SystemIndependent.IParameter>(this);
        ...
        [ConstantAttribute()]
        public IOrderedSetExpression<NMFExamples.MM06.SystemIndependent.IParameter> Parameter
        {
            get
            {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ReturnTypeChanged;
        
        /// <summary>
        /// Gets fired before the ReturnType property changes its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ReturnTypeChanging;
        
        private static ITypedElement RetrieveReturnTypeAttribute()
        {
            return ((ITypedElement)(((ModelElement)(NMFExamples.MM06.SystemIndependent.Signature.ClassInstance)).Resolve("ReturnType")));
        }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ReturnTypeChanged;
            if ((handler != null))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ReturnTypeChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            return ((ITypedElement)(((ModelElement)(NMFExamples.MM06.SystemIndependent.Signature.ClassInstance)).Resolve("Parameter")));
        }
        ...
        protected override NMF.Expressions.INotifyExpression<object> GetExpressionForAttribute(string attribute)
        {
            if ((attribute == "RETURNTYPE"))
            {
                return Observable.Box(new ReturnTypeProxy(this));
            }
        ...
        public class SignatureChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.Parameter.AsNotifiable()};
            }
            ...
            {
                NMFExamples.MM06.SystemIndependent.IParameter parameterCasted = item.As<NMFExamples.MM06.SystemIndependent.IParameter>();
            ...
            {
                NMFExamples.MM06.SystemIndependent.IParameter parameterItem = item.As<NMFExamples.MM06.SystemIndependent.IParameter>();
