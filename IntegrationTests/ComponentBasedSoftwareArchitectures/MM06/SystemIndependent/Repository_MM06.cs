...
namespace NMFExamples.MM06.SystemIndependent
{
    ...
    public partial class Repository_MM06 : ModelElement, IRepository_MM06, IModelElement
    {
        ...
        private ObservableCompositionOrderedSet<NMFExamples.MM06.SystemIndependent.IInterface> _interfaces;
        ...
        {
            this._interfaces = new ObservableCompositionOrderedSet<NMFExamples.MM06.SystemIndependent.IInterface>(this);
        ...
        [ConstantAttribute()]
        public IOrderedSetExpression<NMFExamples.MM06.SystemIndependent.IInterface> Interfaces
        {
            get
            {
        ...
        [ContainmentAttribute()]
        [ConstantAttribute()]
        public IOrderedSetExpression<IComponent_MM06> Components
        {
            get
            {
        ...
        {
            return ((ITypedElement)(((ModelElement)(NMFExamples.MM06.SystemIndependent.Repository_MM06.ClassInstance)).Resolve("Interfaces")));
        }
        ...
        private void InterfacesCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        {
            return ((ITypedElement)(((ModelElement)(NMFExamples.MM06.SystemIndependent.Repository_MM06.ClassInstance)).Resolve("Components")));
        }
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void ComponentsCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        {
            return ((ITypedElement)(((ModelElement)(NMFExamples.MM06.SystemIndependent.Repository_MM06.ClassInstance)).Resolve("AvailableSignatures")));
        }
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void AvailableSignaturesCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        {
            throw new NotSupportedException("Repository_MM06 does not have an absolute URI and therefore cannot be resolved.");
        }
        ...
        public class Repository_MM06ChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.Interfaces.AsNotifiable(),
                        this._parent.Components.AsNotifiable(),
                        this._parent.AvailableSignatures.AsNotifiable()};
            }
            ...
            {
                NMFExamples.MM06.SystemIndependent.IInterface interfacesCasted = item.As<NMFExamples.MM06.SystemIndependent.IInterface>();
