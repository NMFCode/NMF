...
namespace NMFExamples.MM06.SystemIndependent
{
    ...
    public partial class Component_MM06 : NMFExamples.MM06.NamedElement, IComponent_MM06, IModelElement
    {
        ...
        /// </summary>
        [DebuggerBrowsableAttribute(DebuggerBrowsableState.Never)]
        private ObservableAssociationOrderedSet<NMFExamples.MM06.SystemIndependent.IInterface> _providedInterfaces;
        ...
        /// </summary>
        [DebuggerBrowsableAttribute(DebuggerBrowsableState.Never)]
        private ObservableAssociationOrderedSet<NMFExamples.MM06.SystemIndependent.IInterface> _requiredInterfaces;
        ...
        public Component_MM06()
        {
            ...
            this._providedInterfaces = new ObservableAssociationOrderedSet<NMFExamples.MM06.SystemIndependent.IInterface>();
            ...
            this._requiredInterfaces = new ObservableAssociationOrderedSet<NMFExamples.MM06.SystemIndependent.IInterface>();
        ...
        [ConstantAttribute()]
        public IOrderedSetExpression<NMFExamples.MM06.SystemIndependent.IInterface> ProvidedInterfaces
        {
            get
            {
        ...
        [XmlAttributeAttribute(true)]
        [ConstantAttribute()]
        public IOrderedSetExpression<NMFExamples.MM06.SystemIndependent.IInterface> RequiredInterfaces
        {
            get
            {
        ...
        {
            return ((ITypedElement)(((ModelElement)(NMFExamples.MM06.SystemIndependent.Component_MM06.ClassInstance)).Resolve("Services")));
        }
        ...
        private void ServicesCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        {
            return ((ITypedElement)(((ModelElement)(NMFExamples.MM06.SystemIndependent.Component_MM06.ClassInstance)).Resolve("ProvidedInterfaces")));
        }
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void ProvidedInterfacesCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        {
            return ((ITypedElement)(((ModelElement)(NMFExamples.MM06.SystemIndependent.Component_MM06.ClassInstance)).Resolve("RequiredInterfaces")));
        }
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void RequiredInterfacesCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        protected override IModelElement GetModelElementForReference(string reference, int index)
        {
            ...
            if ((reference == "PROVIDEDINTERFACES"))
            {
                if ((index < this.ProvidedInterfaces.Count))
                {
                    return this.ProvidedInterfaces[index];
                }
                else
                {
                    return null;
            ...
            if ((reference == "REQUIREDINTERFACES"))
            {
                if ((index < this.RequiredInterfaces.Count))
                {
                    return this.RequiredInterfaces[index];
                }
                else
                {
                    return null;
        ...
        {
            throw new NotSupportedException("Component_MM06 does not have an absolute URI and therefore cannot be resolved.");
        }
        ...
        public class Component_MM06ChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.Services.AsNotifiable()};
            }
        ...
        public class Component_MM06ReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.Services.AsNotifiable(),
                        this._parent.ProvidedInterfaces.AsNotifiable(),
                        this._parent.RequiredInterfaces.AsNotifiable()};
            }
            ...
            public override void Add(IModelElement item)
            {
                ...
                NMFExamples.MM06.SystemIndependent.IInterface providedInterfacesCasted = item.As<NMFExamples.MM06.SystemIndependent.IInterface>();
                if ((providedInterfacesCasted != null))
                {
                    this._parent.ProvidedInterfaces.Add(providedInterfacesCasted);
                }
                NMFExamples.MM06.SystemIndependent.IInterface requiredInterfacesCasted = item.As<NMFExamples.MM06.SystemIndependent.IInterface>();
            ...
            public override bool Remove(IModelElement item)
            {
                ...
                NMFExamples.MM06.SystemIndependent.IInterface interfaceItem = item.As<NMFExamples.MM06.SystemIndependent.IInterface>();
