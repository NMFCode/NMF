...
namespace NMFExamples.Pcm.Seff
{
    ...
    public partial class InternalCallAction : CallAction, IInternalCallAction, IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> CalledResourceDemandingInternalBehaviourChanging;
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> Predecessor_AbstractActionChanging;
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> Successor_AbstractActionChanging;
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ResourceDemandingBehaviour_AbstractActionChanging;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.CalledResourceDemandingInternalBehaviourChanging;
            if ((handler != null))
            {
        ...
        {
            if ((sender == this.CalledResourceDemandingInternalBehaviour))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.Predecessor_AbstractActionChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            if ((sender == this.Predecessor_AbstractAction))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.Successor_AbstractActionChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            if ((sender == this.Successor_AbstractAction))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ResourceDemandingBehaviour_AbstractActionChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        protected override IModelElement GetModelElementForReference(string reference, int index)
        {
            ...
            {
                return this.ResourceDemandingBehaviour_AbstractAction;
            }
        ...
        public class InternalCallActionChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.ResourceDemand_Action.AsNotifiable(),
                        this._parent.InfrastructureCall__Action.AsNotifiable(),
                        this._parent.ResourceCall__Action.AsNotifiable()};
            }
        ...
        public class InternalCallActionReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            {
                return new INotifiable[] {
                        new CalledResourceDemandingInternalBehaviourProxy(this._parent),
                        this._parent.ResourceDemand_Action.AsNotifiable(),
                        this._parent.InfrastructureCall__Action.AsNotifiable(),
                        this._parent.ResourceCall__Action.AsNotifiable(),
                        new Predecessor_AbstractActionProxy(this._parent),
                        new Successor_AbstractActionProxy(this._parent),
                        new ResourceDemandingBehaviour_AbstractActionProxy(this._parent)};
            }
