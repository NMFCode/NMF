...
namespace NMFExamples.Pcm.Seff
{
    ...
    public partial class EmitEventAction : AbstractAction, IEmitEventAction, IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> EventType__EmitEventActionChanging;
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> SourceRole__EmitEventActionChanging;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.EventType__EmitEventActionChanging;
            if ((handler != null))
            {
        ...
        {
            if ((sender == this.EventType__EmitEventAction))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.SourceRole__EmitEventActionChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            if ((sender == this.SourceRole__EmitEventAction))
            {
        ...
        {
            throw new NotSupportedException("EmitEventAction does not have an absolute URI and therefore cannot be resolved.");
        }
        ...
        public class EmitEventActionReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            {
                return new INotifiable[] {
                        new EventType__EmitEventActionProxy(this._parent),
                        new SourceRole__EmitEventActionProxy(this._parent),
                        this._parent.InputVariableUsages__CallAction.AsNotifiable()};
            }
