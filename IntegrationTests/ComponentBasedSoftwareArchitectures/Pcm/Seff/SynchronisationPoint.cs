...
namespace NMFExamples.Pcm.Seff
{
    ...
    public partial class SynchronisationPoint : ModelElement, ISynchronisationPoint, IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ForkAction_SynchronisationPointChanging;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ForkAction_SynchronisationPointChanging;
            if ((handler != null))
            {
        ...
        protected override IModelElement GetModelElementForReference(string reference, int index)
        {
            ...
            {
                return this.ForkAction_SynchronisationPoint;
            }
        ...
        {
            throw new NotSupportedException(("SynchronisationPoint does not have an absolute URI and therefore cannot be resolv" +
                    "ed."));
        }
        ...
        public class SynchronisationPointChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.OutputParameterUsage_SynchronisationPoint.AsNotifiable(),
                        this._parent.SynchronousForkedBehaviours_SynchronisationPoint.AsNotifiable()};
            }
        ...
        public class SynchronisationPointReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.OutputParameterUsage_SynchronisationPoint.AsNotifiable(),
                        new ForkAction_SynchronisationPointProxy(this._parent),
                        this._parent.SynchronousForkedBehaviours_SynchronisationPoint.AsNotifiable()};
            }
