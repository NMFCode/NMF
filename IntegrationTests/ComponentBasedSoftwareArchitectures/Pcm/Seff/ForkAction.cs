...
namespace NMFExamples.Pcm.Seff
{
    ...
    public partial class ForkAction : AbstractInternalControlFlowAction, IForkAction, IModelElement
    {
            ...
            set
            {
                if ((this._synchronisingBehaviours_ForkAction != value))
                {
                    ...
                    if ((old != null))
                    {
                        ...
                        old.ParentChanged -= this.OnResetSynchronisingBehaviours_ForkAction;
                    }
                    if ((value != null))
                    {
                        value.ForkAction_SynchronisationPoint = this;
                        value.Parent = this;
                        value.ParentChanged += this.OnResetSynchronisingBehaviours_ForkAction;
                    }
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> SynchronisingBehaviours_ForkActionChanging;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.SynchronisingBehaviours_ForkActionChanging;
            if ((handler != null))
            {
        ...
        {
            if ((sender == this.SynchronisingBehaviours_ForkAction))
            {
        ...
        public class ForkActionChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.AsynchronousForkedBehaviours_ForkAction.AsNotifiable(),
                        new SynchronisingBehaviours_ForkActionProxy(this._parent)};
            }
