...
namespace NMFExamples.Pcm.Seff
{
    ...
    /// <summary>
    /// Denotes a class to implement the outputParameterUsage_SynchronisationPoint reference
    /// </summary>
    public class SynchronisationPointOutputParameterUsage_SynchronisationPointCollection : ObservableOppositeList<ISynchronisationPoint, IVariableUsage>
    {
        ...
        protected override void SetOpposite(IVariableUsage item, ISynchronisationPoint newParent)
        {
            if ((newParent != null))
            {
                item.ParentChanged += this.OnItemParentChanged;
                item.SynchronisationPoint_VariableUsage = newParent;
            }
            else
            {
                item.ParentChanged -= this.OnItemParentChanged;
