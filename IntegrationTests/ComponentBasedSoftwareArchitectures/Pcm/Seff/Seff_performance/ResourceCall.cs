...
namespace NMFExamples.Pcm.Seff.Seff_performance
{
    ...
    public partial class ResourceCall : CallAction, IResourceCall, IModelElement
    {
        ...
        private static Lazy<IOperation> _resourceSignatureBelongsToResourceRequiredRoleOperation = new Lazy<IOperation>(RetrieveResourceSignatureBelongsToResourceRequiredRoleOperation);
            ...
            set
            {
                if ((this._numberOfCalls__ResourceCall != value))
                {
                    ...
                    if ((old != null))
                    {
                        ...
                        old.ParentChanged -= this.OnResetNumberOfCalls__ResourceCall;
                    }
                    if ((value != null))
                    {
                        value.ResourceCall__PCMRandomVariable = this;
                        value.Parent = this;
                        value.ParentChanged += this.OnResetNumberOfCalls__ResourceCall;
                    }
        ...
        /// </summary>
        public event EventHandler<OperationCallEventArgs> ResourceSignatureBelongsToResourceRequiredRoleCalling;
        
        /// <summary>
        /// Gets fired after the operation ResourceSignatureBelongsToResourceRequiredRole got called
        /// </summary>
        public event EventHandler<OperationCallEventArgs> ResourceSignatureBelongsToResourceRequiredRoleCalled;
        
        /// <summary>
        /// Gets fired before the Action__ResourceCall property changes its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> Action__ResourceCallChanging;
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ResourceRequiredRole__ResourceCallChanging;
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> Signature__ResourceCallChanging;
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> NumberOfCalls__ResourceCallChanging;
        ...
        public bool ResourceSignatureBelongsToResourceRequiredRole(object diagnostics, object context)
        {
            Func<IResourceCall, object, object, bool> handler = OperationBroker.Instance.GetRegisteredDelegate<Func<IResourceCall, object, object, bool>>(_resourceSignatureBelongsToResourceRequiredRoleOperation);
            if ((handler != null))
            {
            }
            else
            {
                throw new InvalidOperationException(("There is no implementation for method ResourceSignatureBelongsToResourceRequiredR" +
                        "ole registered. Use the method broker to register a method implementation."));
            }
            OperationCallEventArgs e = new OperationCallEventArgs(this, _resourceSignatureBelongsToResourceRequiredRoleOperation.Value, diagnostics, context);
            this.OnResourceSignatureBelongsToResourceRequiredRoleCalling(e);
            this.OnBubbledChange(BubbledChangeEventArgs.OperationCalling(this, _resourceSignatureBelongsToResourceRequiredRoleOperation.Value, e));
            bool result = handler.Invoke(this, diagnostics, context);
            e.Result = result;
            this.OnResourceSignatureBelongsToResourceRequiredRoleCalled(e);
            this.OnBubbledChange(BubbledChangeEventArgs.OperationCalled(this, _resourceSignatureBelongsToResourceRequiredRoleOperation.Value, e));
            return result;
        }
        
        private static IOperation RetrieveResourceSignatureBelongsToResourceRequiredRoleOperation()
        {
            return ClassInstance.LookupOperation("ResourceSignatureBelongsToResourceRequiredRole");
        }
        
        /// <summary>
        /// Raises the ResourceSignatureBelongsToResourceRequiredRoleCalling event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnResourceSignatureBelongsToResourceRequiredRoleCalling(OperationCallEventArgs eventArgs)
        {
            EventHandler<OperationCallEventArgs> handler = this.ResourceSignatureBelongsToResourceRequiredRoleCalling;
            if ((handler != null))
            {
        ...
        /// <summary>
        /// Raises the ResourceSignatureBelongsToResourceRequiredRoleCalled event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnResourceSignatureBelongsToResourceRequiredRoleCalled(OperationCallEventArgs eventArgs)
        {
            EventHandler<OperationCallEventArgs> handler = this.ResourceSignatureBelongsToResourceRequiredRoleCalled;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.Action__ResourceCallChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ResourceRequiredRole__ResourceCallChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            if ((sender == this.ResourceRequiredRole__ResourceCall))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.Signature__ResourceCallChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            if ((sender == this.Signature__ResourceCall))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.NumberOfCalls__ResourceCallChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            if ((sender == this.NumberOfCalls__ResourceCall))
            {
        ...
        protected override IModelElement GetModelElementForReference(string reference, int index)
        {
            ...
            {
                return this.Action__ResourceCall;
            }
        ...
        public class ResourceCallChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new NumberOfCalls__ResourceCallProxy(this._parent)};
            }
        ...
        public class ResourceCallReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            {
                return new INotifiable[] {
                        new Action__ResourceCallProxy(this._parent),
                        new ResourceRequiredRole__ResourceCallProxy(this._parent),
                        new Signature__ResourceCallProxy(this._parent),
                        new NumberOfCalls__ResourceCallProxy(this._parent)};
            }
