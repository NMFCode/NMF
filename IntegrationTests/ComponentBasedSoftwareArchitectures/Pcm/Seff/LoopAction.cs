...
namespace NMFExamples.Pcm.Seff
{
    ...
    public partial class LoopAction : AbstractLoopAction, ILoopAction, IModelElement
    {
            ...
            set
            {
                if ((this._iterationCount_LoopAction != value))
                {
                    ...
                    if ((old != null))
                    {
                        ...
                        old.ParentChanged -= this.OnResetIterationCount_LoopAction;
                    }
                    if ((value != null))
                    {
                        value.LoopAction_PCMRandomVariable = this;
                        value.Parent = this;
                        value.ParentChanged += this.OnResetIterationCount_LoopAction;
                    }
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> IterationCount_LoopActionChanging;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.IterationCount_LoopActionChanging;
            if ((handler != null))
            {
        ...
        {
            if ((sender == this.IterationCount_LoopAction))
            {
        ...
        public class LoopActionChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new IterationCount_LoopActionProxy(this._parent)};
            }
