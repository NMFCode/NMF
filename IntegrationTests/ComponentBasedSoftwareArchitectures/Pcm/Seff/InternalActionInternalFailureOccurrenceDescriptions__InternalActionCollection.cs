...
namespace NMFExamples.Pcm.Seff
{
    ...
    /// <summary>
    /// Denotes a class to implement the internalFailureOccurrenceDescriptions__InternalAction reference
    /// </summary>
    public class InternalActionInternalFailureOccurrenceDescriptions__InternalActionCollection : ObservableOppositeList<IInternalAction, IInternalFailureOccurrenceDescription>
    {
        ...
        /// </summary>
        /// <param name="parent">the parent InternalAction</param>
        ...
        protected override void SetOpposite(IInternalFailureOccurrenceDescription item, IInternalAction newParent)
        {
            if ((newParent != null))
            {
                item.ParentChanged += this.OnItemParentChanged;
                item.InternalAction__InternalFailureOccurrenceDescription = newParent;
            }
            else
            {
                item.ParentChanged -= this.OnItemParentChanged;
