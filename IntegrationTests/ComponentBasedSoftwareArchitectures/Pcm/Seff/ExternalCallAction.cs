...
namespace NMFExamples.Pcm.Seff
{
    ...
    public partial class ExternalCallAction : AbstractAction, IExternalCallAction, IModelElement
    {
        ...
        private static Lazy<IOperation> _signatureBelongsToRoleOperation = new Lazy<IOperation>(RetrieveSignatureBelongsToRoleOperation);
        ...
        /// </summary>
        public event EventHandler<OperationCallEventArgs> SignatureBelongsToRoleCalling;
        
        /// <summary>
        /// Gets fired after the operation SignatureBelongsToRole got called
        /// </summary>
        public event EventHandler<OperationCallEventArgs> SignatureBelongsToRoleCalled;
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> RetryCountChanging;
        
        /// <summary>
        /// Gets fired before the CalledService_ExternalService property changes its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> CalledService_ExternalServiceChanging;
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> Role_ExternalServiceChanging;
        ...
        public bool SignatureBelongsToRole(object diagnostics, object context)
        {
            Func<IExternalCallAction, object, object, bool> handler = OperationBroker.Instance.GetRegisteredDelegate<Func<IExternalCallAction, object, object, bool>>(_signatureBelongsToRoleOperation);
            if ((handler != null))
            {
            }
            else
            {
                throw new InvalidOperationException(("There is no implementation for method SignatureBelongsToRole registered. Use the " +
                        "method broker to register a method implementation."));
            }
            OperationCallEventArgs e = new OperationCallEventArgs(this, _signatureBelongsToRoleOperation.Value, diagnostics, context);
            this.OnSignatureBelongsToRoleCalling(e);
            this.OnBubbledChange(BubbledChangeEventArgs.OperationCalling(this, _signatureBelongsToRoleOperation.Value, e));
            bool result = handler.Invoke(this, diagnostics, context);
            e.Result = result;
            this.OnSignatureBelongsToRoleCalled(e);
            this.OnBubbledChange(BubbledChangeEventArgs.OperationCalled(this, _signatureBelongsToRoleOperation.Value, e));
            return result;
        }
        
        private static IOperation RetrieveSignatureBelongsToRoleOperation()
        {
            return ClassInstance.LookupOperation("SignatureBelongsToRole");
        }
        
        /// <summary>
        /// Raises the SignatureBelongsToRoleCalling event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnSignatureBelongsToRoleCalling(OperationCallEventArgs eventArgs)
        {
            EventHandler<OperationCallEventArgs> handler = this.SignatureBelongsToRoleCalling;
            if ((handler != null))
            {
        ...
        /// <summary>
        /// Raises the SignatureBelongsToRoleCalled event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnSignatureBelongsToRoleCalled(OperationCallEventArgs eventArgs)
        {
            EventHandler<OperationCallEventArgs> handler = this.SignatureBelongsToRoleCalled;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.RetryCountChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.CalledService_ExternalServiceChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            if ((sender == this.CalledService_ExternalService))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.Role_ExternalServiceChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            if ((sender == this.Role_ExternalService))
            {
        ...
        protected override NMF.Expressions.INotifyExpression<object> GetExpressionForAttribute(string attribute)
        {
            if ((attribute == "RETRYCOUNT"))
            {
                return Observable.Box(new RetryCountProxy(this));
            }
        ...
        public class ExternalCallActionChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.ReturnVariableUsage__CallReturnAction.AsNotifiable(),
                        this._parent.InputVariableUsages__CallAction.AsNotifiable()};
            }
        ...
        public class ExternalCallActionReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            {
                return new INotifiable[] {
                        new CalledService_ExternalServiceProxy(this._parent),
                        new Role_ExternalServiceProxy(this._parent),
                        this._parent.ReturnVariableUsage__CallReturnAction.AsNotifiable(),
                        this._parent.InputVariableUsages__CallAction.AsNotifiable(),
                        this._parent.FailureTypes_FailureHandlingEntity.AsNotifiable()};
            }
