...
namespace NMFExamples.Pcm.Seff
{
    ...
    public partial class ResourceDemandingInternalBehaviour : ResourceDemandingBehaviour, IResourceDemandingInternalBehaviour, IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ResourceDemandingSEFF_ResourceDemandingInternalBehaviourChanging;
        
        /// <summary>
        /// Gets fired when the ResourceDemandingSEFF_ResourceDemandingInternalBehaviour property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ResourceDemandingSEFF_ResourceDemandingInternalBehaviourChanged;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ResourceDemandingSEFF_ResourceDemandingInternalBehaviourChanging;
            if ((handler != null))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ResourceDemandingSEFF_ResourceDemandingInternalBehaviourChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        protected override IModelElement GetModelElementForReference(string reference, int index)
        {
            ...
            {
                return this.ResourceDemandingSEFF_ResourceDemandingInternalBehaviour;
            }
        ...
        {
            throw new NotSupportedException(("ResourceDemandingInternalBehaviour does not have an absolute URI and therefore ca" +
                    "nnot be resolved."));
        }
        ...
        public class ResourceDemandingInternalBehaviourReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new ResourceDemandingSEFF_ResourceDemandingInternalBehaviourProxy(this._parent)};
            }
