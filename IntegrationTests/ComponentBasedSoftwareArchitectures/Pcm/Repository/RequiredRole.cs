...
namespace NMFExamples.Pcm.Repository
{
    ...
    public abstract partial class RequiredRole : Role, IRequiredRole, IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> RequiringEntity_RequiredRoleChanging;
        
        /// <summary>
        /// Gets fired when the RequiringEntity_RequiredRole property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> RequiringEntity_RequiredRoleChanged;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.RequiringEntity_RequiredRoleChanging;
            if ((handler != null))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.RequiringEntity_RequiredRoleChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        protected override IModelElement GetModelElementForReference(string reference, int index)
        {
            ...
            {
                return this.RequiringEntity_RequiredRole;
            }
        ...
        {
            throw new NotSupportedException("RequiredRole does not have an absolute URI and therefore cannot be resolved.");
        }
        ...
        public class RequiredRoleReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new RequiringEntity_RequiredRoleProxy(this._parent)};
            }
