...
namespace NMFExamples.Pcm.Repository
{
    ...
    public partial class EventType : Signature, IEventType, IModelElement
    {
        ...
        private NMFExamples.Pcm.Repository.IParameter _parameter__EventType;
        ...
        public NMFExamples.Pcm.Repository.IParameter Parameter__EventType
        {
            get
            {
            ...
            set
            {
                ...
                {
                    NMFExamples.Pcm.Repository.IParameter old = this._parameter__EventType;
                    ...
                    if ((old != null))
                    {
                        ...
                        old.ParentChanged -= this.OnResetParameter__EventType;
                    }
                    if ((value != null))
                    {
                        value.EventType__Parameter = this;
                        value.Parent = this;
                        value.ParentChanged += this.OnResetParameter__EventType;
                    }
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> Parameter__EventTypeChanging;
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> EventGroup__EventTypeChanging;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.Parameter__EventTypeChanging;
            if ((handler != null))
            {
        ...
        {
            if ((sender == this.Parameter__EventType))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.EventGroup__EventTypeChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        protected override IModelElement GetModelElementForReference(string reference, int index)
        {
            ...
            {
                return this.EventGroup__EventType;
            }
        ...
        protected override void SetFeature(string feature, object value)
        {
            ...
            {
                this.Parameter__EventType = ((NMFExamples.Pcm.Repository.IParameter)(value));
                return;
            }
        ...
        public class EventTypeChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new Parameter__EventTypeProxy(this._parent)};
            }
            ...
            public override void Add(IModelElement item)
            {
                if ((this._parent.Parameter__EventType == null))
                {
                    NMFExamples.Pcm.Repository.IParameter parameter__EventTypeCasted = item.As<NMFExamples.Pcm.Repository.IParameter>();
        ...
        public class EventTypeReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new Parameter__EventTypeProxy(this._parent),
                        new EventGroup__EventTypeProxy(this._parent)};
            }
        ...
        /// </summary>
        private sealed class Parameter__EventTypeProxy : ModelPropertyChange<IEventType, NMFExamples.Pcm.Repository.IParameter>
        {
