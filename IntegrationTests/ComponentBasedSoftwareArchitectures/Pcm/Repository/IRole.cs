...
namespace NMFExamples.Pcm.Repository
{
    ...
    /// <summary>
    /// The public interface for Role
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(Role))]
    [XmlDefaultImplementationTypeAttribute(typeof(Role))]
    [ModelRepresentationClassAttribute("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//repository/Role")]
    public partial interface IRole : IModelElement, IEntity
    {
    }
}
