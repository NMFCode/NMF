...
namespace NMFExamples.Pcm.Repository
{
    ...
    public abstract partial class ProvidedRole : Role, IProvidedRole, IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ProvidingEntity_ProvidedRoleChanging;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ProvidingEntity_ProvidedRoleChanging;
            if ((handler != null))
            {
        ...
        protected override IModelElement GetModelElementForReference(string reference, int index)
        {
            ...
            {
                return this.ProvidingEntity_ProvidedRole;
            }
        ...
        public class ProvidedRoleReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new ProvidingEntity_ProvidedRoleProxy(this._parent)};
            }
