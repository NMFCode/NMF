...
namespace NMFExamples.Pcm.Repository
{
    ...
    /// <summary>
    /// Denotes a class to implement the eventTypes__EventGroup reference
    /// </summary>
    public class EventGroupEventTypes__EventGroupCollection : ObservableOppositeList<IEventGroup, IEventType>
    {
        ...
        /// </summary>
        /// <param name="parent">the parent EventGroup</param>
        ...
        protected override void SetOpposite(IEventType item, IEventGroup newParent)
        {
            if ((newParent != null))
            {
                item.ParentChanged += this.OnItemParentChanged;
                item.EventGroup__EventType = newParent;
            }
            else
            {
                item.ParentChanged -= this.OnItemParentChanged;
