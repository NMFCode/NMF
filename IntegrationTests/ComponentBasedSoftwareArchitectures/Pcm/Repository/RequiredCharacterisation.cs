...
namespace NMFExamples.Pcm.Repository
{
    ...
    public partial class RequiredCharacterisation : ModelElement, IRequiredCharacterisation, IModelElement
    {
        ...
        /// </summary>
        [DebuggerBrowsableAttribute(DebuggerBrowsableState.Never)]
        private NMFExamples.Pcm.Repository.IParameter _parameter;
        ...
        [XmlAttributeAttribute(true)]
        public NMFExamples.Pcm.Repository.IParameter Parameter
        {
            get
            {
            ...
            set
            {
                ...
                {
                    NMFExamples.Pcm.Repository.IParameter old = this._parameter;
                    ValueChangedEventArgs e = new ValueChangedEventArgs(old, value);
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ParameterChanging;
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> Interface_RequiredCharacterisationChanging;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ParameterChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.Interface_RequiredCharacterisationChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        protected override IModelElement GetModelElementForReference(string reference, int index)
        {
            ...
            {
                return this.Interface_RequiredCharacterisation;
            }
        ...
        protected override void SetFeature(string feature, object value)
        {
            ...
            {
                this.Parameter = ((NMFExamples.Pcm.Repository.IParameter)(value));
                return;
            }
        ...
        public class RequiredCharacterisationReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new ParameterProxy(this._parent),
                        new Interface_RequiredCharacterisationProxy(this._parent)};
            }
            ...
            public override void Add(IModelElement item)
            {
                if ((this._parent.Parameter == null))
                {
                    NMFExamples.Pcm.Repository.IParameter parameterCasted = item.As<NMFExamples.Pcm.Repository.IParameter>();
        ...
        /// </summary>
        private sealed class ParameterProxy : ModelPropertyChange<IRequiredCharacterisation, NMFExamples.Pcm.Repository.IParameter>
        {
