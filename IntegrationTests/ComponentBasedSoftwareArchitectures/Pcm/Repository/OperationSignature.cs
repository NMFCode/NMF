...
namespace NMFExamples.Pcm.Repository
{
    ...
    public partial class OperationSignature : Signature, IOperationSignature, IModelElement
    {
        ...
        private static Lazy<IOperation> _parameterNamesHaveToBeUniqueForASignatureOperation = new Lazy<IOperation>(RetrieveParameterNamesHaveToBeUniqueForASignatureOperation);
        ...
        /// </summary>
        [DebuggerBrowsableAttribute(DebuggerBrowsableState.Never)]
        private NMFExamples.Pcm.Repository.IDataType _returnType__OperationSignature;
        ...
        [ConstantAttribute()]
        public IListExpression<NMFExamples.Pcm.Repository.IParameter> Parameters__OperationSignature
        {
            get
            {
        ...
        [XmlAttributeAttribute(true)]
        public NMFExamples.Pcm.Repository.IDataType ReturnType__OperationSignature
        {
            get
            {
            ...
            set
            {
                ...
                {
                    NMFExamples.Pcm.Repository.IDataType old = this._returnType__OperationSignature;
        ...
        /// </summary>
        public event EventHandler<OperationCallEventArgs> ParameterNamesHaveToBeUniqueForASignatureCalling;
        
        /// <summary>
        /// Gets fired after the operation ParameterNamesHaveToBeUniqueForASignature got called
        /// </summary>
        public event EventHandler<OperationCallEventArgs> ParameterNamesHaveToBeUniqueForASignatureCalled;
        
        /// <summary>
        /// Gets fired before the Interface__OperationSignature property changes its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> Interface__OperationSignatureChanging;
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ReturnType__OperationSignatureChanging;
        ...
        public bool ParameterNamesHaveToBeUniqueForASignature(object diagnostics, object context)
        {
            Func<IOperationSignature, object, object, bool> handler = OperationBroker.Instance.GetRegisteredDelegate<Func<IOperationSignature, object, object, bool>>(_parameterNamesHaveToBeUniqueForASignatureOperation);
            if ((handler != null))
            {
            }
            else
            {
                throw new InvalidOperationException(("There is no implementation for method ParameterNamesHaveToBeUniqueForASignature r" +
                        "egistered. Use the method broker to register a method implementation."));
            }
            OperationCallEventArgs e = new OperationCallEventArgs(this, _parameterNamesHaveToBeUniqueForASignatureOperation.Value, diagnostics, context);
            this.OnParameterNamesHaveToBeUniqueForASignatureCalling(e);
            this.OnBubbledChange(BubbledChangeEventArgs.OperationCalling(this, _parameterNamesHaveToBeUniqueForASignatureOperation.Value, e));
            bool result = handler.Invoke(this, diagnostics, context);
            e.Result = result;
            this.OnParameterNamesHaveToBeUniqueForASignatureCalled(e);
            this.OnBubbledChange(BubbledChangeEventArgs.OperationCalled(this, _parameterNamesHaveToBeUniqueForASignatureOperation.Value, e));
            return result;
        }
        
        private static IOperation RetrieveParameterNamesHaveToBeUniqueForASignatureOperation()
        {
            return ClassInstance.LookupOperation("ParameterNamesHaveToBeUniqueForASignature");
        }
        
        /// <summary>
        /// Raises the ParameterNamesHaveToBeUniqueForASignatureCalling event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnParameterNamesHaveToBeUniqueForASignatureCalling(OperationCallEventArgs eventArgs)
        {
            EventHandler<OperationCallEventArgs> handler = this.ParameterNamesHaveToBeUniqueForASignatureCalling;
            if ((handler != null))
            {
        ...
        /// <summary>
        /// Raises the ParameterNamesHaveToBeUniqueForASignatureCalled event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnParameterNamesHaveToBeUniqueForASignatureCalled(OperationCallEventArgs eventArgs)
        {
            EventHandler<OperationCallEventArgs> handler = this.ParameterNamesHaveToBeUniqueForASignatureCalled;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.Interface__OperationSignatureChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ReturnType__OperationSignatureChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            if ((sender == this.ReturnType__OperationSignature))
            {
        ...
        protected override IModelElement GetModelElementForReference(string reference, int index)
        {
            ...
            {
                return this.Interface__OperationSignature;
            }
        ...
        protected override void SetFeature(string feature, object value)
        {
            ...
            {
                this.ReturnType__OperationSignature = ((NMFExamples.Pcm.Repository.IDataType)(value));
                return;
            }
        ...
        {
            throw new NotSupportedException(("OperationSignature does not have an absolute URI and therefore cannot be resolved" +
                    "."));
        }
        ...
        public class OperationSignatureChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.Parameters__OperationSignature.AsNotifiable()};
            }
            ...
            {
                NMFExamples.Pcm.Repository.IParameter parameters__OperationSignatureCasted = item.As<NMFExamples.Pcm.Repository.IParameter>();
        ...
        public class OperationSignatureReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            {
                return new INotifiable[] {
                        new Interface__OperationSignatureProxy(this._parent),
                        this._parent.Parameters__OperationSignature.AsNotifiable(),
                        new ReturnType__OperationSignatureProxy(this._parent)};
            }
            ...
            public override void Add(IModelElement item)
            {
                ...
                if ((this._parent.ReturnType__OperationSignature == null))
                {
                    NMFExamples.Pcm.Repository.IDataType returnType__OperationSignatureCasted = item.As<NMFExamples.Pcm.Repository.IDataType>();
        ...
        /// </summary>
        private sealed class ReturnType__OperationSignatureProxy : ModelPropertyChange<IOperationSignature, NMFExamples.Pcm.Repository.IDataType>
        {
