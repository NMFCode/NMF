...
namespace NMFExamples.Pcm.Repository
{
    ...
    public partial class Repository : NMFExamples.Pcm.Core.Entity.Entity, IRepository, IModelElement
    {
        ...
        [ConstantAttribute()]
        public IListExpression<NMFExamples.Pcm.Repository.IDataType> DataTypes__Repository
        {
            get
            {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> RepositoryDescriptionChanging;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.RepositoryDescriptionChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        protected override NMF.Expressions.INotifyExpression<object> GetExpressionForAttribute(string attribute)
        {
            if ((attribute == "REPOSITORYDESCRIPTION"))
            {
                return new RepositoryDescriptionProxy(this);
            }
        ...
        {
            throw new NotSupportedException("Repository does not have an absolute URI and therefore cannot be resolved.");
        }
        ...
        public class RepositoryChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.Components__Repository.AsNotifiable(),
                        this._parent.Interfaces__Repository.AsNotifiable(),
                        this._parent.FailureTypes__Repository.AsNotifiable(),
                        this._parent.DataTypes__Repository.AsNotifiable()};
            }
            ...
            public override void Add(IModelElement item)
            {
                ...
                NMFExamples.Pcm.Repository.IDataType dataTypes__RepositoryCasted = item.As<NMFExamples.Pcm.Repository.IDataType>();
            ...
            public override bool Remove(IModelElement item)
            {
                ...
                NMFExamples.Pcm.Repository.IDataType dataTypeItem = item.As<NMFExamples.Pcm.Repository.IDataType>();
