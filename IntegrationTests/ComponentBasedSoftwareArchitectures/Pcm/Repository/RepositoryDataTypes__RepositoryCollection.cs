...
namespace NMFExamples.Pcm.Repository
{
    ...
    /// <summary>
    /// Denotes a class to implement the dataTypes__Repository reference
    /// </summary>
    public class RepositoryDataTypes__RepositoryCollection : ObservableOppositeList<IRepository, NMFExamples.Pcm.Repository.IDataType>
    {
        ...
        private void OnItemParentChanged(object sender, ValueChangedEventArgs e)
        {
            ...
            {
                this.Remove(((NMFExamples.Pcm.Repository.IDataType)(sender)));
            }
        }
        ...
        protected override void SetOpposite(NMFExamples.Pcm.Repository.IDataType item, IRepository newParent)
        {
            if ((newParent != null))
            {
                item.ParentChanged += this.OnItemParentChanged;
                item.Repository__DataType = newParent;
            }
            else
            {
                item.ParentChanged -= this.OnItemParentChanged;
