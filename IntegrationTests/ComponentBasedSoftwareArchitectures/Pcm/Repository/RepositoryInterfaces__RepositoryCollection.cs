...
namespace NMFExamples.Pcm.Repository
{
    ...
    /// <summary>
    /// Denotes a class to implement the interfaces__Repository reference
    /// </summary>
    public class RepositoryInterfaces__RepositoryCollection : ObservableOppositeList<IRepository, IInterface>
    {
        ...
        protected override void SetOpposite(IInterface item, IRepository newParent)
        {
            if ((newParent != null))
            {
                item.ParentChanged += this.OnItemParentChanged;
                item.Repository__Interface = newParent;
            }
            else
            {
                item.ParentChanged -= this.OnItemParentChanged;
