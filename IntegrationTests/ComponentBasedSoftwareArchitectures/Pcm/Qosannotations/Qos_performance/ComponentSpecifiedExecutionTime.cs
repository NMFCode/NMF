...
namespace NMFExamples.Pcm.Qosannotations.Qos_performance
{
    ...
    public partial class ComponentSpecifiedExecutionTime : SpecifiedExecutionTime, IComponentSpecifiedExecutionTime, IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> AssemblyContext_ComponentSpecifiedExecutionTimeChanging;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.AssemblyContext_ComponentSpecifiedExecutionTimeChanging;
            if ((handler != null))
            {
        ...
        {
            if ((sender == this.AssemblyContext_ComponentSpecifiedExecutionTime))
            {
        ...
        public class ComponentSpecifiedExecutionTimeReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new AssemblyContext_ComponentSpecifiedExecutionTimeProxy(this._parent)};
            }
