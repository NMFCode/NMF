...
namespace NMFExamples.Pcm.Qosannotations
{
    ...
    /// <summary>
    /// Denotes a class to implement the expectedExternalOutputs_SpecifiedOutputParameterAbstraction reference
    /// </summary>
    public class SpecifiedOutputParameterAbstractionExpectedExternalOutputs_SpecifiedOutputParameterAbstractionCollection : ObservableOppositeList<ISpecifiedOutputParameterAbstraction, IVariableUsage>
    {
        ...
        /// </summary>
        /// <param name="parent">the parent SpecifiedOutputParameterAbstraction</param>
        ...
        protected override void SetOpposite(IVariableUsage item, ISpecifiedOutputParameterAbstraction newParent)
        {
            if ((newParent != null))
            {
                item.ParentChanged += this.OnItemParentChanged;
                item.SpecifiedOutputParameterAbstraction_expectedExternalOutputs_VariableUsage = newParent;
            }
            else
            {
                item.ParentChanged -= this.OnItemParentChanged;
