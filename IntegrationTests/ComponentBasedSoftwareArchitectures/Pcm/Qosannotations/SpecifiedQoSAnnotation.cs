...
namespace NMFExamples.Pcm.Qosannotations
{
    ...
    public abstract partial class SpecifiedQoSAnnotation : ModelElement, ISpecifiedQoSAnnotation, IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> Signature_SpecifiedQoSAnnationChanging;
        
        /// <summary>
        /// Gets fired when the Signature_SpecifiedQoSAnnation property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> Signature_SpecifiedQoSAnnationChanged;
        
        /// <summary>
        /// Gets fired before the Role_SpecifiedQoSAnnotation property changes its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> Role_SpecifiedQoSAnnotationChanging;
        
        /// <summary>
        /// Gets fired when the Role_SpecifiedQoSAnnotation property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> Role_SpecifiedQoSAnnotationChanged;
        
        /// <summary>
        /// Gets fired before the QosAnnotations_SpecifiedQoSAnnotation property changes its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> QosAnnotations_SpecifiedQoSAnnotationChanging;
        
        /// <summary>
        /// Gets fired when the QosAnnotations_SpecifiedQoSAnnotation property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> QosAnnotations_SpecifiedQoSAnnotationChanged;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.Signature_SpecifiedQoSAnnationChanging;
            if ((handler != null))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.Signature_SpecifiedQoSAnnationChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private void OnResetSignature_SpecifiedQoSAnnation(object sender, EventArgs eventArgs)
        {
            if ((sender == this.Signature_SpecifiedQoSAnnation))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.Role_SpecifiedQoSAnnotationChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.Role_SpecifiedQoSAnnotationChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <param name="sender">The object that sent this reset request</param>
        /// <param name="eventArgs">The event data for the reset event</param>
        private void OnResetRole_SpecifiedQoSAnnotation(object sender, EventArgs eventArgs)
        {
            if ((sender == this.Role_SpecifiedQoSAnnotation))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.QosAnnotations_SpecifiedQoSAnnotationChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.QosAnnotations_SpecifiedQoSAnnotationChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        protected override IModelElement GetModelElementForReference(string reference, int index)
        {
            ...
            {
                return this.QosAnnotations_SpecifiedQoSAnnotation;
            }
        ...
        public class SpecifiedQoSAnnotationReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new Signature_SpecifiedQoSAnnationProxy(this._parent),
                        new Role_SpecifiedQoSAnnotationProxy(this._parent),
                        new QosAnnotations_SpecifiedQoSAnnotationProxy(this._parent)};
            }
