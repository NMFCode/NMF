...
namespace NMFExamples.Pcm.Qosannotations
{
    ...
    public abstract partial class SpecifiedOutputParameterAbstraction : ModelElement, ISpecifiedOutputParameterAbstraction, IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> Signature_SpecifiedOutputParameterAbstractionChanging;
        
        /// <summary>
        /// Gets fired when the Signature_SpecifiedOutputParameterAbstraction property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> Signature_SpecifiedOutputParameterAbstractionChanged;
        
        /// <summary>
        /// Gets fired before the Role_SpecifiedOutputParameterAbstraction property changes its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> Role_SpecifiedOutputParameterAbstractionChanging;
        
        /// <summary>
        /// Gets fired when the Role_SpecifiedOutputParameterAbstraction property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> Role_SpecifiedOutputParameterAbstractionChanged;
        
        /// <summary>
        /// Gets fired before the QosAnnotations_SpecifiedOutputParameterAbstraction property changes its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> QosAnnotations_SpecifiedOutputParameterAbstractionChanging;
        
        /// <summary>
        /// Gets fired when the QosAnnotations_SpecifiedOutputParameterAbstraction property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> QosAnnotations_SpecifiedOutputParameterAbstractionChanged;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.Signature_SpecifiedOutputParameterAbstractionChanging;
            if ((handler != null))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.Signature_SpecifiedOutputParameterAbstractionChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private void OnResetSignature_SpecifiedOutputParameterAbstraction(object sender, EventArgs eventArgs)
        {
            if ((sender == this.Signature_SpecifiedOutputParameterAbstraction))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.Role_SpecifiedOutputParameterAbstractionChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.Role_SpecifiedOutputParameterAbstractionChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <param name="sender">The object that sent this reset request</param>
        /// <param name="eventArgs">The event data for the reset event</param>
        private void OnResetRole_SpecifiedOutputParameterAbstraction(object sender, EventArgs eventArgs)
        {
            if ((sender == this.Role_SpecifiedOutputParameterAbstraction))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.QosAnnotations_SpecifiedOutputParameterAbstractionChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.QosAnnotations_SpecifiedOutputParameterAbstractionChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        protected override IModelElement GetModelElementForReference(string reference, int index)
        {
            ...
            {
                return this.QosAnnotations_SpecifiedOutputParameterAbstraction;
            }
        ...
        public class SpecifiedOutputParameterAbstractionChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.ExpectedExternalOutputs_SpecifiedOutputParameterAbstraction.AsNotifiable()};
            }
        ...
        public class SpecifiedOutputParameterAbstractionReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            {
                return new INotifiable[] {
                        new Signature_SpecifiedOutputParameterAbstractionProxy(this._parent),
                        new Role_SpecifiedOutputParameterAbstractionProxy(this._parent),
                        this._parent.ExpectedExternalOutputs_SpecifiedOutputParameterAbstraction.AsNotifiable(),
                        new QosAnnotations_SpecifiedOutputParameterAbstractionProxy(this._parent)};
            }
