...
namespace NMFExamples.Pcm.Parameter
{
    ...
    public partial class VariableCharacterisation : ModelElement, IVariableCharacterisation, IModelElement
    {
            ...
            set
            {
                if ((this._specification_VariableCharacterisation != value))
                {
                    ...
                    if ((old != null))
                    {
                        ...
                        old.ParentChanged -= this.OnResetSpecification_VariableCharacterisation;
                    }
                    if ((value != null))
                    {
                        value.VariableCharacterisation_Specification = this;
                        value.Parent = this;
                        value.ParentChanged += this.OnResetSpecification_VariableCharacterisation;
                    }
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> Specification_VariableCharacterisationChanging;
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> VariableUsage_VariableCharacterisationChanging;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.Specification_VariableCharacterisationChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            if ((sender == this.Specification_VariableCharacterisation))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.VariableUsage_VariableCharacterisationChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        protected override IModelElement GetModelElementForReference(string reference, int index)
        {
            ...
            {
                return this.VariableUsage_VariableCharacterisation;
            }
        ...
        protected override NMF.Expressions.INotifyExpression<object> GetExpressionForAttribute(string attribute)
        {
            if ((attribute == "TYPE"))
            {
                return Observable.Box(new TypeProxy(this));
            }
        ...
        public class VariableCharacterisationChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new Specification_VariableCharacterisationProxy(this._parent)};
            }
        ...
        public class VariableCharacterisationReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new Specification_VariableCharacterisationProxy(this._parent),
                        new VariableUsage_VariableCharacterisationProxy(this._parent)};
            }
