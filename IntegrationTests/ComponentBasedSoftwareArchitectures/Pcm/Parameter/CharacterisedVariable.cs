...
namespace NMFExamples.Pcm.Parameter
{
    ...
    public partial class CharacterisedVariable : Variable, ICharacterisedVariable, IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> CharacterisationTypeChanging;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.CharacterisationTypeChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        protected override NMF.Expressions.INotifyExpression<object> GetExpressionForAttribute(string attribute)
        {
            if ((attribute == "CHARACTERISATIONTYPE"))
            {
                return Observable.Box(new CharacterisationTypeProxy(this));
            }
