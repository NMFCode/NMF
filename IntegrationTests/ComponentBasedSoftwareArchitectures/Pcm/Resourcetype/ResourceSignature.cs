...
namespace NMFExamples.Pcm.Resourcetype
{
    ...
    public partial class ResourceSignature : NMFExamples.Pcm.Core.Entity.Entity, IResourceSignature, IModelElement
    {
        ...
        /// </summary>
        [DebuggerBrowsableAttribute(DebuggerBrowsableState.Never)]
        private NMFExamples.Pcm.Repository.IParameter _parameter__ResourceSignature;
        ...
        public NMFExamples.Pcm.Repository.IParameter Parameter__ResourceSignature
        {
            get
            {
            ...
            set
            {
                ...
                {
                    NMFExamples.Pcm.Repository.IParameter old = this._parameter__ResourceSignature;
                    ValueChangedEventArgs e = new ValueChangedEventArgs(old, value);
                    ...
                    if ((old != null))
                    {
                        ...
                        old.ParentChanged -= this.OnResetParameter__ResourceSignature;
                    }
                    if ((value != null))
                    {
                        value.ResourceSignature__Parameter = this;
                        value.Parent = this;
                        value.ParentChanged += this.OnResetParameter__ResourceSignature;
                    }
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ResourceServiceIdChanged;
        
        /// <summary>
        /// Gets fired before the ResourceServiceId property changes its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ResourceServiceIdChanging;
        
        /// <summary>
        /// Gets fired before the Parameter__ResourceSignature property changes its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> Parameter__ResourceSignatureChanging;
        
        /// <summary>
        /// Gets fired when the Parameter__ResourceSignature property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> Parameter__ResourceSignatureChanged;
        
        /// <summary>
        /// Gets fired before the ResourceInterface__ResourceSignature property changes its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ResourceInterface__ResourceSignatureChanging;
        
        /// <summary>
        /// Gets fired when the ResourceInterface__ResourceSignature property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ResourceInterface__ResourceSignatureChanged;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ResourceServiceIdChanged;
            if ((handler != null))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ResourceServiceIdChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.Parameter__ResourceSignatureChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.Parameter__ResourceSignatureChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private void OnResetParameter__ResourceSignature(object sender, EventArgs eventArgs)
        {
            if ((sender == this.Parameter__ResourceSignature))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ResourceInterface__ResourceSignatureChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ResourceInterface__ResourceSignatureChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        protected override IModelElement GetModelElementForReference(string reference, int index)
        {
            ...
            {
                return this.ResourceInterface__ResourceSignature;
            }
        ...
        protected override void SetFeature(string feature, object value)
        {
            ...
            {
                this.Parameter__ResourceSignature = ((NMFExamples.Pcm.Repository.IParameter)(value));
                return;
            }
        ...
        protected override NMF.Expressions.INotifyExpression<object> GetExpressionForAttribute(string attribute)
        {
            if ((attribute == "RESOURCESERVICEID"))
            {
                return Observable.Box(new ResourceServiceIdProxy(this));
            }
        ...
        public class ResourceSignatureChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new Parameter__ResourceSignatureProxy(this._parent)};
            }
            ...
            public override void Add(IModelElement item)
            {
                if ((this._parent.Parameter__ResourceSignature == null))
                {
                    NMFExamples.Pcm.Repository.IParameter parameter__ResourceSignatureCasted = item.As<NMFExamples.Pcm.Repository.IParameter>();
        ...
        public class ResourceSignatureReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new Parameter__ResourceSignatureProxy(this._parent),
                        new ResourceInterface__ResourceSignatureProxy(this._parent)};
            }
        ...
        /// </summary>
        private sealed class Parameter__ResourceSignatureProxy : ModelPropertyChange<IResourceSignature, NMFExamples.Pcm.Repository.IParameter>
        {
