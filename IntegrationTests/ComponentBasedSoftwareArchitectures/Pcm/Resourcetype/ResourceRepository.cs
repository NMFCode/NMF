        ...
        public class ResourceRepositoryChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.ResourceInterfaces__ResourceRepository.AsNotifiable(),
                        this._parent.SchedulingPolicies__ResourceRepository.AsNotifiable(),
                        this._parent.AvailableResourceTypes_ResourceRepository.AsNotifiable()};
            }
