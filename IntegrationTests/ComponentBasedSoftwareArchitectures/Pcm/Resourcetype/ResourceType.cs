...
namespace NMFExamples.Pcm.Resourcetype
{
    ...
    public abstract partial class ResourceType : UnitCarryingElement, IResourceType, IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ResourceRepository_ResourceTypeChanging;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ResourceRepository_ResourceTypeChanging;
            if ((handler != null))
            {
        ...
        protected override IModelElement GetModelElementForReference(string reference, int index)
        {
            ...
            {
                return this.ResourceRepository_ResourceType;
            }
        ...
        public class ResourceTypeChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.ResourceProvidedRoles__ResourceInterfaceProvidingEntity.AsNotifiable()};
            }
        ...
        public class ResourceTypeReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            {
                return new INotifiable[] {
                        new ResourceRepository_ResourceTypeProxy(this._parent),
                        this._parent.ResourceProvidedRoles__ResourceInterfaceProvidingEntity.AsNotifiable()};
            }
