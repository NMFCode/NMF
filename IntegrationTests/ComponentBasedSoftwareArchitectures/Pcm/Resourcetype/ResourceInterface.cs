...
namespace NMFExamples.Pcm.Resourcetype
{
    ...
    public partial class ResourceInterface : NMFExamples.Pcm.Core.Entity.Entity, IResourceInterface, IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ResourceRepository__ResourceInterfaceChanging;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ResourceRepository__ResourceInterfaceChanging;
            if ((handler != null))
            {
        ...
        protected override IModelElement GetModelElementForReference(string reference, int index)
        {
            ...
            {
                return this.ResourceRepository__ResourceInterface;
            }
        ...
        {
            throw new NotSupportedException("ResourceInterface does not have an absolute URI and therefore cannot be resolved.");
        }
        ...
        public class ResourceInterfaceChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.ResourceSignatures__ResourceInterface.AsNotifiable()};
            }
        ...
        public class ResourceInterfaceReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            {
                return new INotifiable[] {
                        new ResourceRepository__ResourceInterfaceProxy(this._parent),
                        this._parent.ResourceSignatures__ResourceInterface.AsNotifiable()};
            }
