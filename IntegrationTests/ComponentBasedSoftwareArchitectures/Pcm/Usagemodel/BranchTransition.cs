...
namespace NMFExamples.Pcm.Usagemodel
{
    ...
    public partial class BranchTransition : ModelElement, IBranchTransition, IModelElement
    {
            ...
            set
            {
                if ((this._branchedBehaviour_BranchTransition != value))
                {
                    ...
                    if ((old != null))
                    {
                        ...
                        old.ParentChanged -= this.OnResetBranchedBehaviour_BranchTransition;
                    }
                    if ((value != null))
                    {
                        value.BranchTransition_ScenarioBehaviour = this;
                        value.Parent = this;
                        value.ParentChanged += this.OnResetBranchedBehaviour_BranchTransition;
                    }
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> Branch_BranchTransitionChanging;
        
        /// <summary>
        /// Gets fired when the Branch_BranchTransition property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> Branch_BranchTransitionChanged;
        
        /// <summary>
        /// Gets fired before the BranchedBehaviour_BranchTransition property changes its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> BranchedBehaviour_BranchTransitionChanging;
        
        /// <summary>
        /// Gets fired when the BranchedBehaviour_BranchTransition property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> BranchedBehaviour_BranchTransitionChanged;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.Branch_BranchTransitionChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.Branch_BranchTransitionChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.BranchedBehaviour_BranchTransitionChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.BranchedBehaviour_BranchTransitionChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private void OnResetBranchedBehaviour_BranchTransition(object sender, EventArgs eventArgs)
        {
            if ((sender == this.BranchedBehaviour_BranchTransition))
            {
        ...
        protected override IModelElement GetModelElementForReference(string reference, int index)
        {
            ...
            {
                return this.Branch_BranchTransition;
            }
        ...
        public class BranchTransitionChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new BranchedBehaviour_BranchTransitionProxy(this._parent)};
            }
        ...
        public class BranchTransitionReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            {
                return new INotifiable[] {
                        new Branch_BranchTransitionProxy(this._parent),
                        new BranchedBehaviour_BranchTransitionProxy(this._parent)};
            }
