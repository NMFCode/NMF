...
namespace NMFExamples.Pcm.Usagemodel
{
    ...
    public abstract partial class Workload : ModelElement, IWorkload, IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> UsageScenario_WorkloadChanging;
        
        /// <summary>
        /// Gets fired when the UsageScenario_Workload property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> UsageScenario_WorkloadChanged;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.UsageScenario_WorkloadChanging;
            if ((handler != null))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.UsageScenario_WorkloadChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        protected override IModelElement GetModelElementForReference(string reference, int index)
        {
            ...
            {
                return this.UsageScenario_Workload;
            }
        ...
        {
            throw new NotSupportedException("Workload does not have an absolute URI and therefore cannot be resolved.");
        }
        ...
        public class WorkloadReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new UsageScenario_WorkloadProxy(this._parent)};
            }
