...
namespace NMFExamples.Pcm.Usagemodel
{
    ...
    public partial class UsageScenario : NMFExamples.Pcm.Core.Entity.Entity, IUsageScenario, IModelElement
    {
            ...
            set
            {
                if ((this._scenarioBehaviour_UsageScenario != value))
                {
                    ...
                    if ((old != null))
                    {
                        ...
                        old.ParentChanged -= this.OnResetScenarioBehaviour_UsageScenario;
                    }
                    if ((value != null))
                    {
                        value.UsageScenario_SenarioBehaviour = this;
                        value.Parent = this;
                        value.ParentChanged += this.OnResetScenarioBehaviour_UsageScenario;
                    }
            ...
            set
            {
                if ((this._workload_UsageScenario != value))
                {
                    ...
                    if ((old != null))
                    {
                        ...
                        old.ParentChanged -= this.OnResetWorkload_UsageScenario;
                    }
                    if ((value != null))
                    {
                        value.UsageScenario_Workload = this;
                        value.Parent = this;
                        value.ParentChanged += this.OnResetWorkload_UsageScenario;
                    }
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> UsageModel_UsageScenarioChanging;
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ScenarioBehaviour_UsageScenarioChanging;
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> Workload_UsageScenarioChanging;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.UsageModel_UsageScenarioChanging;
            if ((handler != null))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ScenarioBehaviour_UsageScenarioChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            if ((sender == this.ScenarioBehaviour_UsageScenario))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.Workload_UsageScenarioChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            if ((sender == this.Workload_UsageScenario))
            {
        ...
        protected override IModelElement GetModelElementForReference(string reference, int index)
        {
            ...
            {
                return this.UsageModel_UsageScenario;
            }
        ...
        public class UsageScenarioChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new ScenarioBehaviour_UsageScenarioProxy(this._parent),
                        new Workload_UsageScenarioProxy(this._parent)};
            }
        ...
        public class UsageScenarioReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            {
                return new INotifiable[] {
                        new UsageModel_UsageScenarioProxy(this._parent),
                        new ScenarioBehaviour_UsageScenarioProxy(this._parent),
                        new Workload_UsageScenarioProxy(this._parent)};
            }
