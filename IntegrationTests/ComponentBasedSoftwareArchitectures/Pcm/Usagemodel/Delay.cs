...
namespace NMFExamples.Pcm.Usagemodel
{
    ...
    public partial class Delay : AbstractUserAction, IDelay, IModelElement
    {
            ...
            set
            {
                if ((this._timeSpecification_Delay != value))
                {
                    ...
                    if ((old != null))
                    {
                        ...
                        old.ParentChanged -= this.OnResetTimeSpecification_Delay;
                    }
                    if ((value != null))
                    {
                        value.Delay_TimeSpecification = this;
                        value.Parent = this;
                        value.ParentChanged += this.OnResetTimeSpecification_Delay;
                    }
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> TimeSpecification_DelayChanging;
        
        /// <summary>
        /// Gets fired when the TimeSpecification_Delay property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> TimeSpecification_DelayChanged;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.TimeSpecification_DelayChanging;
            if ((handler != null))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.TimeSpecification_DelayChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private void OnResetTimeSpecification_Delay(object sender, EventArgs eventArgs)
        {
            if ((sender == this.TimeSpecification_Delay))
            {
        ...
        public class DelayChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new TimeSpecification_DelayProxy(this._parent)};
            }
