...
namespace NMFExamples.Pcm.Allocation
{
    ...
    public partial class Allocation : NMFExamples.Pcm.Core.Entity.Entity, IAllocation, IModelElement
    {
        ...
        private static Lazy<IOperation> _eachAssemblyContextWithinSystemHasToBeAllocatedExactlyOnceOperation = new Lazy<IOperation>(RetrieveEachAssemblyContextWithinSystemHasToBeAllocatedExactlyOnceOperation);
        
        private static Lazy<IOperation> _communicatingServersHaveToBeConnectedByLinkingResourceOperation = new Lazy<IOperation>(RetrieveCommunicatingServersHaveToBeConnectedByLinkingResourceOperation);
        ...
        /// </summary>
        public event EventHandler<OperationCallEventArgs> EachAssemblyContextWithinSystemHasToBeAllocatedExactlyOnceCalling;
        
        /// <summary>
        /// Gets fired after the operation EachAssemblyContextWithinSystemHasToBeAllocatedExactlyOnce got called
        /// </summary>
        public event EventHandler<OperationCallEventArgs> EachAssemblyContextWithinSystemHasToBeAllocatedExactlyOnceCalled;
        
        /// <summary>
        /// Gets fired before the operation CommunicatingServersHaveToBeConnectedByLinkingResource gets called
        /// </summary>
        public event EventHandler<OperationCallEventArgs> CommunicatingServersHaveToBeConnectedByLinkingResourceCalling;
        
        /// <summary>
        /// Gets fired after the operation CommunicatingServersHaveToBeConnectedByLinkingResource got called
        /// </summary>
        public event EventHandler<OperationCallEventArgs> CommunicatingServersHaveToBeConnectedByLinkingResourceCalled;
        
        /// <summary>
        /// Gets fired before the TargetResourceEnvironment_Allocation property changes its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> TargetResourceEnvironment_AllocationChanging;
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> System_AllocationChanging;
        ...
        public bool EachAssemblyContextWithinSystemHasToBeAllocatedExactlyOnce(object diagnostics, object context)
        {
            Func<IAllocation, object, object, bool> handler = OperationBroker.Instance.GetRegisteredDelegate<Func<IAllocation, object, object, bool>>(_eachAssemblyContextWithinSystemHasToBeAllocatedExactlyOnceOperation);
            if ((handler != null))
            {
            }
            else
            {
                throw new InvalidOperationException(("There is no implementation for method EachAssemblyContextWithinSystemHasToBeAlloc" +
                        "atedExactlyOnce registered. Use the method broker to register a method implement" +
                        "ation."));
            }
            OperationCallEventArgs e = new OperationCallEventArgs(this, _eachAssemblyContextWithinSystemHasToBeAllocatedExactlyOnceOperation.Value, diagnostics, context);
            this.OnEachAssemblyContextWithinSystemHasToBeAllocatedExactlyOnceCalling(e);
            this.OnBubbledChange(BubbledChangeEventArgs.OperationCalling(this, _eachAssemblyContextWithinSystemHasToBeAllocatedExactlyOnceOperation.Value, e));
            bool result = handler.Invoke(this, diagnostics, context);
            e.Result = result;
            this.OnEachAssemblyContextWithinSystemHasToBeAllocatedExactlyOnceCalled(e);
            this.OnBubbledChange(BubbledChangeEventArgs.OperationCalled(this, _eachAssemblyContextWithinSystemHasToBeAllocatedExactlyOnceOperation.Value, e));
            return result;
        }
        
        private static IOperation RetrieveEachAssemblyContextWithinSystemHasToBeAllocatedExactlyOnceOperation()
        {
            return ClassInstance.LookupOperation("EachAssemblyContextWithinSystemHasToBeAllocatedExactlyOnce");
        }
        
        /// <summary>
        /// Raises the EachAssemblyContextWithinSystemHasToBeAllocatedExactlyOnceCalling event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnEachAssemblyContextWithinSystemHasToBeAllocatedExactlyOnceCalling(OperationCallEventArgs eventArgs)
        {
            EventHandler<OperationCallEventArgs> handler = this.EachAssemblyContextWithinSystemHasToBeAllocatedExactlyOnceCalling;
            if ((handler != null))
            {
        ...
        /// <summary>
        /// Raises the EachAssemblyContextWithinSystemHasToBeAllocatedExactlyOnceCalled event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnEachAssemblyContextWithinSystemHasToBeAllocatedExactlyOnceCalled(OperationCallEventArgs eventArgs)
        {
            EventHandler<OperationCallEventArgs> handler = this.EachAssemblyContextWithinSystemHasToBeAllocatedExactlyOnceCalled;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <param name="diagnostics"></param>
        /// <param name="context"></param>
        public bool CommunicatingServersHaveToBeConnectedByLinkingResource(object diagnostics, object context)
        {
            Func<IAllocation, object, object, bool> handler = OperationBroker.Instance.GetRegisteredDelegate<Func<IAllocation, object, object, bool>>(_communicatingServersHaveToBeConnectedByLinkingResourceOperation);
            if ((handler != null))
            {
            }
            else
            {
                throw new InvalidOperationException(("There is no implementation for method CommunicatingServersHaveToBeConnectedByLink" +
                        "ingResource registered. Use the method broker to register a method implementatio" +
                        "n."));
            }
            OperationCallEventArgs e = new OperationCallEventArgs(this, _communicatingServersHaveToBeConnectedByLinkingResourceOperation.Value, diagnostics, context);
            this.OnCommunicatingServersHaveToBeConnectedByLinkingResourceCalling(e);
            this.OnBubbledChange(BubbledChangeEventArgs.OperationCalling(this, _communicatingServersHaveToBeConnectedByLinkingResourceOperation.Value, e));
            bool result = handler.Invoke(this, diagnostics, context);
            e.Result = result;
            this.OnCommunicatingServersHaveToBeConnectedByLinkingResourceCalled(e);
            this.OnBubbledChange(BubbledChangeEventArgs.OperationCalled(this, _communicatingServersHaveToBeConnectedByLinkingResourceOperation.Value, e));
            return result;
        }
        
        private static IOperation RetrieveCommunicatingServersHaveToBeConnectedByLinkingResourceOperation()
        {
            return ClassInstance.LookupOperation("CommunicatingServersHaveToBeConnectedByLinkingResource");
        }
        
        /// <summary>
        /// Raises the CommunicatingServersHaveToBeConnectedByLinkingResourceCalling event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnCommunicatingServersHaveToBeConnectedByLinkingResourceCalling(OperationCallEventArgs eventArgs)
        {
            EventHandler<OperationCallEventArgs> handler = this.CommunicatingServersHaveToBeConnectedByLinkingResourceCalling;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <summary>
        /// Raises the CommunicatingServersHaveToBeConnectedByLinkingResourceCalled event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnCommunicatingServersHaveToBeConnectedByLinkingResourceCalled(OperationCallEventArgs eventArgs)
        {
            EventHandler<OperationCallEventArgs> handler = this.CommunicatingServersHaveToBeConnectedByLinkingResourceCalled;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.TargetResourceEnvironment_AllocationChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            if ((sender == this.TargetResourceEnvironment_Allocation))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.System_AllocationChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            if ((sender == this.System_Allocation))
            {
        ...
        public class AllocationChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.AllocationContexts_Allocation.AsNotifiable()};
            }
        ...
        public class AllocationReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            {
                return new INotifiable[] {
                        new TargetResourceEnvironment_AllocationProxy(this._parent),
                        new System_AllocationProxy(this._parent),
                        this._parent.AllocationContexts_Allocation.AsNotifiable()};
            }
