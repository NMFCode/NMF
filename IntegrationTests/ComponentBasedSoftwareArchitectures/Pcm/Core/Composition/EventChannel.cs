...
namespace NMFExamples.Pcm.Core.Composition
{
    ...
    public partial class EventChannel : NMFExamples.Pcm.Core.Entity.Entity, IEventChannel, IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> EventGroup__EventChannelChanging;
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ParentStructure__EventChannelChanging;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.EventGroup__EventChannelChanging;
            if ((handler != null))
            {
        ...
        {
            if ((sender == this.EventGroup__EventChannel))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ParentStructure__EventChannelChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        protected override IModelElement GetModelElementForReference(string reference, int index)
        {
            ...
            {
                return this.ParentStructure__EventChannel;
            }
        ...
        public class EventChannelReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new EventGroup__EventChannelProxy(this._parent),
                        this._parent.EventChannelSourceConnector__EventChannel.AsNotifiable(),
                        this._parent.EventChannelSinkConnector__EventChannel.AsNotifiable(),
                        new ParentStructure__EventChannelProxy(this._parent)};
            }
