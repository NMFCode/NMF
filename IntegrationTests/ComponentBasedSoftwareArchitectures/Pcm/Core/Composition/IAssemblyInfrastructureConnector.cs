...
namespace NMFExamples.Pcm.Core.Composition
{
    ...
    public partial interface IAssemblyInfrastructureConnector : IModelElement, IConnector
    {
        ...
        [XmlAttributeAttribute(true)]
        NMFExamples.Pcm.Core.Composition.IAssemblyContext ProvidingAssemblyContext__AssemblyInfrastructureConnector
        {
            get;
            set;
        }
        ...
        [XmlAttributeAttribute(true)]
        NMFExamples.Pcm.Core.Composition.IAssemblyContext RequiringAssemblyContext__AssemblyInfrastructureConnector
        {
            get;
            set;
        }
