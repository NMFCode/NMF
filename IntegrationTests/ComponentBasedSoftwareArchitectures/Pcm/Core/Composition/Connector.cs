...
namespace NMFExamples.Pcm.Core.Composition
{
    ...
    public abstract partial class Connector : NMFExamples.Pcm.Core.Entity.Entity, IConnector, IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ParentStructure__ConnectorChanging;
        
        /// <summary>
        /// Gets fired when the ParentStructure__Connector property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ParentStructure__ConnectorChanged;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ParentStructure__ConnectorChanging;
            if ((handler != null))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ParentStructure__ConnectorChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        protected override IModelElement GetModelElementForReference(string reference, int index)
        {
            ...
            {
                return this.ParentStructure__Connector;
            }
        ...
        public class ConnectorReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new ParentStructure__ConnectorProxy(this._parent)};
            }
