...
namespace NMFExamples.Pcm.Core.Composition
{
    ...
    public partial class EventChannelSourceConnector : Connector, IEventChannelSourceConnector, IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> SourceRole__EventChannelSourceRoleChanging;
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> AssemblyContext__EventChannelSourceConnectorChanging;
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> EventChannel__EventChannelSourceConnectorChanging;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.SourceRole__EventChannelSourceRoleChanging;
            if ((handler != null))
            {
        ...
        {
            if ((sender == this.SourceRole__EventChannelSourceRole))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.AssemblyContext__EventChannelSourceConnectorChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            if ((sender == this.AssemblyContext__EventChannelSourceConnector))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.EventChannel__EventChannelSourceConnectorChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            if ((sender == this.EventChannel__EventChannelSourceConnector))
            {
        ...
        public class EventChannelSourceConnectorReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new SourceRole__EventChannelSourceRoleProxy(this._parent),
                        new AssemblyContext__EventChannelSourceConnectorProxy(this._parent),
                        new EventChannel__EventChannelSourceConnectorProxy(this._parent)};
            }
