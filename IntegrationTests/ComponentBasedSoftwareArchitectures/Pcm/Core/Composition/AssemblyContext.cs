...
namespace NMFExamples.Pcm.Core.Composition
{
    ...
    public partial class AssemblyContext : NMFExamples.Pcm.Core.Entity.Entity, NMFExamples.Pcm.Core.Composition.IAssemblyContext, IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ParentStructure__AssemblyContextChanging;
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> EncapsulatedComponent__AssemblyContextChanging;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ParentStructure__AssemblyContextChanging;
            if ((handler != null))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.EncapsulatedComponent__AssemblyContextChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            if ((sender == this.EncapsulatedComponent__AssemblyContext))
            {
        ...
        private void ConfigParameterUsages__AssemblyContextCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        protected override IModelElement GetModelElementForReference(string reference, int index)
        {
            ...
            {
                return this.ParentStructure__AssemblyContext;
            }
        ...
        public class AssemblyContextChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.ConfigParameterUsages__AssemblyContext.AsNotifiable()};
            }
        ...
        public class AssemblyContextReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            {
                return new INotifiable[] {
                        new ParentStructure__AssemblyContextProxy(this._parent),
                        new EncapsulatedComponent__AssemblyContextProxy(this._parent),
                        this._parent.ConfigParameterUsages__AssemblyContext.AsNotifiable()};
            }
