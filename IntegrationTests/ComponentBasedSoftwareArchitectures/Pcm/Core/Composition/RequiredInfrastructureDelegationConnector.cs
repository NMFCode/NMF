...
namespace NMFExamples.Pcm.Core.Composition
{
    ...
    public partial class RequiredInfrastructureDelegationConnector : DelegationConnector, IRequiredInfrastructureDelegationConnector, IModelElement
    {
        ...
        /// </summary>
        [DebuggerBrowsableAttribute(DebuggerBrowsableState.Never)]
        private NMFExamples.Pcm.Core.Composition.IAssemblyContext _assemblyContext__RequiredInfrastructureDelegationConnector;
        ...
        [XmlAttributeAttribute(true)]
        public NMFExamples.Pcm.Core.Composition.IAssemblyContext AssemblyContext__RequiredInfrastructureDelegationConnector
        {
            get
            {
            ...
            set
            {
                ...
                {
                    NMFExamples.Pcm.Core.Composition.IAssemblyContext old = this._assemblyContext__RequiredInfrastructureDelegationConnector;
                    ValueChangedEventArgs e = new ValueChangedEventArgs(old, value);
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> InnerRequiredRole__RequiredInfrastructureDelegationConnectorChanging;
        
        /// <summary>
        /// Gets fired when the InnerRequiredRole__RequiredInfrastructureDelegationConnector property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> InnerRequiredRole__RequiredInfrastructureDelegationConnectorChanged;
        
        /// <summary>
        /// Gets fired before the OuterRequiredRole__RequiredInfrastructureDelegationConnector property changes its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> OuterRequiredRole__RequiredInfrastructureDelegationConnectorChanging;
        
        /// <summary>
        /// Gets fired when the OuterRequiredRole__RequiredInfrastructureDelegationConnector property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> OuterRequiredRole__RequiredInfrastructureDelegationConnectorChanged;
        
        /// <summary>
        /// Gets fired before the AssemblyContext__RequiredInfrastructureDelegationConnector property changes its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> AssemblyContext__RequiredInfrastructureDelegationConnectorChanging;
        
        /// <summary>
        /// Gets fired when the AssemblyContext__RequiredInfrastructureDelegationConnector property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> AssemblyContext__RequiredInfrastructureDelegationConnectorChanged;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.InnerRequiredRole__RequiredInfrastructureDelegationConnectorChanging;
            if ((handler != null))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.InnerRequiredRole__RequiredInfrastructureDelegationConnectorChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private void OnResetInnerRequiredRole__RequiredInfrastructureDelegationConnector(object sender, EventArgs eventArgs)
        {
            if ((sender == this.InnerRequiredRole__RequiredInfrastructureDelegationConnector))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.OuterRequiredRole__RequiredInfrastructureDelegationConnectorChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.OuterRequiredRole__RequiredInfrastructureDelegationConnectorChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <param name="sender">The object that sent this reset request</param>
        /// <param name="eventArgs">The event data for the reset event</param>
        private void OnResetOuterRequiredRole__RequiredInfrastructureDelegationConnector(object sender, EventArgs eventArgs)
        {
            if ((sender == this.OuterRequiredRole__RequiredInfrastructureDelegationConnector))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.AssemblyContext__RequiredInfrastructureDelegationConnectorChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.AssemblyContext__RequiredInfrastructureDelegationConnectorChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <param name="sender">The object that sent this reset request</param>
        /// <param name="eventArgs">The event data for the reset event</param>
        private void OnResetAssemblyContext__RequiredInfrastructureDelegationConnector(object sender, EventArgs eventArgs)
        {
            if ((sender == this.AssemblyContext__RequiredInfrastructureDelegationConnector))
            {
        ...
        protected override void SetFeature(string feature, object value)
        {
            ...
            {
                this.AssemblyContext__RequiredInfrastructureDelegationConnector = ((NMFExamples.Pcm.Core.Composition.IAssemblyContext)(value));
                return;
            }
        ...
        {
            throw new NotSupportedException(("RequiredInfrastructureDelegationConnector does not have an absolute URI and there" +
                    "fore cannot be resolved."));
        }
        ...
        public class RequiredInfrastructureDelegationConnectorReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new InnerRequiredRole__RequiredInfrastructureDelegationConnectorProxy(this._parent),
                        new OuterRequiredRole__RequiredInfrastructureDelegationConnectorProxy(this._parent),
                        new AssemblyContext__RequiredInfrastructureDelegationConnectorProxy(this._parent)};
            }
            ...
            public override void Add(IModelElement item)
            {
                ...
                if ((this._parent.AssemblyContext__RequiredInfrastructureDelegationConnector == null))
                {
                    NMFExamples.Pcm.Core.Composition.IAssemblyContext assemblyContext__RequiredInfrastructureDelegationConnectorCasted = item.As<NMFExamples.Pcm.Core.Composition.IAssemblyContext>();
        ...
        /// </summary>
        private sealed class AssemblyContext__RequiredInfrastructureDelegationConnectorProxy : ModelPropertyChange<IRequiredInfrastructureDelegationConnector, NMFExamples.Pcm.Core.Composition.IAssemblyContext>
        {
