...
namespace NMFExamples.Pcm.Core.Composition
{
    ...
    public partial class EventChannelSinkConnector : Connector, IEventChannelSinkConnector, IModelElement
    {
            ...
            set
            {
                if ((this._filterCondition__EventChannelSinkConnector != value))
                {
                    ...
                    if ((old != null))
                    {
                        ...
                        old.ParentChanged -= this.OnResetFilterCondition__EventChannelSinkConnector;
                    }
                    if ((value != null))
                    {
                        value.EventChannelSinkConnector__FilterCondition = this;
                        value.Parent = this;
                        value.ParentChanged += this.OnResetFilterCondition__EventChannelSinkConnector;
                    }
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> SinkRole__EventChannelSinkConnectorChanging;
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> FilterCondition__EventChannelSinkConnectorChanging;
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> AssemblyContext__EventChannelSinkConnectorChanging;
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> EventChannel__EventChannelSinkConnectorChanging;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.SinkRole__EventChannelSinkConnectorChanging;
            if ((handler != null))
            {
        ...
        {
            if ((sender == this.SinkRole__EventChannelSinkConnector))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.FilterCondition__EventChannelSinkConnectorChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            if ((sender == this.FilterCondition__EventChannelSinkConnector))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.AssemblyContext__EventChannelSinkConnectorChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            if ((sender == this.AssemblyContext__EventChannelSinkConnector))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.EventChannel__EventChannelSinkConnectorChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            if ((sender == this.EventChannel__EventChannelSinkConnector))
            {
        ...
        public class EventChannelSinkConnectorChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new FilterCondition__EventChannelSinkConnectorProxy(this._parent)};
            }
        ...
        public class EventChannelSinkConnectorReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            {
                return new INotifiable[] {
                        new SinkRole__EventChannelSinkConnectorProxy(this._parent),
                        new FilterCondition__EventChannelSinkConnectorProxy(this._parent),
                        new AssemblyContext__EventChannelSinkConnectorProxy(this._parent),
                        new EventChannel__EventChannelSinkConnectorProxy(this._parent)};
            }
