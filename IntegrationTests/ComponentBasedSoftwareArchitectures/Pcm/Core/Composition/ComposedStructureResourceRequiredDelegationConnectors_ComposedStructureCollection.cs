...
namespace NMFExamples.Pcm.Core.Composition
{
    ...
    /// <summary>
    /// Denotes a class to implement the resourceRequiredDelegationConnectors_ComposedStructure reference
    /// </summary>
    public class ComposedStructureResourceRequiredDelegationConnectors_ComposedStructureCollection : ObservableOppositeList<IComposedStructure, IResourceRequiredDelegationConnector>
    {
        ...
        protected override void SetOpposite(IResourceRequiredDelegationConnector item, IComposedStructure newParent)
        {
            if ((newParent != null))
            {
                item.ParentChanged += this.OnItemParentChanged;
                item.ParentStructure_ResourceRequiredDelegationConnector = newParent;
            }
            else
            {
                item.ParentChanged -= this.OnItemParentChanged;
