...
namespace NMFExamples.Pcm.Core.Entity
{
    ...
    /// <summary>
    /// Denotes a class to implement the requiredRoles_InterfaceRequiringEntity reference
    /// </summary>
    public class InterfaceRequiringEntityRequiredRoles_InterfaceRequiringEntityCollection : ObservableOppositeList<IInterfaceRequiringEntity, IRequiredRole>
    {
        ...
        /// </summary>
        /// <param name="parent">the parent InterfaceRequiringEntity</param>
        ...
        protected override void SetOpposite(IRequiredRole item, IInterfaceRequiringEntity newParent)
        {
            if ((newParent != null))
            {
                item.ParentChanged += this.OnItemParentChanged;
                item.RequiringEntity_RequiredRole = newParent;
            }
            else
            {
                item.ParentChanged -= this.OnItemParentChanged;
