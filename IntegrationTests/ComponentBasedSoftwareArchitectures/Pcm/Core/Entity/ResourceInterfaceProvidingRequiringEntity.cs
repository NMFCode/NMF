...
namespace NMFExamples.Pcm.Core.Entity
{
    ...
    [ModelRepresentationClassAttribute("http://sdq.ipd.uka.de/PalladioComponentModel/5.0#//core/entity/ResourceInterfaceP" +
        "rovidingRequiringEntity")]
    [DebuggerDisplayAttribute("ResourceInterfaceProvidingRequiringEntity {Id}")]
    public partial class ResourceInterfaceProvidingRequiringEntity : ResourceInterfaceRequiringEntity, IResourceInterfaceProvidingRequiringEntity, IModelElement
    {
        ...
        public override IEnumerableExpression<IModelElement> Children
        {
            get
            {
                return base.Children.Concat(new ResourceInterfaceProvidingRequiringEntityChildrenCollection(this));
            }
        }
        ...
        /// <summary>
        /// The collection class to to represent the children of the ResourceInterfaceProvidingRequiringEntity class
        /// </summary>
        public class ResourceInterfaceProvidingRequiringEntityChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private ResourceInterfaceProvidingRequiringEntity _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public ResourceInterfaceProvidingRequiringEntityChildrenCollection(ResourceInterfaceProvidingRequiringEntity parent)
            {
                this._parent = parent;
            }
