...
namespace NMFExamples.Pcm.Core.Entity
{
    ...
    public abstract partial class InterfaceProvidingRequiringEntity : InterfaceProvidingEntity, IInterfaceProvidingRequiringEntity, IModelElement
    {
        ...
        public override IEnumerableExpression<IModelElement> Children
        {
            get
            {
                return base.Children.Concat(new InterfaceProvidingRequiringEntityChildrenCollection(this));
            }
        }
        ...
        /// <summary>
        /// The collection class to to represent the children of the InterfaceProvidingRequiringEntity class
        /// </summary>
        public class InterfaceProvidingRequiringEntityChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private InterfaceProvidingRequiringEntity _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public InterfaceProvidingRequiringEntityChildrenCollection(InterfaceProvidingRequiringEntity parent)
            {
                this._parent = parent;
            }
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.RequiredRoles_InterfaceRequiringEntity).Concat(this._parent.ResourceRequiredRoles__ResourceInterfaceRequiringEntity).GetEnumerator();
            }
        }
    }
}
