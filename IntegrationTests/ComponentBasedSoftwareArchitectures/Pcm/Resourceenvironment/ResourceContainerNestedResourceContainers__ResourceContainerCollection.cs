...
namespace NMFExamples.Pcm.Resourceenvironment
{
    ...
    /// <summary>
    /// Denotes a class to implement the nestedResourceContainers__ResourceContainer reference
    /// </summary>
    public class ResourceContainerNestedResourceContainers__ResourceContainerCollection : ObservableOppositeList<IResourceContainer, IResourceContainer>
    {
        ...
        protected override void SetOpposite(IResourceContainer item, IResourceContainer newParent)
        {
            if ((newParent != null))
            {
                item.ParentChanged += this.OnItemParentChanged;
                item.ParentResourceContainer__ResourceContainer = newParent;
            }
            else
            {
                item.ParentChanged -= this.OnItemParentChanged;
