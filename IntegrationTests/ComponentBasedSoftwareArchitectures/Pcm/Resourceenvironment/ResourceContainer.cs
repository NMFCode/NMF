...
namespace NMFExamples.Pcm.Resourceenvironment
{
    ...
    public partial class ResourceContainer : NMFExamples.Pcm.Core.Entity.Entity, IResourceContainer, IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ResourceEnvironment_ResourceContainerChanging;
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ParentResourceContainer__ResourceContainerChanging;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ResourceEnvironment_ResourceContainerChanging;
            if ((handler != null))
            {
        ...
        {
            if ((sender == this.ResourceEnvironment_ResourceContainer))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ParentResourceContainer__ResourceContainerChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            if ((sender == this.ParentResourceContainer__ResourceContainer))
            {
        ...
        protected override IModelElement GetModelElementForReference(string reference, int index)
        {
            ...
            {
                return this.ResourceEnvironment_ResourceContainer;
            }
            ...
            {
                return this.ParentResourceContainer__ResourceContainer;
            }
        ...
        {
            throw new NotSupportedException("ResourceContainer does not have an absolute URI and therefore cannot be resolved.");
        }
        ...
        public class ResourceContainerChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.ActiveResourceSpecifications_ResourceContainer.AsNotifiable(),
                        this._parent.NestedResourceContainers__ResourceContainer.AsNotifiable()};
            }
        ...
        public class ResourceContainerReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.ActiveResourceSpecifications_ResourceContainer.AsNotifiable(),
                        new ResourceEnvironment_ResourceContainerProxy(this._parent),
                        this._parent.NestedResourceContainers__ResourceContainer.AsNotifiable(),
                        new ParentResourceContainer__ResourceContainerProxy(this._parent)};
            }
