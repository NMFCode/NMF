...
namespace NMFExamples.Pcm.Resourceenvironment
{
    ...
    public partial class LinkingResource : NMFExamples.Pcm.Core.Entity.Entity, ILinkingResource, IModelElement
    {
            ...
            set
            {
                if ((this._communicationLinkResourceSpecifications_LinkingResource != value))
                {
                    ...
                    if ((old != null))
                    {
                        ...
                        old.ParentChanged -= this.OnResetCommunicationLinkResourceSpecifications_LinkingResource;
                    }
                    if ((value != null))
                    {
                        value.LinkingResource_CommunicationLinkResourceSpecification = this;
                        value.Parent = this;
                        value.ParentChanged += this.OnResetCommunicationLinkResourceSpecifications_LinkingResource;
                    }
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> CommunicationLinkResourceSpecifications_LinkingResourceChanging;
        
        /// <summary>
        /// Gets fired when the CommunicationLinkResourceSpecifications_LinkingResource property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> CommunicationLinkResourceSpecifications_LinkingResourceChanged;
        
        /// <summary>
        /// Gets fired before the ResourceEnvironment_LinkingResource property changes its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ResourceEnvironment_LinkingResourceChanging;
        
        /// <summary>
        /// Gets fired when the ResourceEnvironment_LinkingResource property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ResourceEnvironment_LinkingResourceChanged;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.CommunicationLinkResourceSpecifications_LinkingResourceChanging;
            if ((handler != null))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.CommunicationLinkResourceSpecifications_LinkingResourceChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private void OnResetCommunicationLinkResourceSpecifications_LinkingResource(object sender, EventArgs eventArgs)
        {
            if ((sender == this.CommunicationLinkResourceSpecifications_LinkingResource))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ResourceEnvironment_LinkingResourceChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ResourceEnvironment_LinkingResourceChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        protected override IModelElement GetModelElementForReference(string reference, int index)
        {
            ...
            {
                return this.ResourceEnvironment_LinkingResource;
            }
        ...
        public class LinkingResourceChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new CommunicationLinkResourceSpecifications_LinkingResourceProxy(this._parent)};
            }
        ...
        public class LinkingResourceReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            {
                return new INotifiable[] {
                        this._parent.ConnectedResourceContainers_LinkingResource.AsNotifiable(),
                        new CommunicationLinkResourceSpecifications_LinkingResourceProxy(this._parent),
                        new ResourceEnvironment_LinkingResourceProxy(this._parent)};
            }
