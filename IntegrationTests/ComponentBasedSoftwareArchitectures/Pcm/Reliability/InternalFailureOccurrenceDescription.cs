...
namespace NMFExamples.Pcm.Reliability
{
    ...
    public partial class InternalFailureOccurrenceDescription : FailureOccurrenceDescription, IInternalFailureOccurrenceDescription, IModelElement
    {
        ...
        private static Lazy<IOperation> _noResourceTimeoutFailureAllowedForInternalFailureOccurrenceDescriptionOperation = new Lazy<IOperation>(RetrieveNoResourceTimeoutFailureAllowedForInternalFailureOccurrenceDescriptionOperation);
        ...
        /// </summary>
        public event EventHandler<OperationCallEventArgs> NoResourceTimeoutFailureAllowedForInternalFailureOccurrenceDescriptionCalling;
        
        /// <summary>
        /// Gets fired after the operation NoResourceTimeoutFailureAllowedForInternalFailureOccurrenceDescription got called
        /// </summary>
        public event EventHandler<OperationCallEventArgs> NoResourceTimeoutFailureAllowedForInternalFailureOccurrenceDescriptionCalled;
        
        /// <summary>
        /// Gets fired before the InternalAction__InternalFailureOccurrenceDescription property changes its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> InternalAction__InternalFailureOccurrenceDescriptionChanging;
        
        /// <summary>
        /// Gets fired when the InternalAction__InternalFailureOccurrenceDescription property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> InternalAction__InternalFailureOccurrenceDescriptionChanged;
        
        /// <summary>
        /// Gets fired before the SoftwareInducedFailureType__InternalFailureOccurrenceDescription property changes its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> SoftwareInducedFailureType__InternalFailureOccurrenceDescriptionChanging;
        
        /// <summary>
        /// Gets fired when the SoftwareInducedFailureType__InternalFailureOccurrenceDescription property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> SoftwareInducedFailureType__InternalFailureOccurrenceDescriptionChanged;
        ...
        public bool NoResourceTimeoutFailureAllowedForInternalFailureOccurrenceDescription(object diagnostics, object context)
        {
            Func<IInternalFailureOccurrenceDescription, object, object, bool> handler = OperationBroker.Instance.GetRegisteredDelegate<Func<IInternalFailureOccurrenceDescription, object, object, bool>>(_noResourceTimeoutFailureAllowedForInternalFailureOccurrenceDescriptionOperation);
            if ((handler != null))
            {
            }
            else
            {
                throw new InvalidOperationException(("There is no implementation for method NoResourceTimeoutFailureAllowedForInternalF" +
                        "ailureOccurrenceDescription registered. Use the method broker to register a meth" +
                        "od implementation."));
            }
            OperationCallEventArgs e = new OperationCallEventArgs(this, _noResourceTimeoutFailureAllowedForInternalFailureOccurrenceDescriptionOperation.Value, diagnostics, context);
            this.OnNoResourceTimeoutFailureAllowedForInternalFailureOccurrenceDescriptionCalling(e);
            this.OnBubbledChange(BubbledChangeEventArgs.OperationCalling(this, _noResourceTimeoutFailureAllowedForInternalFailureOccurrenceDescriptionOperation.Value, e));
            bool result = handler.Invoke(this, diagnostics, context);
            e.Result = result;
            this.OnNoResourceTimeoutFailureAllowedForInternalFailureOccurrenceDescriptionCalled(e);
            this.OnBubbledChange(BubbledChangeEventArgs.OperationCalled(this, _noResourceTimeoutFailureAllowedForInternalFailureOccurrenceDescriptionOperation.Value, e));
            return result;
        }
        
        private static IOperation RetrieveNoResourceTimeoutFailureAllowedForInternalFailureOccurrenceDescriptionOperation()
        {
            return ClassInstance.LookupOperation("NoResourceTimeoutFailureAllowedForInternalFailureOccurrenceDescription");
        }
        
        /// <summary>
        /// Raises the NoResourceTimeoutFailureAllowedForInternalFailureOccurrenceDescriptionCalling event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnNoResourceTimeoutFailureAllowedForInternalFailureOccurrenceDescriptionCalling(OperationCallEventArgs eventArgs)
        {
            EventHandler<OperationCallEventArgs> handler = this.NoResourceTimeoutFailureAllowedForInternalFailureOccurrenceDescriptionCalling;
            if ((handler != null))
            {
        ...
        /// <summary>
        /// Raises the NoResourceTimeoutFailureAllowedForInternalFailureOccurrenceDescriptionCalled event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnNoResourceTimeoutFailureAllowedForInternalFailureOccurrenceDescriptionCalled(OperationCallEventArgs eventArgs)
        {
            EventHandler<OperationCallEventArgs> handler = this.NoResourceTimeoutFailureAllowedForInternalFailureOccurrenceDescriptionCalled;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.InternalAction__InternalFailureOccurrenceDescriptionChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.InternalAction__InternalFailureOccurrenceDescriptionChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.SoftwareInducedFailureType__InternalFailureOccurrenceDescriptionChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.SoftwareInducedFailureType__InternalFailureOccurrenceDescriptionChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private void OnResetSoftwareInducedFailureType__InternalFailureOccurrenceDescription(object sender, EventArgs eventArgs)
        {
            if ((sender == this.SoftwareInducedFailureType__InternalFailureOccurrenceDescription))
            {
        ...
        protected override IModelElement GetModelElementForReference(string reference, int index)
        {
            ...
            {
                return this.InternalAction__InternalFailureOccurrenceDescription;
            }
        ...
        public class InternalFailureOccurrenceDescriptionReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new InternalAction__InternalFailureOccurrenceDescriptionProxy(this._parent),
                        new SoftwareInducedFailureType__InternalFailureOccurrenceDescriptionProxy(this._parent)};
            }
