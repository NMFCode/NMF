...
namespace NMFExamples.Pcm.Reliability
{
    ...
    public partial class NetworkInducedFailureType : FailureType, INetworkInducedFailureType, IModelElement
    {
        ...
        private static Lazy<IOperation> _networkInducedFailureTypeHasCommunicationLinkResourceTypeOperation = new Lazy<IOperation>(RetrieveNetworkInducedFailureTypeHasCommunicationLinkResourceTypeOperation);
        ...
        /// </summary>
        public event EventHandler<OperationCallEventArgs> NetworkInducedFailureTypeHasCommunicationLinkResourceTypeCalling;
        
        /// <summary>
        /// Gets fired after the operation NetworkInducedFailureTypeHasCommunicationLinkResourceType got called
        /// </summary>
        public event EventHandler<OperationCallEventArgs> NetworkInducedFailureTypeHasCommunicationLinkResourceTypeCalled;
        
        /// <summary>
        /// Gets fired before the CommunicationLinkResourceType__NetworkInducedFailureType property changes its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> CommunicationLinkResourceType__NetworkInducedFailureTypeChanging;
        ...
        public bool NetworkInducedFailureTypeHasCommunicationLinkResourceType(object diagnostics, object context)
        {
            Func<INetworkInducedFailureType, object, object, bool> handler = OperationBroker.Instance.GetRegisteredDelegate<Func<INetworkInducedFailureType, object, object, bool>>(_networkInducedFailureTypeHasCommunicationLinkResourceTypeOperation);
            if ((handler != null))
            {
            }
            else
            {
                throw new InvalidOperationException(("There is no implementation for method NetworkInducedFailureTypeHasCommunicationLi" +
                        "nkResourceType registered. Use the method broker to register a method implementa" +
                        "tion."));
            }
            OperationCallEventArgs e = new OperationCallEventArgs(this, _networkInducedFailureTypeHasCommunicationLinkResourceTypeOperation.Value, diagnostics, context);
            this.OnNetworkInducedFailureTypeHasCommunicationLinkResourceTypeCalling(e);
            this.OnBubbledChange(BubbledChangeEventArgs.OperationCalling(this, _networkInducedFailureTypeHasCommunicationLinkResourceTypeOperation.Value, e));
            bool result = handler.Invoke(this, diagnostics, context);
            e.Result = result;
            this.OnNetworkInducedFailureTypeHasCommunicationLinkResourceTypeCalled(e);
            this.OnBubbledChange(BubbledChangeEventArgs.OperationCalled(this, _networkInducedFailureTypeHasCommunicationLinkResourceTypeOperation.Value, e));
            return result;
        }
        
        private static IOperation RetrieveNetworkInducedFailureTypeHasCommunicationLinkResourceTypeOperation()
        {
            return ClassInstance.LookupOperation("NetworkInducedFailureTypeHasCommunicationLinkResourceType");
        }
        
        /// <summary>
        /// Raises the NetworkInducedFailureTypeHasCommunicationLinkResourceTypeCalling event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnNetworkInducedFailureTypeHasCommunicationLinkResourceTypeCalling(OperationCallEventArgs eventArgs)
        {
            EventHandler<OperationCallEventArgs> handler = this.NetworkInducedFailureTypeHasCommunicationLinkResourceTypeCalling;
            if ((handler != null))
            {
        ...
        /// <summary>
        /// Raises the NetworkInducedFailureTypeHasCommunicationLinkResourceTypeCalled event
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnNetworkInducedFailureTypeHasCommunicationLinkResourceTypeCalled(OperationCallEventArgs eventArgs)
        {
            EventHandler<OperationCallEventArgs> handler = this.NetworkInducedFailureTypeHasCommunicationLinkResourceTypeCalled;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.CommunicationLinkResourceType__NetworkInducedFailureTypeChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            if ((sender == this.CommunicationLinkResourceType__NetworkInducedFailureType))
            {
        ...
        {
            throw new NotSupportedException(("NetworkInducedFailureType does not have an absolute URI and therefore cannot be r" +
                    "esolved."));
        }
        ...
        public class NetworkInducedFailureTypeReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new CommunicationLinkResourceType__NetworkInducedFailureTypeProxy(this._parent)};
            }
