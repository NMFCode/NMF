...
namespace NMFExamples.Pcm.Protocol
{
    ...
    public abstract partial class Protocol : ModelElement, IProtocol, IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ProtocolTypeIDChanging;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ProtocolTypeIDChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        protected override NMF.Expressions.INotifyExpression<object> GetExpressionForAttribute(string attribute)
        {
            if ((attribute == "PROTOCOLTYPEID"))
            {
                return new ProtocolTypeIDProxy(this);
            }
