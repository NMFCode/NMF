...
namespace NMFExamples.Probfunction
{
    ...
    public partial class ProbabilityMassFunction : ProbabilityFunction, IProbabilityMassFunction, IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> OrderedDomainChanging;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.OrderedDomainChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        protected override NMF.Expressions.INotifyExpression<object> GetExpressionForAttribute(string attribute)
        {
            if ((attribute == "ORDEREDDOMAIN"))
            {
                return Observable.Box(new OrderedDomainProxy(this));
            }
        ...
        {
            throw new NotSupportedException(("ProbabilityMassFunction does not have an absolute URI and therefore cannot be res" +
                    "olved."));
        }
        ...
        public class ProbabilityMassFunctionChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.Samples.AsNotifiable()};
            }
