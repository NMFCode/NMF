...
namespace NMFExamples.Probfunction
{
    ...
    public interface IProbabilityMassFunction : IModelElement, IProbabilityFunction
    {
        ...
        /// </summary>
        event global::System.EventHandler<ValueChangedEventArgs> OrderedDomainChanging;
        
        /// <summary>
        /// Gets fired when the OrderedDomain property changed its value
        /// </summary>
        event global::System.EventHandler<ValueChangedEventArgs> OrderedDomainChanged;
    }
}
