...
namespace NMFExamples.Probfunction
{
    ...
    public partial class SamplePDF : ProbabilityDensityFunction, ISamplePDF, IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> DistanceChanging;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.DistanceChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        protected override NMF.Expressions.INotifyExpression<object> GetExpressionForAttribute(string attribute)
        {
            if ((attribute == "DISTANCE"))
            {
                return Observable.Box(new DistanceProxy(this));
            }
        ...
        {
            throw new NotSupportedException("SamplePDF does not have an absolute URI and therefore cannot be resolved.");
        }
