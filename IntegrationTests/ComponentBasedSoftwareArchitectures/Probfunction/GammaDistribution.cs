...
namespace NMFExamples.Probfunction
{
    ...
    public partial class GammaDistribution : ContinuousPDF, IGammaDistribution, IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> AlphaChanging;
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ThetaChanging;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.AlphaChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ThetaChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        protected override NMF.Expressions.INotifyExpression<object> GetExpressionForAttribute(string attribute)
        {
            if ((attribute == "ALPHA"))
            {
                return Observable.Box(new AlphaProxy(this));
            }
            if ((attribute == "THETA"))
            {
                return Observable.Box(new ThetaProxy(this));
            }
        ...
        {
            throw new NotSupportedException("GammaDistribution does not have an absolute URI and therefore cannot be resolved.");
        }
