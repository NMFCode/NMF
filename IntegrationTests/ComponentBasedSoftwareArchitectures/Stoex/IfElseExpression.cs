...
namespace NMFExamples.Stoex
{
    ...
    public partial class IfElseExpression : IfElse, IIfElseExpression, IModelElement
    {
            ...
            set
            {
                if ((this._ifExpression != value))
                {
                    ...
                    if ((old != null))
                    {
                        ...
                        old.ParentChanged -= this.OnResetIfExpression;
                    }
                    if ((value != null))
                    {
                        value.Parent = this;
                        value.ParentChanged += this.OnResetIfExpression;
                    }
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> IfExpressionChanging;
        
        /// <summary>
        /// Gets fired when the IfExpression property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> IfExpressionChanged;
        
        /// <summary>
        /// Gets fired before the ElseExpression property changes its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ElseExpressionChanging;
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ConditionExpressionChanging;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.IfExpressionChanging;
            if ((handler != null))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.IfExpressionChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private void OnResetIfExpression(object sender, EventArgs eventArgs)
        {
            if ((sender == this.IfExpression))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ElseExpressionChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ConditionExpressionChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            if ((sender == this.ConditionExpression))
            {
        ...
        public class IfElseExpressionChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new IfExpressionProxy(this._parent),
                        new ElseExpressionProxy(this._parent),
                        new ConditionExpressionProxy(this._parent)};
            }
