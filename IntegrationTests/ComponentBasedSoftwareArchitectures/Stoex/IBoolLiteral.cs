...
namespace NMFExamples.Stoex
{
    ...
    /// <summary>
    /// The public interface for BoolLiteral
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(BoolLiteral))]
    [XmlDefaultImplementationTypeAttribute(typeof(BoolLiteral))]
    [ModelRepresentationClassAttribute("http://sdq.ipd.uka.de/StochasticExpressions/1.0#//BoolLiteral")]
    public partial interface IBoolLiteral : IModelElement, IAtom
    {
