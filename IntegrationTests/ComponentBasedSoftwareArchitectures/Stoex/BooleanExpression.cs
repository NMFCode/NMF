...
namespace NMFExamples.Stoex
{
    ...
    public abstract partial class BooleanExpression : IfElse, IBooleanExpression, IModelElement
    {
        ...
        {
            throw new NotSupportedException("BooleanExpression does not have an absolute URI and therefore cannot be resolved.");
        }
    }
}
