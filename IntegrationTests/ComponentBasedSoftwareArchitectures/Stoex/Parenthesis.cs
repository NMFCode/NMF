...
namespace NMFExamples.Stoex
{
    ...
    public partial class Parenthesis : Atom, IParenthesis, IModelElement
    {
            ...
            set
            {
                if ((this._innerExpression != value))
                {
                    ...
                    if ((old != null))
                    {
                        ...
                        old.ParentChanged -= this.OnResetInnerExpression;
                    }
                    if ((value != null))
                    {
                        value.Parent = this;
                        value.ParentChanged += this.OnResetInnerExpression;
                    }
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> InnerExpressionChanging;
        
        /// <summary>
        /// Gets fired when the InnerExpression property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> InnerExpressionChanged;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.InnerExpressionChanging;
            if ((handler != null))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.InnerExpressionChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private void OnResetInnerExpression(object sender, EventArgs eventArgs)
        {
            if ((sender == this.InnerExpression))
            {
        ...
        {
            throw new NotSupportedException("Parenthesis does not have an absolute URI and therefore cannot be resolved.");
        }
        ...
        public class ParenthesisChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new InnerExpressionProxy(this._parent)};
            }
