...
namespace NMFExamples.Stoex
{
    ...
    public partial class FunctionLiteral : Atom, IFunctionLiteral, IModelElement
    {
        ...
        {
            throw new NotSupportedException("FunctionLiteral does not have an absolute URI and therefore cannot be resolved.");
        }
        ...
        public class FunctionLiteralChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.Parameters_FunctionLiteral.AsNotifiable()};
            }
