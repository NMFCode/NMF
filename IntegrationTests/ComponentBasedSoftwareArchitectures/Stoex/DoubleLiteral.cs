...
namespace NMFExamples.Stoex
{
    ...
    public partial class DoubleLiteral : NumericLiteral, IDoubleLiteral, IModelElement
    {
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://sdq.ipd.uka.de/StochasticExpressions/1.0#//DoubleLiteral")));
                }
        ...
        {
            return ((ITypedElement)(((ModelElement)(NMFExamples.Stoex.DoubleLiteral.ClassInstance)).Resolve("value")));
        }
