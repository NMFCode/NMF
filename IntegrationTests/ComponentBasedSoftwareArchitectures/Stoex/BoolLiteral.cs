...
namespace NMFExamples.Stoex
{
    ...
    public partial class BoolLiteral : Atom, IBoolLiteral, IModelElement
    {
        ...
        {
            return ((ITypedElement)(((ModelElement)(NMFExamples.Stoex.BoolLiteral.ClassInstance)).Resolve("value")));
        }
        ...
        {
            throw new NotSupportedException("BoolLiteral does not have an absolute URI and therefore cannot be resolved.");
        }
