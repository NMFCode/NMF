...
terminal ID: /[_a-zA-Z][\w_]*/;";
            ...
            {
                0, 0, 7, 3, 0, 0, 8, 10, 4, 0, 0, 11, 4, 3, 0, 0, 5, 5, 1, 0, 2, 0, 5, 1, 2, 0, 5, 1, 11, 0, 1, 4,
                1, 11, 0, 0, 1, 7, 9, 2, 0, 7, 2, 11, 0, 0, 2, 6, 1, 0, 0, 7, 1, 11, 0, 0, 2, 9, 9, 2, 0, 9, 2, 11, 0,
                0, 2, 8, 1, 0, 0, 0, 8, 1, 0, 0, 8, 1, 11, 0, 0, 1, 1, 11, 0, 0, 1, 1, 11, 0, 2, 0, 6, 1, 2, 0, 6, 1, 11, 0, 1, 4, 8,
...
terminal ID: /[_a-zA-Z][\w_]*/;";
            ...
            var expected = new uint[]
            {
                0, 0, 7, 3, 0, 0, 8, 10, 4, 0, 0, 11, 4, 3, 0, 0, 5, 5, 1, 0
            };
            Assert.That(result, Is.EqualTo(expected));
        }
    }
