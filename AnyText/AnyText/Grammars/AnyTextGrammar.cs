        ...
        public partial class GrammarRule : ModelElementRule<NMF.AnyText.Metamodel.Grammar>
        {
            ...
            public override void Initialize(GrammarContext context)
            {
                Rules = new FormattedRule[] {
                        ...
                        RuleFormatter.ZeroOrOne(new SequenceRule(context.ResolveKeyword("("), context.ResolveFormattedRule<GrammarLanguageIdLanguageIdRule>(), context.ResolveKeyword(")")), NMF.AnyText.PrettyPrinting.FormattingInstruction.Newline),
