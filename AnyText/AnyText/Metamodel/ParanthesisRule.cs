...
namespace NMF.AnyText.Metamodel
{
    ...
    public partial class ParanthesisRule : ClassRule, IParanthesisRule, IModelElement
    {
        ...
        public IListExpression<FormattingInstruction> FormattingInstructionsAfterOpening
        {
            get
            {
                return this._formattingInstructionsAfterOpening;
            }
        }
        ...
        public IListExpression<FormattingInstruction> FormattingInstructionsAfterClosing
        {
            get
            {
                return this._formattingInstructionsAfterClosing;
            }
        }
        ...
        public IListExpression<FormattingInstruction> FormattingInstructionsInner
        {
            get
            {
                return this._formattingInstructionsInner;
            }
        }
        ...
        private static ITypedElement RetrieveFormattingInstructionsAfterOpeningAttribute()
        {
            return ((ITypedElement)(((ModelElement)(NMF.AnyText.Metamodel.ParanthesisRule.ClassInstance)).Resolve("FormattingInstructionsAfterOpening")));
        }
        
        /// <summary>
        /// Forwards CollectionChanging notifications for the FormattingInstructionsAfterOpening property to the parent model element
        /// </summary>
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void FormattingInstructionsAfterOpeningCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
            this.OnCollectionChanging("FormattingInstructionsAfterOpening", e, _formattingInstructionsAfterOpeningAttribute);
        }
        
        /// <summary>
        /// Forwards CollectionChanged notifications for the FormattingInstructionsAfterOpening property to the parent model element
        /// </summary>
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void FormattingInstructionsAfterOpeningCollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            this.OnCollectionChanged("FormattingInstructionsAfterOpening", e, _formattingInstructionsAfterOpeningAttribute);
        }
        
        private static ITypedElement RetrieveFormattingInstructionsAfterClosingAttribute()
        {
            return ((ITypedElement)(((ModelElement)(NMF.AnyText.Metamodel.ParanthesisRule.ClassInstance)).Resolve("FormattingInstructionsAfterClosing")));
        }
        
        /// <summary>
        /// Forwards CollectionChanging notifications for the FormattingInstructionsAfterClosing property to the parent model element
        /// </summary>
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void FormattingInstructionsAfterClosingCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
            this.OnCollectionChanging("FormattingInstructionsAfterClosing", e, _formattingInstructionsAfterClosingAttribute);
        }
        
        /// <summary>
        /// Forwards CollectionChanged notifications for the FormattingInstructionsAfterClosing property to the parent model element
        /// </summary>
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void FormattingInstructionsAfterClosingCollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            this.OnCollectionChanged("FormattingInstructionsAfterClosing", e, _formattingInstructionsAfterClosingAttribute);
        }
        
        private static ITypedElement RetrieveFormattingInstructionsInnerAttribute()
        {
            return ((ITypedElement)(((ModelElement)(NMF.AnyText.Metamodel.ParanthesisRule.ClassInstance)).Resolve("FormattingInstructionsInner")));
        }
        
        /// <summary>
        /// Forwards CollectionChanging notifications for the FormattingInstructionsInner property to the parent model element
        /// </summary>
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void FormattingInstructionsInnerCollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
            this.OnCollectionChanging("FormattingInstructionsInner", e, _formattingInstructionsInnerAttribute);
        }
        
        /// <summary>
        /// Forwards CollectionChanged notifications for the FormattingInstructionsInner property to the parent model element
        /// </summary>
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void FormattingInstructionsInnerCollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            this.OnCollectionChanged("FormattingInstructionsInner", e, _formattingInstructionsInnerAttribute);
        }
        ...
        {
            if ((attribute == "FORMATTINGINSTRUCTIONSAFTEROPENING"))
            {
                if ((index < this.FormattingInstructionsAfterOpening.Count))
                {
                    return this.FormattingInstructionsAfterOpening[index];
                }
                else
                {
                    return null;
            ...
            if ((attribute == "FORMATTINGINSTRUCTIONSAFTERCLOSING"))
            {
                if ((index < this.FormattingInstructionsAfterClosing.Count))
                {
                    return this.FormattingInstructionsAfterClosing[index];
                }
                else
                {
                    return null;
            ...
            if ((attribute == "FORMATTINGINSTRUCTIONSINNER"))
            {
                if ((index < this.FormattingInstructionsInner.Count))
                {
                    return this.FormattingInstructionsInner[index];
                }
                else
                {
                    return null;
        ...
        {
            if ((feature == "FORMATTINGINSTRUCTIONSAFTEROPENING"))
            {
                return this._formattingInstructionsAfterOpening;
            }
            if ((feature == "FORMATTINGINSTRUCTIONSAFTERCLOSING"))
            {
                return this._formattingInstructionsAfterClosing;
            }
            if ((feature == "FORMATTINGINSTRUCTIONSINNER"))
            {
                return this._formattingInstructionsInner;
            }
        ...
        public class ParanthesisRuleChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new OpeningParanthesisProxy(this._parent),
                        new ClosingParanthesisProxy(this._parent)};
            }
        ...
        public class ParanthesisRuleReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new OpeningParanthesisProxy(this._parent),
                        new InnerRuleProxy(this._parent),
                        new ClosingParanthesisProxy(this._parent)};
            }
