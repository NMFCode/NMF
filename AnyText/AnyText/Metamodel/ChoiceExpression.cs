...
namespace NMF.AnyText.Metamodel
{
    ...
    public partial class ChoiceExpression : ParserExpression, IChoiceExpression, IModelElement
    {
        ...
        private ObservableCompositionOrderedSet<IFormattedExpression> _alternatives;
        ...
        {
            this._alternatives = new ObservableCompositionOrderedSet<IFormattedExpression>(this);
        ...
        [ConstantAttribute()]
        public IOrderedSetExpression<IFormattedExpression> Alternatives
        {
            get
            {
        ...
        public class ChoiceExpressionChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.Alternatives.AsNotifiable()};
            }
            ...
            {
                IFormattedExpression alternativesCasted = item.As<IFormattedExpression>();
            ...
            public override bool Remove(IModelElement item)
            {
                ...
                if (((formattedExpressionItem != null) 
                            && this._parent.Alternatives.Remove(formattedExpressionItem)))
                {
                    return true;
                }
                return false;
