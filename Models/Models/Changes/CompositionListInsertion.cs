...
namespace NMF.Models.Changes
{
    ...
    public partial class CompositionListInsertion : CompositionChange, ICompositionListInsertion, NMF.Models.IModelElement
    {
        ...
        public override IEnumerableExpression<NMF.Models.IModelElement> Children
        {
            get
            {
                return base.Children.Concat(new CompositionListInsertionChildrenCollection(this));
            }
        }
        ...
        public override IEnumerableExpression<NMF.Models.IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new CompositionListInsertionReferencedElementsCollection(this));
            }
        }
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://nmf.codeplex.com/changes#//CompositionListInsertion")));
                }
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> IndexChanged;
        
        /// <summary>
        /// Gets fired before the Index property changes its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> IndexChanging;
        
        /// <summary>
        /// Gets fired before the AddedElement property changes its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> AddedElementChanging;
        
        /// <summary>
        /// Gets fired when the AddedElement property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> AddedElementChanged;
        
        private static ITypedElement RetrieveIndexAttribute()
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Changes.CompositionListInsertion.ClassInstance)).Resolve("index")));
        }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.IndexChanged;
            if ((handler != null))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.IndexChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.AddedElementChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.AddedElementChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// </summary>
        public class CompositionListInsertionChildrenCollection : ReferenceCollection, ICollectionExpression<NMF.Models.IModelElement>, ICollection<NMF.Models.IModelElement>
        {
            
            private CompositionListInsertion _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public CompositionListInsertionChildrenCollection(CompositionListInsertion parent)
            {
                this._parent = parent;
            }
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new AddedElementProxy(this._parent)};
            }
        ...
        /// The collection class to to represent the children of the CompositionListInsertion class
        /// </summary>
        public class CompositionListInsertionReferencedElementsCollection : ReferenceCollection, ICollectionExpression<NMF.Models.IModelElement>, ICollection<NMF.Models.IModelElement>
        {
            ...
            /// Creates a new instance
            /// </summary>
            public CompositionListInsertionReferencedElementsCollection(CompositionListInsertion parent)
            {
                this._parent = parent;
            }
        ...
        /// </summary>
        private sealed class IndexProxy : ModelPropertyChange<ICompositionListInsertion, int>
        {
            ...
            public IndexProxy(ICompositionListInsertion modelElement) : 
        ...
        /// </summary>
        private sealed class AddedElementProxy : ModelPropertyChange<ICompositionListInsertion, NMF.Models.IModelElement>
        {
            ...
            /// </summary>
            /// <param name="modelElement">The model instance element for which to create the property access proxy</param>
            public AddedElementProxy(ICompositionListInsertion modelElement) : 
