...
namespace NMF.Models.Changes
{
    ...
    public partial class AttributeListDeletion : AttributeChange, IAttributeListDeletion, NMF.Models.IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> DeletedValueChanged;
        
        /// <summary>
        /// Gets fired before the DeletedValue property changes its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> DeletedValueChanging;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.DeletedValueChanged;
            if ((handler != null))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.DeletedValueChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Changes.AttributeListDeletion.ClassInstance)).Resolve("index")));
        }
