...
namespace NMF.Models.Changes
{
    ...
    public abstract partial class ElementaryChange : ModelChange, IElementaryChange, NMF.Models.IModelElement
    {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.AffectedElementChanging;
            if ((handler != null))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.AffectedElementChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private void OnResetAffectedElement(object sender, EventArgs eventArgs)
        {
            if ((sender == this.AffectedElement))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.FeatureChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        public class ElementaryChangeReferencedElementsCollection : ReferenceCollection, ICollectionExpression<NMF.Models.IModelElement>, ICollection<NMF.Models.IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new AffectedElementProxy(this._parent),
                        new FeatureProxy(this._parent)};
            }
