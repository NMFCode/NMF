...
namespace NMF.Models.Changes
{
    ...
    public partial class AttributeListInsertion : AttributeChange, IAttributeListInsertion, NMF.Models.IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> AddedValueChanged;
        
        /// <summary>
        /// Gets fired before the AddedValue property changes its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> AddedValueChanging;
        
        private static ITypedElement RetrieveIndexAttribute()
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Changes.AttributeListInsertion.ClassInstance)).Resolve("index")));
        }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.AddedValueChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.AddedValueChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
