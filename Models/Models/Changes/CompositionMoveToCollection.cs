...
namespace NMF.Models.Changes
{
    ...
    public partial class CompositionMoveToCollection : CompositionChange, ICompositionMoveToCollection, NMF.Models.IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> MovedElementChanging;
        
        /// <summary>
        /// Gets fired when the MovedElement property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> MovedElementChanged;
        
        /// <summary>
        /// Gets fired before the Origin property changes its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> OriginChanging;
        
        /// <summary>
        /// Gets fired when the Origin property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> OriginChanged;
        
        private static ITypedElement RetrieveMovedElementReference()
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Changes.CompositionMoveToCollection.ClassInstance)).Resolve("movedElement")));
        }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.MovedElementChanging;
            if ((handler != null))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.MovedElementChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Changes.CompositionMoveToCollection.ClassInstance)).Resolve("origin")));
        }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.OriginChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.OriginChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private void OnResetOrigin(object sender, EventArgs eventArgs)
        {
            if ((sender == this.Origin))
            {
                this.Origin = null;
            }
        }
        ...
        public class CompositionMoveToCollectionReferencedElementsCollection : ReferenceCollection, ICollectionExpression<NMF.Models.IModelElement>, ICollection<NMF.Models.IModelElement>
        {
            ...
            {
                return new INotifiable[] {
                        new MovedElementProxy(this._parent),
                        new OriginProxy(this._parent)};
            }
