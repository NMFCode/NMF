...
namespace NMF.Models.Changes
{
    ...
    public partial class OperationCall : ModelChange, IOperationCall, NMF.Models.IModelElement
    {
        ...
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Changes.OperationCall.ClassInstance)).Resolve("operation")));
        }
        ...
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Changes.OperationCall.ClassInstance)).Resolve("targetElement")));
        }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.TargetElementChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.TargetElementChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        /// <param name="sender">The object that sent this reset request</param>
        /// <param name="eventArgs">The event data for the reset event</param>
        private void OnResetTargetElement(object sender, EventArgs eventArgs)
        {
            if ((sender == this.TargetElement))
            {
        ...
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Changes.OperationCall.ClassInstance)).Resolve("arguments")));
        }
        ...
        public class OperationCallReferencedElementsCollection : ReferenceCollection, ICollectionExpression<NMF.Models.IModelElement>, ICollection<NMF.Models.IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        ...
                        new TargetElementProxy(this._parent),
