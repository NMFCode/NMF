...
namespace NMF.Models.Changes
{
    ...
    public partial class ChangeTransaction : ModelChange, IChangeTransaction, NMF.Models.IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> SourceChangeChanging;
        
        /// <summary>
        /// Gets fired when the SourceChange property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> SourceChangeChanged;
        
        private static ITypedElement RetrieveSourceChangeReference()
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Changes.ChangeTransaction.ClassInstance)).Resolve("sourceChange")));
        }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.SourceChangeChanging;
            if ((handler != null))
            {
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.SourceChangeChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private void OnResetSourceChange(object sender, EventArgs eventArgs)
        {
            if ((sender == this.SourceChange))
            {
        ...
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Changes.ChangeTransaction.ClassInstance)).Resolve("nestedChanges")));
        }
        ...
        public class ChangeTransactionChildrenCollection : ReferenceCollection, ICollectionExpression<NMF.Models.IModelElement>, ICollection<NMF.Models.IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new SourceChangeProxy(this._parent),
                        this._parent.NestedChanges.AsNotifiable()};
            }
