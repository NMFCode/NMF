...
namespace NMF.Models.Meta
{
    ...
    public abstract partial class Type : MetaElement, NMF.Models.Meta.IType, NMF.Models.IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> NamespaceChanging;
        ...
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Meta.Type.ClassInstance)).Resolve("Namespace")));
        }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.NamespaceChanging;
            if ((handler != null))
            {
        ...
        public class TypeReferencedElementsCollection : ReferenceCollection, ICollectionExpression<NMF.Models.IModelElement>, ICollection<NMF.Models.IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new NamespaceProxy(this._parent)};
            }
