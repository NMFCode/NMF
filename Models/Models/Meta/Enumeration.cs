...
namespace NMF.Models.Meta
{
    ...
    public partial class Enumeration : Type, NMF.Models.Meta.IEnumeration, NMF.Models.IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> IsFlaggedChanging;
        
        private static ITypedElement RetrieveIsFlaggedAttribute()
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Meta.Enumeration.ClassInstance)).Resolve("IsFlagged")));
        }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.IsFlaggedChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Meta.Enumeration.ClassInstance)).Resolve("Literals")));
        }
