...
namespace NMF.Models.Meta
{
    ...
    public partial class Event : MetaElement, NMF.Models.Meta.IEvent, NMF.Models.IModelElement
    {
        ...
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Meta.Event.ClassInstance)).Resolve("Type")));
        }
        ...
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Meta.Event.ClassInstance)).Resolve("DeclaringType")));
        }
