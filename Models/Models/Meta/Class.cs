...
namespace NMF.Models.Meta
{
    ...
    public partial class Class : ReferenceType, NMF.Models.Meta.IClass, NMF.Models.IModelElement
    {
        ...
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Meta.Class.ClassInstance)).Resolve("IsAbstract")));
        }
        ...
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Meta.Class.ClassInstance)).Resolve("IdentifierScope")));
        }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.IdentifierScopeChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Meta.Class.ClassInstance)).Resolve("BaseTypes")));
        }
        ...
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Meta.Class.ClassInstance)).Resolve("InstanceOf")));
        }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.InstanceOfChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Meta.Class.ClassInstance)).Resolve("Identifier")));
        }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.IdentifierChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Meta.Class.ClassInstance)).Resolve("AttributeConstraints")));
        }
        ...
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Meta.Class.ClassInstance)).Resolve("ReferenceConstraints")));
        }
        ...
        public class ClassChildrenCollection : ReferenceCollection, ICollectionExpression<NMF.Models.IModelElement>, ICollection<NMF.Models.IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.AttributeConstraints.AsNotifiable(),
                        this._parent.ReferenceConstraints.AsNotifiable()};
            }
        ...
        public class ClassReferencedElementsCollection : ReferenceCollection, ICollectionExpression<NMF.Models.IModelElement>, ICollection<NMF.Models.IModelElement>
        {
            ...
            {
                return new INotifiable[] {
                        this._parent.BaseTypes.AsNotifiable(),
                        new InstanceOfProxy(this._parent),
                        new IdentifierProxy(this._parent),
                        this._parent.AttributeConstraints.AsNotifiable(),
                        this._parent.ReferenceConstraints.AsNotifiable()};
            }
