...
namespace NMF.Models.Meta
{
    ...
    /// <summary>
    /// Denotes a class to implement the Extensions reference
    /// </summary>
    public class ModelElementExtensionsCollection : ObservableOppositeList<IModelElement, IModelElementExtension>
    {
        ...
        /// </summary>
        /// <param name="parent">the parent ModelElement</param>
        ...
        protected override void SetOpposite(IModelElementExtension item, IModelElement newParent)
        {
            if ((newParent != null))
            {
                item.ParentChanged += this.OnItemParentChanged;
                item.ExtendedElement = newParent;
            }
            else
            {
                item.ParentChanged -= this.OnItemParentChanged;
