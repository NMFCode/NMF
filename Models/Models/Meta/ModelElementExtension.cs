...
namespace NMF.Models.Meta
{
    ...
    public abstract partial class ModelElementExtension : NMF.Models.ModelElement, NMF.Models.Meta.IModelElementExtension, NMF.Models.IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> ExtendedElementChanging;
        ...
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Meta.ModelElementExtension.ClassInstance)).Resolve("ExtendedElement")));
        }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ExtendedElementChanging;
            if ((handler != null))
            {
        ...
        public class ModelElementExtensionReferencedElementsCollection : ReferenceCollection, ICollectionExpression<NMF.Models.IModelElement>, ICollection<NMF.Models.IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new ExtendedElementProxy(this._parent)};
            }
