...
namespace NMF.Models.Meta
{
    ...
    public partial class Attribute : TypedElement, NMF.Models.Meta.IAttribute, NMF.Models.IModelElement
    {
        ...
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Meta.Attribute.ClassInstance)).Resolve("DefaultValue")));
        }
        ...
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Meta.Attribute.ClassInstance)).Resolve("DeclaringType")));
        }
        ...
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Meta.Attribute.ClassInstance)).Resolve("Refines")));
        }
