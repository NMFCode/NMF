...
namespace NMF.Models.Meta
{
    ...
    public class Reference : MetaElement, IReference, IModelElement
    {
        ...
        protected override string GetRelativePathForNonIdentifiedChild(IModelElement element)
        {
            ...
            if ((element == this.Opposite))
            {
                return ModelHelper.CreatePath("Opposite");
            }
            if ((element == this.ReferenceType))
            {
                return ModelHelper.CreatePath("ReferenceType");
            }
            if ((element == this.Refines))
            {
                return ModelHelper.CreatePath("Refines");
            }
