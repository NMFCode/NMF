...
namespace NMF.Models.Meta
{
    ...
    public partial class Extension : ReferenceType, NMF.Models.Meta.IExtension, NMF.Models.IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> AdornedClassChanging;
        ...
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Meta.Extension.ClassInstance)).Resolve("AdornedClass")));
        }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.AdornedClassChanging;
            if ((handler != null))
            {
        ...
        public class ExtensionReferencedElementsCollection : ReferenceCollection, ICollectionExpression<NMF.Models.IModelElement>, ICollection<NMF.Models.IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        new AdornedClassProxy(this._parent)};
            }
