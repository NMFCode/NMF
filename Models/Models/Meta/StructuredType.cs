...
namespace NMF.Models.Meta
{
    ...
    public abstract partial class StructuredType : Type, NMF.Models.Meta.IStructuredType, NMF.Models.IModelElement
    {
        ...
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Meta.StructuredType.ClassInstance)).Resolve("Operations")));
        }
        ...
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Meta.StructuredType.ClassInstance)).Resolve("Attributes")));
        }
        ...
        public class StructuredTypeChildrenCollection : ReferenceCollection, ICollectionExpression<NMF.Models.IModelElement>, ICollection<NMF.Models.IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.Operations.AsNotifiable(),
                        this._parent.Attributes.AsNotifiable()};
            }
