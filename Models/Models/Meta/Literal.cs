...
namespace NMF.Models.Meta
{
    ...
    public partial class Literal : MetaElement, NMF.Models.Meta.ILiteral, NMF.Models.IModelElement
    {
        ...
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Meta.Literal.ClassInstance)).Resolve("Value")));
        }
        ...
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Meta.Literal.ClassInstance)).Resolve("Enumeration")));
        }
