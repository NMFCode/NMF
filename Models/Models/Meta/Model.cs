...
namespace NMF.Models.Meta
{
    ...
    public partial class Model : ModelElement, NMF.Models.Meta.IModel, NMF.Models.IModelElement
    {
        ...
        /// </summary>
        [DebuggerBrowsableAttribute(DebuggerBrowsableState.Never)]
        private ObservableCompositionOrderedSet<NMF.Models.Meta.IModelElement> _rootElements;
        ...
        public Model()
        {
            this._rootElements = new ObservableCompositionOrderedSet<NMF.Models.Meta.IModelElement>(this);
        ...
        [ConstantAttribute()]
        public IOrderedSetExpression<NMF.Models.Meta.IModelElement> RootElements
        {
            get
            {
        ...
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Meta.Model.ClassInstance)).Resolve("ModelUri")));
        }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.ModelUriChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Meta.Model.ClassInstance)).Resolve("RootElements")));
        }
        ...
        public class ModelChildrenCollection : ReferenceCollection, ICollectionExpression<NMF.Models.IModelElement>, ICollection<NMF.Models.IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.RootElements.AsNotifiable()};
            }
        ...
        /// </summary>
        private sealed class ModelUriProxy : ModelPropertyChange<NMF.Models.Meta.IModel, Uri>
        {
            ...
            public ModelUriProxy(NMF.Models.Meta.IModel modelElement) : 
