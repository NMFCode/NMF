...
namespace NMF.Models.Meta
{
    ...
    public partial class MappedType : ModelElementExtension<NMF.Models.Meta.IType, MappedType>
    {
        ...
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Meta.MappedType.ClassInstance)).Resolve("SystemType")));
        }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.SystemTypeChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
