...
namespace NMF.Models.Meta
{
    ...
    public partial class Operation : TypedElement, NMF.Models.Meta.IOperation, NMF.Models.IModelElement
    {
        ...
        [ConstantAttribute()]
        public IListExpression<NMF.Models.Meta.IParameter> Parameters
        {
            get
            {
        ...
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Meta.Operation.ClassInstance)).Resolve("Parameters")));
        }
        ...
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Meta.Operation.ClassInstance)).Resolve("DeclaringType")));
        }
        ...
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Meta.Operation.ClassInstance)).Resolve("Refines")));
        }
