...
namespace NMF.Models.Meta
{
    ...
    public abstract partial class ReferenceType : StructuredType, NMF.Models.Meta.IReferenceType, NMF.Models.IModelElement
    {
        ...
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Meta.ReferenceType.ClassInstance)).Resolve("Events")));
        }
        ...
        {
            return ((ITypedElement)(((NMF.Models.ModelElement)(NMF.Models.Meta.ReferenceType.ClassInstance)).Resolve("References")));
        }
        ...
        public class ReferenceTypeChildrenCollection : ReferenceCollection, ICollectionExpression<NMF.Models.IModelElement>, ICollection<NMF.Models.IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.Events.AsNotifiable(),
