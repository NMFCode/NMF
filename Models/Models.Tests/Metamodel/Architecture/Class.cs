...
namespace NMF.Models.Tests.Architecture
{
    ...
    public partial class Class : NamedElement, NMF.Models.Tests.Architecture.IClass, IModelElement
    {
        ...
        private static Lazy<IOperation> _pullUpFeatureOperation = new Lazy<IOperation>(RetrievePullUpFeatureOperation);
        ...
        /// </summary>
        public event EventHandler<OperationCallEventArgs> PullUpFeatureCalling;
        
        /// <summary>
        /// Gets fired after the operation pullUpFeature got called
        /// </summary>
        public event EventHandler<OperationCallEventArgs> PullUpFeatureCalled;
        
        /// <summary>
        /// Gets fired before the BaseType property changes its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> BaseTypeChanging;
        
        /// <summary>
        /// Gets fired when the BaseType property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> BaseTypeChanged;
        ...
        public void PullUpFeature(string methodName)
        {
            ...
            {
                throw new InvalidOperationException(("There is no implementation for method pullUpFeature registered. Use the method br" +
        ...
        {
            EventHandler<OperationCallEventArgs> handler = this.PullUpFeatureCalling;
            if ((handler != null))
            {
        ...
        {
            EventHandler<OperationCallEventArgs> handler = this.PullUpFeatureCalled;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            return ((ITypedElement)(((ModelElement)(NMF.Models.Tests.Architecture.Class.ClassInstance)).Resolve("encapsulates")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(NMF.Models.Tests.Architecture.Class.ClassInstance)).Resolve("baseType")));
        }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.BaseTypeChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.BaseTypeChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
