...
namespace NMF.Models.Tests.Architecture
{
    ...
    public partial class Method : Feature, IMethod, IModelElement
    {
        ...
        {
            return ((ITypedElement)(((ModelElement)(NMF.Models.Tests.Architecture.Method.ClassInstance)).Resolve("dataDependency")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(NMF.Models.Tests.Architecture.Method.ClassInstance)).Resolve("functionalDependency")));
        }
