...
namespace NMF.Models.Tests.Minimal_example.Product
{
    ...
    public partial class ProductSegment : ModelElement, IProductSegment, IModelElement
    {
        ...
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> WorkpieceOutChanging;
        
        /// <summary>
        /// Gets fired when the WorkpieceOut property changed its value
        /// </summary>
        public event EventHandler<ValueChangedEventArgs> WorkpieceOutChanged;
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.WorkpieceOutChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            EventHandler<ValueChangedEventArgs> handler = this.WorkpieceOutChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private void OnResetWorkpieceOut(object sender, EventArgs eventArgs)
        {
            if ((sender == this.WorkpieceOut))
            {
        ...
        public class ProductSegmentReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.WorkpieceIn.AsNotifiable(),
                        new WorkpieceOutProxy(this._parent)};
            }
