...
namespace NMF.Models.Tests.Debug
{
    ...
    public partial class AClass : ModelElement, IAClass, IModelElement
    {
        ...
        [ConstantAttribute()]
        public IListExpression<ICClass> Cont1
        {
            get
            {
                return this._cont1;
        ...
        {
            return ((ITypedElement)(((ModelElement)(NMF.Models.Tests.Debug.AClass.ClassInstance)).Resolve("cont1")));
        }
        ...
        private void Cont1CollectionChanging(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        /// <param name="sender">The collection that raised the change</param>
        /// <param name="e">The original event data</param>
        private void Cont1CollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
        ...
        public class AClassChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            protected override INotifiable[] CreateDependencies()
            {
                return new INotifiable[] {
                        this._parent.Cont1.AsNotifiable()};
            }
